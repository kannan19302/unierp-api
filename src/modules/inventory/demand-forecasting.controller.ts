...
export class DemandForecastingController {
  ...
  createForecast(
    @Req() req: AuthReq,
    @ZodBody(createForecastSchema) body: any,
  ) {
  ...
  runForecastEngine(
    @Req() req: AuthReq,
    @ZodBody(runForecastEngineSchema) body: any,
  ) {
  ...
  updateActual(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateActualSchema) body: any,
  ) {
  ...
  listReorderPoints(
    ...
    return this.svc.listReorderPoints(
      req.user.tenantId,
      productId,
      activeOnly === "true",
    );
  ...
  calculateReorderPoint(
    @Req() req: AuthReq,
    @ZodBody(calculateReorderPointSchema) body: any,
  ) {
  ...
  @Permissions("inventory.demand_forecast.manage")
  @Post("safety-stock")
  upsertSafetyStockConfig(
    @Req() req: AuthReq,
    @ZodBody(upsertSafetyStockConfigSchema) body: any,
  ) {
  ...
  listReplenishmentOrders(
    ...
    return this.svc.listReplenishmentOrders(
      req.user.tenantId,
      status,
      priority,
    );
  ...
  createReplenishmentOrder(
    @Req() req: AuthReq,
    @ZodBody(createReplenishmentOrderSchema) body: any,
  ) {
    return this.svc.createReplenishmentOrder(
      req.user.tenantId,
      req.user.userId,
      body,
    );
  ...
  autoGenerateReplenishments(@Req() req: AuthReq) {
    return this.svc.autoGenerateReplenishments(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  approveReplenishmentOrder(
    ...
    return this.svc.approveReplenishmentOrder(
      req.user.tenantId,
      id,
      req.user.userId,
      body,
  ...
  generateStockoutPredictions(
    @Req() req: AuthReq,
    @ZodBody(generateStockoutPredictionsSchema) body: any,
  ) {
