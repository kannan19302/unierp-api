...
const createAdjustmentSchema = z.object({
  ...
  relatedPartyId: z.string().min(1),
  transactionType: z.string().min(1),
  originalAmount: z.number(),
  adjustedAmount: z.number(),
  reason: z.string().optional(),
  armLengthRange: z.string().optional(),
});
...
export class GlobalTaxDeepController {
  ...
  async getPolicies(
    ...
    return this.globalTaxService.getTransferPricingPolicies(
      req.user.tenantId,
      active,
    );
  }
  ...
  async getPolicyById(
    ...
    return this.globalTaxService.getTransferPricingPolicyById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createPolicy(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createPolicySchema) dto: any,
  ) {
    return this.globalTaxService.createTransferPricingPolicy(
      req.user.tenantId,
  ...
  async updatePolicy(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createPolicySchema.partial()) dto: any,
  ) {
    return this.globalTaxService.updateTransferPricingPolicy(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deletePolicy(
    ...
    return this.globalTaxService.deleteTransferPricingPolicy(
      req.user.tenantId,
      id,
    );
  }
  ...
  async approvePolicy(
    ...
    return this.globalTaxService.approveTransferPricingPolicy(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async getPoliciesByType(
    ...
    return this.globalTaxService.getPoliciesByType(
      req.user.tenantId,
      policyType,
    );
  }
  ...
  async getAdjustments(
    ...
    return this.globalTaxService.getTransferPricingAdjustments(
      req.user.tenantId,
      fiscalYear,
      policyId,
    );
  ...
  async getAdjustmentById(
    ...
    return this.globalTaxService.getTransferPricingAdjustmentById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createAdjustment(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createAdjustmentSchema) dto: any,
  ) {
    return this.globalTaxService.createTransferPricingAdjustment(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto,
    );
  ...
  async updateAdjustment(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createAdjustmentSchema.partial()) dto: any,
  ) {
    return this.globalTaxService.updateTransferPricingAdjustment(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async reviewAdjustment(
    ...
    return this.globalTaxService.reviewTransferPricingAdjustment(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async approveAdjustment(
    ...
    return this.globalTaxService.approveTransferPricingAdjustment(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async postAdjustment(
    ...
    return this.globalTaxService.postTransferPricingAdjustment(
      req.user.tenantId,
      id,
    );
  }
  ...
  async deleteAdjustment(
    ...
    return this.globalTaxService.deleteTransferPricingAdjustment(
      req.user.tenantId,
      id,
    );
  }
  ...
  async getAdjustmentsByPolicy(
    @Req() req: AuthenticatedRequest,
    @Param("policyId") policyId: string,
  ) {
    return this.globalTaxService.getAdjustmentsByPolicy(
      req.user.tenantId,
      policyId,
    );
  }
  ...
  async getApportionmentFactors(
    ...
    return this.globalTaxService.getApportionmentFactors(
      req.user.tenantId,
      fiscalYear,
      jurisdiction,
    );
  ...
  async getApportionmentFactorById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.globalTaxService.getApportionmentFactorById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createApportionmentFactor(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createApportionmentSchema) dto: any,
  ) {
    return this.globalTaxService.createApportionmentFactor(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto,
    );
  ...
  async updateApportionmentFactor(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createApportionmentSchema.partial()) dto: any,
  ) {
    return this.globalTaxService.updateApportionmentFactor(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async finalizeApportionmentFactor(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.globalTaxService.finalizeApportionmentFactor(
      req.user.tenantId,
      id,
    );
  }
  ...
  async deleteApportionmentFactor(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.globalTaxService.deleteApportionmentFactor(
      req.user.tenantId,
      id,
    );
  }
  ...
  async getFactorsByJurisdiction(
    ...
    return this.globalTaxService.getFactorsByJurisdiction(
      req.user.tenantId,
      orgId,
      fiscalYear,
      jurisdiction,
  ...
  async computeEffectiveApportionment(
    ...
    return this.globalTaxService.computeEffectiveApportionment(
      req.user.tenantId,
      orgId,
      fiscalYear,
    );
  ...
  async getDashboard(
    ...
    return this.globalTaxService.getTaxComplianceDashboard(
      req.user.tenantId,
      orgId,
    );
  }
  ...
  async getTransferPricingSummary(
    ...
    return this.globalTaxService.getTransferPricingSummary(
      req.user.tenantId,
      orgId,
      fiscalYear,
    );
  ...
  async getMultiStateSummary(
    @Req() req: AuthenticatedRequest,
    @Param("orgId") orgId: string,
    @Param("fiscalYear") fiscalYear: string,
  ) {
    return this.globalTaxService.getMultiStateReturnSummary(
      req.user.tenantId,
      orgId,
      fiscalYear,
    );
