...
export class ProcurementSchedulingController {
  ...
  async updatePaymentScheduleStatus(
    ...
    return this.paymentSchedulesService.updateStatus(
      req.user.tenantId,
      id,
      dto.status,
    );
  ...
  @TrackChanges("PaymentSchedule")
  @Permissions("procurement.purchase-order.create")
  async bulkCreateFromPo(
    @Req() req: AuthRequest,
    @Param("purchaseOrderId") poId: string,
    @Body() dto: { milestones: Array<{ dueDate: string; amount: number }> },
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.paymentSchedulesService.bulkCreateFromPo(
      req.user.tenantId,
      orgId,
      poId,
      dto.milestones,
  ...
  async getUpcomingPayments(
    ...
    return this.paymentSchedulesService.getUpcoming(
      req.user.tenantId,
  ...
  @Permissions("procurement.purchase-order.read")
  async getPaymentSchedulesByPo(
    @Req() req: AuthRequest,
    @Param("purchaseOrderId") poId: string,
  ) {
    return this.paymentSchedulesService.getSchedulesByPurchaseOrder(
      req.user.tenantId,
      poId,
    );
  }
  ...
  @Permissions("procurement.purchase-order.read")
  async getPaymentSchedulesByDateRange(
    @Req() req: AuthRequest,
    @Query() q: any,
  ) {
    return this.paymentSchedulesService.getSchedulesByDateRange(
      req.user.tenantId,
      q.startDate,
      q.endDate,
      q,
  ...
  async getPaymentForecast(
    ...
    return this.paymentSchedulesService.getPaymentForecast(
      req.user.tenantId,
  ...
  async getPendingApprovals(@Req() req: AuthRequest) {
    return this.procurementApprovalsService.getPendingApprovals(
      req.user.tenantId,
    );
  }
  ...
  async approveRequisition(@Req() req: AuthRequest, @Param("id") id: string) {
    return this.procurementApprovalsService.approveRequisition(
      req.user.tenantId,
      id,
    );
  }
  ...
  async rejectRequisition(
    ...
    return this.procurementApprovalsService.rejectRequisition(
      req.user.tenantId,
      id,
      dto.reason,
    );
  ...
  async approvePurchaseOrder(@Req() req: AuthRequest, @Param("id") id: string) {
    return this.procurementApprovalsService.approvePurchaseOrder(
      req.user.tenantId,
      id,
    );
  }
  ...
  async rejectPurchaseOrder(
    ...
    return this.procurementApprovalsService.rejectPurchaseOrder(
      req.user.tenantId,
      id,
      dto.reason,
    );
  ...
  async getApprovalPolicy(@Req() req: AuthRequest) {
    return this.procurementApprovalsService.getApprovalPolicy(
      req.user.tenantId,
    );
  }
  ...
  async setApprovalPolicy(@Req() req: AuthRequest, @Body() dto: any) {
    return this.procurementApprovalsService.setApprovalPolicy(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async getApprovalHistory(@Req() req: AuthRequest, @Query() q: any) {
    return this.procurementApprovalsService.getApprovalHistory(
      req.user.tenantId,
      q,
    );
  }
  ...
  async delegateApproval(@Req() req: AuthRequest, @Body() dto: any) {
    return this.procurementApprovalsService.delegateApproval(
      req.user.tenantId,
  ...
  async getMyPendingApprovals(@Req() req: AuthRequest) {
    return this.procurementApprovalsService.getMyPendingApprovals(
      req.user.tenantId,
      req.user.userId || "system",
    );
  }
  ...
  async getApprovalStatistics(@Req() req: AuthRequest) {
    return this.procurementApprovalsService.getApprovalStatistics(
      req.user.tenantId,
    );
  }
