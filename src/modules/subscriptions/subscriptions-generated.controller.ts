...
export class SubscriptionsGeneratedController {
  ...
  @ApiOperation({ summary: "List subscriptions-entity-18" })
  @Get("subscriptions-entity-18")
  @Permissions("subscriptions.subscriptionsEntity18.read")
  async listSubscriptionsEntity18(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity18(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-18" })
  @Get("subscriptions-entity-18/:id")
  @Permissions("subscriptions.subscriptionsEntity18.read")
  async getSubscriptionsEntity18(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity18(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-18" })
  @Post("subscriptions-entity-18")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-18" })
  @Put("subscriptions-entity-18/:id")
  @Permissions("subscriptions.subscriptionsEntity18.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-18" })
  @Delete("subscriptions-entity-18/:id")
  @Permissions("subscriptions.subscriptionsEntity18.delete")
  async deleteSubscriptionsEntity18(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity18(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-19" })
  @Get("subscriptions-entity-19")
  @Permissions("subscriptions.subscriptionsEntity19.read")
  async listSubscriptionsEntity19(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity19(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-19" })
  @Get("subscriptions-entity-19/:id")
  @Permissions("subscriptions.subscriptionsEntity19.read")
  async getSubscriptionsEntity19(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity19(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-19" })
  @Post("subscriptions-entity-19")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-19" })
  @Put("subscriptions-entity-19/:id")
  @Permissions("subscriptions.subscriptionsEntity19.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-19" })
  @Delete("subscriptions-entity-19/:id")
  @Permissions("subscriptions.subscriptionsEntity19.delete")
  async deleteSubscriptionsEntity19(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity19(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-20" })
  @Get("subscriptions-entity-20")
  @Permissions("subscriptions.subscriptionsEntity20.read")
  async listSubscriptionsEntity20(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity20(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-20" })
  @Get("subscriptions-entity-20/:id")
  @Permissions("subscriptions.subscriptionsEntity20.read")
  async getSubscriptionsEntity20(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity20(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-20" })
  @Post("subscriptions-entity-20")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-20" })
  @Put("subscriptions-entity-20/:id")
  @Permissions("subscriptions.subscriptionsEntity20.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-20" })
  @Delete("subscriptions-entity-20/:id")
  @Permissions("subscriptions.subscriptionsEntity20.delete")
  async deleteSubscriptionsEntity20(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity20(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-21" })
  @Get("subscriptions-entity-21")
  @Permissions("subscriptions.subscriptionsEntity21.read")
  async listSubscriptionsEntity21(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity21(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-21" })
  @Get("subscriptions-entity-21/:id")
  @Permissions("subscriptions.subscriptionsEntity21.read")
  async getSubscriptionsEntity21(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity21(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-21" })
  @Post("subscriptions-entity-21")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-21" })
  @Put("subscriptions-entity-21/:id")
  @Permissions("subscriptions.subscriptionsEntity21.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-21" })
  @Delete("subscriptions-entity-21/:id")
  @Permissions("subscriptions.subscriptionsEntity21.delete")
  async deleteSubscriptionsEntity21(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity21(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-22" })
  @Get("subscriptions-entity-22")
  @Permissions("subscriptions.subscriptionsEntity22.read")
  async listSubscriptionsEntity22(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity22(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-22" })
  @Get("subscriptions-entity-22/:id")
  @Permissions("subscriptions.subscriptionsEntity22.read")
  async getSubscriptionsEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-22" })
  @Post("subscriptions-entity-22")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-22" })
  @Put("subscriptions-entity-22/:id")
  @Permissions("subscriptions.subscriptionsEntity22.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-22" })
  @Delete("subscriptions-entity-22/:id")
  @Permissions("subscriptions.subscriptionsEntity22.delete")
  async deleteSubscriptionsEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-23" })
  @Get("subscriptions-entity-23")
  @Permissions("subscriptions.subscriptionsEntity23.read")
  async listSubscriptionsEntity23(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity23(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-23" })
  @Get("subscriptions-entity-23/:id")
  @Permissions("subscriptions.subscriptionsEntity23.read")
  async getSubscriptionsEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-23" })
  @Post("subscriptions-entity-23")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-23" })
  @Put("subscriptions-entity-23/:id")
  @Permissions("subscriptions.subscriptionsEntity23.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-23" })
  @Delete("subscriptions-entity-23/:id")
  @Permissions("subscriptions.subscriptionsEntity23.delete")
  async deleteSubscriptionsEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-24" })
  @Get("subscriptions-entity-24")
  @Permissions("subscriptions.subscriptionsEntity24.read")
  async listSubscriptionsEntity24(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity24(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-24" })
  @Get("subscriptions-entity-24/:id")
  @Permissions("subscriptions.subscriptionsEntity24.read")
  async getSubscriptionsEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-24" })
  @Post("subscriptions-entity-24")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-24" })
  @Put("subscriptions-entity-24/:id")
  @Permissions("subscriptions.subscriptionsEntity24.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-24" })
  @Delete("subscriptions-entity-24/:id")
  @Permissions("subscriptions.subscriptionsEntity24.delete")
  async deleteSubscriptionsEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-25" })
  @Get("subscriptions-entity-25")
  @Permissions("subscriptions.subscriptionsEntity25.read")
  async listSubscriptionsEntity25(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity25(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-25" })
  @Get("subscriptions-entity-25/:id")
  @Permissions("subscriptions.subscriptionsEntity25.read")
  async getSubscriptionsEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-25" })
  @Post("subscriptions-entity-25")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-25" })
  @Put("subscriptions-entity-25/:id")
  @Permissions("subscriptions.subscriptionsEntity25.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-25" })
  @Delete("subscriptions-entity-25/:id")
  @Permissions("subscriptions.subscriptionsEntity25.delete")
  async deleteSubscriptionsEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-26" })
  @Get("subscriptions-entity-26")
  @Permissions("subscriptions.subscriptionsEntity26.read")
  async listSubscriptionsEntity26(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity26(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-26" })
  @Get("subscriptions-entity-26/:id")
  @Permissions("subscriptions.subscriptionsEntity26.read")
  async getSubscriptionsEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-26" })
  @Post("subscriptions-entity-26")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-26" })
  @Put("subscriptions-entity-26/:id")
  @Permissions("subscriptions.subscriptionsEntity26.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-26" })
  @Delete("subscriptions-entity-26/:id")
  @Permissions("subscriptions.subscriptionsEntity26.delete")
  async deleteSubscriptionsEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-27" })
  @Get("subscriptions-entity-27")
  @Permissions("subscriptions.subscriptionsEntity27.read")
  async listSubscriptionsEntity27(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity27(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-27" })
  @Get("subscriptions-entity-27/:id")
  @Permissions("subscriptions.subscriptionsEntity27.read")
  async getSubscriptionsEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-27" })
  @Post("subscriptions-entity-27")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-27" })
  @Put("subscriptions-entity-27/:id")
  @Permissions("subscriptions.subscriptionsEntity27.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-27" })
  @Delete("subscriptions-entity-27/:id")
  @Permissions("subscriptions.subscriptionsEntity27.delete")
  async deleteSubscriptionsEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-28" })
  @Get("subscriptions-entity-28")
  @Permissions("subscriptions.subscriptionsEntity28.read")
  async listSubscriptionsEntity28(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity28(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-28" })
  @Get("subscriptions-entity-28/:id")
  @Permissions("subscriptions.subscriptionsEntity28.read")
  async getSubscriptionsEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-28" })
  @Post("subscriptions-entity-28")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-28" })
  @Put("subscriptions-entity-28/:id")
  @Permissions("subscriptions.subscriptionsEntity28.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-28" })
  @Delete("subscriptions-entity-28/:id")
  @Permissions("subscriptions.subscriptionsEntity28.delete")
  async deleteSubscriptionsEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-29" })
  @Get("subscriptions-entity-29")
  @Permissions("subscriptions.subscriptionsEntity29.read")
  async listSubscriptionsEntity29(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity29(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-29" })
  @Get("subscriptions-entity-29/:id")
  @Permissions("subscriptions.subscriptionsEntity29.read")
  async getSubscriptionsEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-29" })
  @Post("subscriptions-entity-29")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-29" })
  @Put("subscriptions-entity-29/:id")
  @Permissions("subscriptions.subscriptionsEntity29.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-29" })
  @Delete("subscriptions-entity-29/:id")
  @Permissions("subscriptions.subscriptionsEntity29.delete")
  async deleteSubscriptionsEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-30" })
  @Get("subscriptions-entity-30")
  @Permissions("subscriptions.subscriptionsEntity30.read")
  async listSubscriptionsEntity30(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity30(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-30" })
  @Get("subscriptions-entity-30/:id")
  @Permissions("subscriptions.subscriptionsEntity30.read")
  async getSubscriptionsEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-30" })
  @Post("subscriptions-entity-30")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-30" })
  @Put("subscriptions-entity-30/:id")
  @Permissions("subscriptions.subscriptionsEntity30.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-30" })
  @Delete("subscriptions-entity-30/:id")
  @Permissions("subscriptions.subscriptionsEntity30.delete")
  async deleteSubscriptionsEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-31" })
  @Get("subscriptions-entity-31")
  @Permissions("subscriptions.subscriptionsEntity31.read")
  async listSubscriptionsEntity31(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity31(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-31" })
  @Get("subscriptions-entity-31/:id")
  @Permissions("subscriptions.subscriptionsEntity31.read")
  async getSubscriptionsEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-31" })
  @Post("subscriptions-entity-31")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-31" })
  @Put("subscriptions-entity-31/:id")
  @Permissions("subscriptions.subscriptionsEntity31.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-31" })
  @Delete("subscriptions-entity-31/:id")
  @Permissions("subscriptions.subscriptionsEntity31.delete")
  async deleteSubscriptionsEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-32" })
  @Get("subscriptions-entity-32")
  @Permissions("subscriptions.subscriptionsEntity32.read")
  async listSubscriptionsEntity32(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity32(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-32" })
  @Get("subscriptions-entity-32/:id")
  @Permissions("subscriptions.subscriptionsEntity32.read")
  async getSubscriptionsEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-32" })
  @Post("subscriptions-entity-32")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-32" })
  @Put("subscriptions-entity-32/:id")
  @Permissions("subscriptions.subscriptionsEntity32.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-32" })
  @Delete("subscriptions-entity-32/:id")
  @Permissions("subscriptions.subscriptionsEntity32.delete")
  async deleteSubscriptionsEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-33" })
  @Get("subscriptions-entity-33")
  @Permissions("subscriptions.subscriptionsEntity33.read")
  async listSubscriptionsEntity33(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity33(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-33" })
  @Get("subscriptions-entity-33/:id")
  @Permissions("subscriptions.subscriptionsEntity33.read")
  async getSubscriptionsEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-33" })
  @Post("subscriptions-entity-33")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-33" })
  @Put("subscriptions-entity-33/:id")
  @Permissions("subscriptions.subscriptionsEntity33.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-33" })
  @Delete("subscriptions-entity-33/:id")
  @Permissions("subscriptions.subscriptionsEntity33.delete")
  async deleteSubscriptionsEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-34" })
  @Get("subscriptions-entity-34")
  @Permissions("subscriptions.subscriptionsEntity34.read")
  async listSubscriptionsEntity34(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity34(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-34" })
  @Get("subscriptions-entity-34/:id")
  @Permissions("subscriptions.subscriptionsEntity34.read")
  async getSubscriptionsEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-34" })
  @Post("subscriptions-entity-34")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-34" })
  @Put("subscriptions-entity-34/:id")
  @Permissions("subscriptions.subscriptionsEntity34.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-34" })
  @Delete("subscriptions-entity-34/:id")
  @Permissions("subscriptions.subscriptionsEntity34.delete")
  async deleteSubscriptionsEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-35" })
  @Get("subscriptions-entity-35")
  @Permissions("subscriptions.subscriptionsEntity35.read")
  async listSubscriptionsEntity35(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity35(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-35" })
  @Get("subscriptions-entity-35/:id")
  @Permissions("subscriptions.subscriptionsEntity35.read")
  async getSubscriptionsEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-35" })
  @Post("subscriptions-entity-35")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-35" })
  @Put("subscriptions-entity-35/:id")
  @Permissions("subscriptions.subscriptionsEntity35.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-35" })
  @Delete("subscriptions-entity-35/:id")
  @Permissions("subscriptions.subscriptionsEntity35.delete")
  async deleteSubscriptionsEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-36" })
  @Get("subscriptions-entity-36")
  @Permissions("subscriptions.subscriptionsEntity36.read")
  async listSubscriptionsEntity36(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity36(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-36" })
  @Get("subscriptions-entity-36/:id")
  @Permissions("subscriptions.subscriptionsEntity36.read")
  async getSubscriptionsEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-36" })
  @Post("subscriptions-entity-36")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-36" })
  @Put("subscriptions-entity-36/:id")
  @Permissions("subscriptions.subscriptionsEntity36.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-36" })
  @Delete("subscriptions-entity-36/:id")
  @Permissions("subscriptions.subscriptionsEntity36.delete")
  async deleteSubscriptionsEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-37" })
  @Get("subscriptions-entity-37")
  @Permissions("subscriptions.subscriptionsEntity37.read")
  async listSubscriptionsEntity37(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity37(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-37" })
  @Get("subscriptions-entity-37/:id")
  @Permissions("subscriptions.subscriptionsEntity37.read")
  async getSubscriptionsEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-37" })
  @Post("subscriptions-entity-37")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-37" })
  @Put("subscriptions-entity-37/:id")
  @Permissions("subscriptions.subscriptionsEntity37.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-37" })
  @Delete("subscriptions-entity-37/:id")
  @Permissions("subscriptions.subscriptionsEntity37.delete")
  async deleteSubscriptionsEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-38" })
  @Get("subscriptions-entity-38")
  @Permissions("subscriptions.subscriptionsEntity38.read")
  async listSubscriptionsEntity38(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity38(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-38" })
  @Get("subscriptions-entity-38/:id")
  @Permissions("subscriptions.subscriptionsEntity38.read")
  async getSubscriptionsEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-38" })
  @Post("subscriptions-entity-38")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-38" })
  @Put("subscriptions-entity-38/:id")
  @Permissions("subscriptions.subscriptionsEntity38.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-38" })
  @Delete("subscriptions-entity-38/:id")
  @Permissions("subscriptions.subscriptionsEntity38.delete")
  async deleteSubscriptionsEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-39" })
  @Get("subscriptions-entity-39")
  @Permissions("subscriptions.subscriptionsEntity39.read")
  async listSubscriptionsEntity39(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity39(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-39" })
  @Get("subscriptions-entity-39/:id")
  @Permissions("subscriptions.subscriptionsEntity39.read")
  async getSubscriptionsEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-39" })
  @Post("subscriptions-entity-39")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-39" })
  @Put("subscriptions-entity-39/:id")
  @Permissions("subscriptions.subscriptionsEntity39.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-39" })
  @Delete("subscriptions-entity-39/:id")
  @Permissions("subscriptions.subscriptionsEntity39.delete")
  async deleteSubscriptionsEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List subscriptions-entity-40" })
  @Get("subscriptions-entity-40")
  @Permissions("subscriptions.subscriptionsEntity40.read")
  async listSubscriptionsEntity40(@Req() req: AuthenticatedRequest) {
    return this.svc.listSubscriptionsEntity40(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get subscriptions-entity-40" })
  @Get("subscriptions-entity-40/:id")
  @Permissions("subscriptions.subscriptionsEntity40.read")
  async getSubscriptionsEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSubscriptionsEntity40(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create subscriptions-entity-40" })
  @Post("subscriptions-entity-40")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update subscriptions-entity-40" })
  @Put("subscriptions-entity-40/:id")
  @Permissions("subscriptions.subscriptionsEntity40.update")
  ...
  @ApiOperation({ summary: "Delete subscriptions-entity-40" })
  @Delete("subscriptions-entity-40/:id")
  @Permissions("subscriptions.subscriptionsEntity40.delete")
  async deleteSubscriptionsEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSubscriptionsEntity40(req.user.tenantId, id);
  }
}
