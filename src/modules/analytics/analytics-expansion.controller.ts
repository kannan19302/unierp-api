...
export class AnalyticsExpansionController {
  ...
  async createReportFilter(
    @Req() req: AuthenticatedRequest,
    @ZodBody(ReportFilterSchema) dto: unknown,
  ) {
  ...
  async createDashboardWidget(
    @Req() req: AuthenticatedRequest,
    @ZodBody(DashboardWidgetSchema) dto: unknown,
  ) {
  ...
  async updateDashboardWidget(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(DashboardWidgetSchema.partial()) dto: unknown,
  ) {
    return this.service.updateDashboardWidget(
      req.user.tenantId,
      id,
      dto as any,
    );
  ...
  async recordKpiValue(
    @Req() req: AuthenticatedRequest,
    @ZodBody(KpiValueSchema) dto: unknown,
  ) {
  ...
  async createScheduledExport(
    @Req() req: AuthenticatedRequest,
    @ZodBody(ScheduledExportSchema) dto: unknown,
  ) {
  ...
  async updateScheduledExport(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(ScheduledExportSchema.partial()) dto: unknown,
  ) {
