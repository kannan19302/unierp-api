...
export class FreightClaimsController {
  ...
  reviewDamageReport(
    ...
    @Param("id") id: string,
    @Body() dto: { decision: "UNDER_REVIEW" | "RESOLVED" | "CLOSED" },
  ) {
    return this.svc.reviewDamageReport(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.decision,
  ...
  updateClaimStatus(
    ...
    return this.svc.updateClaimStatus(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  addClaimEvent(
    @Request() req: AuthRequest,
    @Param("id") id: string,
    @Body() dto: { description: string; eventType: string },
  ) {
    return this.svc.addClaimEvent(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.description,
