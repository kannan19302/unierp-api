...
export class FinanceEnterpriseController {
  ...
  async getCashFlowStatement(@Req() req: any, @Query('periodStart') periodStart?: string, @Query('periodEnd') periodEnd?: string) {
    return this.service.getCashFlowStatement(req.tenantId, periodStart, periodEnd);
  }
  ...
  async getRevenueRecognitionSchedule(@Req() req: any, @Query('contractId') contractId?: string) {
  ...
  async getTaxSummary(@Req() req: any, @Query('periodStart') periodStart?: string, @Query('periodEnd') periodEnd?: string) {
  ...
  async getBudgetVariance(@Req() req: any, @Param('budgetId') budgetId: string) {
  ...
  async exportFinancialReport(@Req() req: any, @Param('reportType') reportType: string, @Query('format') format: string, @Query() params: any) {
    return this.service.exportFinancialReport(req.tenantId, reportType, format || 'json', params);
  }
}
