...
export class ScheduledReportsController {
  ...
  async createScheduledReport(
    ...
    return this.scheduledReportsService.createScheduledReport(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  async updateScheduledReport(
    ...
    return this.scheduledReportsService.updateScheduledReport(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deleteScheduledReport(
    ...
    return this.scheduledReportsService.deleteScheduledReport(
      req.user.tenantId,
      id,
    );
  }
  ...
  async runScheduledReport(
    ...
    return this.scheduledReportsService.runScheduledReport(
      req.user.tenantId,
      id,
    );
  }
