...
export class AdvancedHrController {
  ...
  async createEmployeeDocument(
    ...
    return this.hrService.createEmployeeDocument(
      req.user.tenantId,
      employeeId,
      dto,
    );
  ...
  async addOnboardingItem(
    ...
    return this.hrService.addOnboardingItem(
      req.user.tenantId,
      checklistId,
      dto,
    );
  ...
  async addOffboardingItem(
    ...
    return this.hrService.addOffboardingItem(
      req.user.tenantId,
      checklistId,
      dto,
    );
  ...
  async updateKeyResultProgress(
    ...
    return this.hrService.updateKeyResultProgress(
      req.user.tenantId,
      id,
      dto.current,
    );
  ...
  async createGoalComment(
    ...
    @Param("goalId") goalId: string,
    @ZodBody(z.any())
    dto: { comment: string; fileUrl?: string; fileName?: string },
  ) {
  ...
  async enrollParticipant(
    ...
    return this.hrService.enrollParticipant(
      req.user.tenantId,
      trainingId,
      dto.employeeId,
    );
  ...
  async unenrollParticipant(
    ...
    return this.hrService.unenrollParticipant(
      req.user.tenantId,
      trainingId,
      employeeId,
    );
  ...
  async updateEnrollmentStatus(
    ...
    return this.hrService.updateEnrollmentStatus(
      req.user.tenantId,
      trainingId,
      employeeId,
      dto.status,
  ...
  async checkInRFID(
    ...
    return this.hrService.checkInRFID(
      req.user.tenantId,
      dto.employeeCode,
      dto.actionType,
    );
  ...
  async getSelfServiceDashboard(@Req() req: AuthenticatedRequest) {
    return this.hrService.getEmployeeDashboardByUserId(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async updateSelfServiceProfile(
    ...
    return this.hrService.updateEmployeeSelfDetails(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
