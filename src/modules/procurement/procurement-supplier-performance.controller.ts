...
export class ProcurementSupplierPerformanceController {
  ...
  async listScorecards(
    ...
    return this.supplierPerformanceService.listScorecards(
      req.user.tenantId,
      supplierId,
      period,
    );
  ...
  async createScorecard(@Req() req: AuthenticatedRequest, @Body() body: any) {
    return this.supplierPerformanceService.createScorecard(
      req.user.tenantId,
      body,
  ...
  async updateScorecard(
    ...
    return this.supplierPerformanceService.updateScorecard(
      req.user.tenantId,
      id,
      body,
      req.user.userId || "system",
  ...
  async listKpis(
    ...
    return this.supplierPerformanceService.listKpis(
      req.user.tenantId,
      scorecardId,
    );
  }
  ...
  async recordKpiValue(@Req() req: AuthenticatedRequest, @Body() body: any) {
    return this.supplierPerformanceService.recordKpiValue(
      req.user.tenantId,
      body,
      req.user.userId || "system",
    );
  ...
  async listAssessments(
    ...
    return this.supplierPerformanceService.listAssessments(
      req.user.tenantId,
      supplierId,
    );
  }
  ...
  async createAssessment(@Req() req: AuthenticatedRequest, @Body() body: any) {
    return this.supplierPerformanceService.createAssessment(
      req.user.tenantId,
      body,
      req.user.userId || "system",
    );
  ...
  async getSupplierRiskProfile(
    ...
    return this.supplierPerformanceService.getSupplierRiskProfile(
      req.user.tenantId,
      supplierId,
    );
  }
  ...
  async listSupplierNcrs(
    ...
    return this.supplierPerformanceService.listSupplierNcrs(
      req.user.tenantId,
      supplierId,
      status,
    );
  ...
  async getTopSuppliers(
    ...
    return this.supplierPerformanceService.getTopSuppliers(
      req.user.tenantId,
  ...
  async getSupplierComparison(
    ...
    return this.supplierPerformanceService.getSupplierComparison(
      req.user.tenantId,
      body.supplierIds,
    );
  }
