...
export class CrmController {
  ...
  async createCustomerTag(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createCustomerTagSchema) dto: CreateCustomerTagInput,
  ) {
  ...
  async assignCustomerTag(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ tagId: z.string().min(1) })) body: { tagId: string },
  ) {
  ...
  async createCustomer(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createCustomerSchema) dto: CreateCustomerInput,
  ) {
  ...
  async updateCustomerStatus(
    ...
    return this.crmService.updateCustomerStatus(
      req.user.tenantId,
      id,
      body.status,
    );
  ...
  async placeCreditHold(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ reason: z.string().max(500).optional() }))
    body: { reason?: string },
  ) {
    return this.crmService.toggleCustomerCreditHold(
      req.user.tenantId,
      id,
      true,
      body.reason,
  ...
  async bulkUpdateCustomerStatus(
    ...
    return this.crmService.bulkUpdateCustomerStatus(
      req.user.tenantId,
      body.ids,
      body.status,
    );
  ...
  async createVendor(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createVendorSchema) dto: CreateVendorInput,
  ) {
    return this.crmService.createVendor(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
    );
  ...
  async updateVendor(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateVendorSchema) dto: UpdateVendorInput,
  ) {
  ...
  async updateVendorStatus(
    ...
    return this.crmService.updateVendorStatus(
      req.user.tenantId,
      id,
      body.status,
    );
  ...
  async addVendorNote(
    ...
    return this.crmService.addVendorNote(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      id,
      dto,
  ...
  async bulkUpdateVendorStatus(
    ...
    return this.crmService.bulkUpdateVendorStatus(
      req.user.tenantId,
      body.ids,
      body.status,
    );
  ...
  async createContact(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createContactSchema) dto: CreateContactInput,
  ) {
  ...
  async updateContact(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateContactSchema) dto: UpdateContactInput,
  ) {
  ...
  @ApiOperation({
    summary: "Get leads with no recent activity (at risk of going cold)",
  })
  @Get("leads/stalled")
  @Permissions("crm.lead.read")
  async getStalledLeads(
    @Req() req: AuthenticatedRequest,
    @Query("staleDays") staleDays?: string,
  ) {
    return this.crmService.getStalledLeads(
      req.user.tenantId,
  ...
  @ApiOperation({
    summary:
      "Get lead 360 summary (activities, converted opportunities, scoring metrics)",
  })
  ...
  async createLead(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateLeadInput,
  ) {
  ...
  async updateLead(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateLeadInput,
  ) {
  ...
  async updateLeadStatus(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) body: { status: string },
  ) {
  ...
  async reactivateLead(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) body: { reason?: string },
  ) {
  ...
  async bulkUpdateLeadStatus(
    ...
    return this.crmService.bulkUpdateLeadStatus(
      req.user.tenantId,
      body.ids,
      body.status,
    );
  ...
  async exportLeads(
    ...
    return this.crmService.exportLeadsData(req.user.tenantId, {
      search,
      status,
    });
  }
  ...
  async createPipeline(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateSalesPipelineInput,
  ) {
    return {
      data: await this.crmService.createPipeline(req.user.tenantId, dto),
    };
  }
  ...
  @ApiOperation({
    summary: "Get opportunities (paginated, searchable, sortable)",
  })
  @Get("opportunities")
  ...
  @ApiOperation({
    summary:
      "Get opportunity 360 summary (line items, activities, weighted value, aging)",
  })
  ...
  async createOpportunity(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateOpportunityInput,
  ) {
  ...
  async updateOpportunity(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateOpportunityInput,
  ) {
  ...
  async updateOpportunityStage(
    ...
    return this.crmService.updateOpportunityStage(
      req.user.tenantId,
      id,
      body.stage,
      body.probability,
  ...
  async exportOpportunities(
    ...
    return this.crmService.exportOpportunities(req.user.tenantId, {
      pipelineId,
      stage,
      search,
    });
  ...
  async bulkUpdateOpportunityStage(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.object({ ids: z.array(z.string()), stage: z.string() }))
    body: { ids: string[]; stage: string },
  ) {
    return this.crmService.bulkUpdateOpportunityStage(
      req.user.tenantId,
      body.ids,
      body.stage,
    );
  ...
  async createActivity(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateActivityInput,
  ) {
  ...
  async createEmailTemplate(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateEmailTemplateInput,
  ) {
  ...
  async updateEmailTemplate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateEmailTemplateInput,
  ) {
  ...
  async createCampaign(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCampaignInput,
  ) {
  ...
  @Permissions("crm.opportunity.update")
  async addOpportunityLineItem(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: CreateOpportunityLineItemInput,
  ) {
  ...
  @Permissions("crm.opportunity.update")
  async updateOpportunityLineItem(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Param("itemId") itemId: string,
    @ZodBody(z.any()) dto: UpdateOpportunityLineItemInput,
  ) {
    return this.crmService.updateOpportunityLineItem(
      req.user.tenantId,
      id,
      itemId,
      dto,
  ...
  @Permissions("crm.opportunity.update")
  async deleteOpportunityLineItem(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Param("itemId") itemId: string,
  ) {
    return this.crmService.deleteOpportunityLineItem(
      req.user.tenantId,
      id,
      itemId,
    );
  ...
  @ApiOperation({
    summary: "Get crm products (paginated, searchable, sortable)",
  })
  @Get("products")
  ...
  async createCrmProduct(
    ...
    return this.crmService.createCrmProduct(
      req.user.tenantId,
      req.user.orgId || "",
      dto,
    );
  ...
  @ApiOperation({
    summary: "Get price books (paginated, searchable, sortable)",
  })
  @Get("price-books")
  @Permissions("crm.product.read")
  async getPriceBooks(
  ...
  async createPriceBook(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreatePriceBookInput,
  ) {
    return this.crmService.createPriceBook(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
    );
  ...
  async updatePriceBook(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdatePriceBookInput,
  ) {
  ...
  async addPriceBookEntry(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: CreatePriceBookEntryInput,
  ) {
  ...
  async createContactTag(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateContactTagInput,
  ) {
  ...
  @Permissions("crm.contact.update")
  async assignContactTag(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) body: { tagId: string },
  ) {
  ...
  async createSalesTarget(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateSalesTargetInput,
  ) {
    return this.crmService.createSalesTarget(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
    );
  ...
  async updateSalesTarget(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateSalesTargetInput,
  ) {
  ...
  async createSavedReport(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateSavedReportInput,
  ) {
    return this.crmService.createSavedReport(
      req.user.tenantId,
      dto,
      req.user.userId || "system",
    );
  ...
  async createWorkflowRule(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCrmWorkflowRuleInput,
  ) {
    return this.crmService.createWorkflowRule(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
      req.user.userId || "system",
  ...
  async updateWorkflowRule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateCrmWorkflowRuleInput,
  ) {
  ...
  async createEmailSequence(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateEmailSequenceInput,
  ) {
    return this.crmService.createEmailSequence(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
      req.user.userId || "system",
  ...
  async enrollInSequence(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: EnrollSequenceInput,
  ) {
  ...
  async createTerritory(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateSalesTerritoryInput,
  ) {
    return this.crmService.createTerritory(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
    );
  ...
  async updateTerritory(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateSalesTerritoryInput,
  ) {
  ...
  async addTeamMember(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: AddTeamMemberInput,
  ) {
  ...
  async createCommissionRule(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCommissionRuleInput,
  ) {
    return this.crmService.createCommissionRule(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
    );
  ...
  async updateCommissionRule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateCommissionRuleInput,
  ) {
  ...
  async calculateCommissions(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CalculateCommissionsInput,
  ) {
  ...
  async createWebForm(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateWebToLeadFormInput,
  ) {
    return this.crmService.createWebForm(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
    );
  ...
  async updateWebForm(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateWebToLeadFormInput,
  ) {
  ...
  async submitWebForm(
    @Param("id") id: string,
    @ZodBody(z.any()) dto: SubmitWebFormInput,
  ) {
  ...
  async getCrmDocuments(
    ...
    return this.crmService.getCrmDocuments(
      req.user.tenantId,
      entityType,
      entityId,
    );
  ...
  async createCrmDocument(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCrmDocumentInput,
  ) {
    return this.crmService.createCrmDocument(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
      req.user.userId || "system",
  ...
  async importContacts(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) body: { rows: Array<Record<string, string>> },
  ) {
    return this.crmService.importContacts(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      body.rows,
    );
  ...
  async importLeads(
    ...
    return this.crmService.importLeads(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      body.rows,
    );
  ...
  async createCustomField(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCustomFieldInput,
  ) {
    return this.crmService.createCustomField(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
      req.user.userId,
  ...
  async updateCustomField(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateCustomFieldInput,
  ) {
  ...
  async getCustomFieldValues(
    ...
    return this.crmService.getCustomFieldValues(
      req.user.tenantId,
      entityType,
      entityId,
    );
  ...
  async upsertCustomFieldValues(
    ...
    @Param("entityId") entityId: string,
    @ZodBody(z.any())
    body: { values: Array<{ fieldId: string; value: string | null }> },
  ) {
    return this.crmService.upsertCustomFieldValues(
      req.user.tenantId,
      entityType,
      entityId,
      body.values,
  ...
  async createRecordType(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateRecordTypeInput,
  ) {
    return this.crmService.createRecordType(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
    );
  ...
  async updateRecordType(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateRecordTypeInput,
  ) {
  ...
  async createApprovalProcess(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateApprovalProcessInput,
  ) {
    return this.crmService.createApprovalProcess(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
      req.user.userId,
  ...
  async updateApprovalProcess(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateApprovalProcessInput,
  ) {
  ...
  async submitForApproval(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any())
    body: { entityType: string; entityId: string; processId?: string },
  ) {
    return this.crmService.submitForApproval(
      req.user.tenantId,
      req.user.userId,
      body.entityType,
      body.entityId,
  ...
  async getPendingApprovals(@Req() req: AuthenticatedRequest) {
    return this.crmService.getPendingApprovals(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async getApprovalHistory(
    ...
    return this.crmService.getApprovalHistory(
      req.user.tenantId,
      entityType,
      entityId,
    );
  ...
  async approveRequest(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) body: { comments?: string },
  ) {
    return this.crmService.approveRequest(
      req.user.tenantId,
      id,
      req.user.userId,
      body.comments,
  ...
  async rejectRequest(
    ...
    return this.crmService.rejectRequest(
      req.user.tenantId,
      id,
      req.user.userId,
      body.comments,
  ...
  async recallRequest(
    ...
    return this.crmService.recallRequest(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async createQuotationTemplate(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateQuotationTemplateInput,
  ) {
    return this.crmService.createQuotationTemplate(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
    );
  ...
  async updateQuotationTemplate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateQuotationTemplateInput,
  ) {
  ...
  async createQuotationVersion(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) body: { changeNote?: string },
  ) {
    return this.crmService.createQuotationVersion(
      req.user.tenantId,
      id,
      req.user.userId,
      body.changeNote,
  ...
  async cloneQuotation(
    ...
    return this.crmService.cloneQuotation(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async sendForSignature(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) body: { signerName: string; signerEmail: string },
  ) {
    return this.crmService.sendForSignature(
      req.user.tenantId,
      id,
      body.signerName,
      body.signerEmail,
  ...
  async submitSignature(
    ...
    @ZodBody(z.any()) body: { signatureData: string },
    @Req() req: Request,
  ) {
    return this.crmService.submitSignature(
      token,
      body.signatureData,
      req.ip || "unknown",
    );
  ...
  async createComment(
    ...
    @Param("entityType") entityType: string,
    @Param("entityId") entityId: string,
    @ZodBody(z.any()) dto: CreateCrmCommentInput,
  ) {
    return this.crmService.createComment(
      req.user.tenantId,
      req.user.userId,
      entityType,
      entityId,
  ...
  async updateComment(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) body: { body: string },
  ) {
    return this.crmService.updateComment(
      req.user.tenantId,
      id,
      req.user.userId,
      body.body,
  ...
  async deleteComment(
    ...
    return this.crmService.deleteComment(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async getFollowers(
    ...
    return this.crmService.getFollowers(
      req.user.tenantId,
      entityType,
      entityId,
    );
  ...
  async followRecord(
    ...
    return this.crmService.followRecord(
      req.user.tenantId,
      req.user.userId,
      entityType,
      entityId,
  ...
  async unfollowRecord(
    ...
    return this.crmService.unfollowRecord(
      req.user.tenantId,
      req.user.userId,
      entityType,
      entityId,
  ...
  async createNote(
    ...
    @Param("entityType") entityType: string,
    @Param("entityId") entityId: string,
    @ZodBody(z.any()) dto: CreateCrmNoteInput,
  ) {
    return this.crmService.createNote(
      req.user.tenantId,
      req.user.userId,
      entityType,
      entityId,
  ...
  async updateNote(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateCrmNoteInput,
  ) {
  ...
  async getUnifiedActivityFeed(
    ...
    return this.crmService.getUnifiedActivityFeed(
      req.user.tenantId,
      entityType,
      entityId,
    );
  ...
  async createPlaybook(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreatePlaybookInput,
  ) {
    return this.crmService.createPlaybook(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
      req.user.userId,
  ...
  async updatePlaybook(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdatePlaybookInput,
  ) {
  ...
  async upsertPlaybookStages(
    ...
    return this.crmService.upsertPlaybookStages(
      req.user.tenantId,
      id,
      body.stages,
    );
  ...
  async createBattlecard(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateBattlecardInput,
  ) {
    return this.crmService.createBattlecard(
      req.user.tenantId,
      dto,
      req.user.userId,
    );
  ...
  async updateBattlecard(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateBattlecardInput,
  ) {
  ...
  @Permissions("crm.settings.read")
  async getBattlecardByCompetitor(
    @Req() req: AuthenticatedRequest,
    @Param("competitor") competitor: string,
  ) {
    return this.crmService.getBattlecardByCompetitor(
      req.user.tenantId,
      competitor,
    );
  }
  ...
  async toggleChecklistItem(
    ...
    return this.crmService.toggleChecklistItem(
      req.user.tenantId,
      id,
      itemId,
      req.user.userId,
  ...
  @Permissions("crm.opportunity.read")
  async validateStageAdvance(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) body: { targetStage: string },
  ) {
    return this.crmService.validateStageAdvance(
      req.user.tenantId,
      id,
      body.targetStage,
    );
  ...
  async createDashboard(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCrmDashboardInput,
  ) {
    return this.crmService.createDashboard(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      req.user.userId,
      dto,
  ...
  async updateDashboard(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateCrmDashboardInput,
  ) {
  ...
  async cloneDashboard(
    ...
    return this.crmService.cloneDashboard(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async addWidget(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: CreateDashboardWidgetInput,
  ) {
  ...
  async updateWidget(
    ...
    @ZodBody(z.any()) dto: UpdateDashboardWidgetInput,
  ) {
  ...
  async updateDashboardLayout(
    ...
    return this.crmService.updateDashboardLayout(
      req.user.tenantId,
      id,
      body.layout,
    );
  ...
  @ApiOperation({
    summary: "Get case 360 summary (SLA rollup + comments + customer/contact)",
  })
  @Permissions("crm.case.read")
  ...
  async addCaseComment(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: { body: string; isInternal?: boolean },
  ) {
    return this.crmService.addCaseComment(req.user.tenantId, id, {
      ...dto,
  ...
  async bulkUpdateCaseStatus(
    ...
    return this.crmService.bulkUpdateCaseStatus(
      req.user.tenantId,
      body.ids,
      body.status,
    );
  ...
  async exportCases(
    ...
    return this.crmService.exportCases(req.user.tenantId, {
      search,
      status,
      priority,
    });
