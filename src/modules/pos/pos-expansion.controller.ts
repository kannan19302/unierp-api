...
import {
  CreatePosShiftSchema,
  ClosePosShiftSchema,
  CreatePosRegisterSchema,
  ClosePosRegisterSchema,
  CreatePosPaymentMethodSchema,
  UpdatePosPaymentMethodSchema,
  CreatePosRefundSchema,
  ApprovePosRefundSchema,
  IssuePosGiftCardSchema,
  TopUpPosGiftCardSchema,
  CreatePosOrderTypeSchema,
  CreatePosDiscountRuleSchema,
  CreatePosTaxRuleSchema,
  CreatePosKitchenDisplaySchema,
  UpdatePosKitchenOrderStatusSchema,
  CreatePosSplitPaymentSchema,
...
export class PosExpansionController {
  ...
  async startShift(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosShiftSchema) dto: any,
  ) {
  ...
  async closeShift(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(ClosePosShiftSchema) dto: any,
  ) {
  ...
  async addCashDrawer(
    ...
    @ZodBody(
      z.object({
        type: z.enum(["CASH_IN", "CASH_OUT", "DECLARE"]),
        amount: z.number(),
    ...
    return this.posExpansionService.addCashDrawer(req.user.tenantId, id, {
      ...dto,
  ...
  async openRegister(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosRegisterSchema) dto: any,
  ) {
    return this.posExpansionService.openRegister(
      req.user.tenantId,
      dto,
      req.user.userId,
    );
  ...
  async closeRegister(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(ClosePosRegisterSchema) dto: any,
  ) {
  ...
  async createPaymentMethod(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosPaymentMethodSchema) dto: any,
  ) {
  ...
  async updatePaymentMethod(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(UpdatePosPaymentMethodSchema) dto: any,
  ) {
    return this.posExpansionService.updatePaymentMethod(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async createRefund(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosRefundSchema) dto: any,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.posExpansionService.createRefund(req.user.tenantId, orgId, {
      ...dto,
  ...
  async approveRefund(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(ApprovePosRefundSchema) dto: any,
  ) {
  ...
  async issueGiftCard(
    @Req() req: AuthenticatedRequest,
    @ZodBody(IssuePosGiftCardSchema) dto: any,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.posExpansionService.issueGiftCard(
      req.user.tenantId,
      orgId,
      dto,
      req.user.userId,
  ...
  async topUpGiftCard(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(TopUpPosGiftCardSchema) dto: any,
  ) {
    return this.posExpansionService.topUpGiftCard(
      req.user.tenantId,
      id,
      dto,
      req.user.userId,
  ...
  async getGiftCardTransactions(
    ...
    return this.posExpansionService.getGiftCardTransactions(
      req.user.tenantId,
      id,
    );
  }
  ...
  async checkGiftCardBalance(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.object({ code: z.string() })) dto: any,
  ) {
    return this.posExpansionService.checkGiftCardBalance(
      req.user.tenantId,
      dto.code,
    );
  }
  ...
  async createOrderType(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosOrderTypeSchema) dto: any,
  ) {
  ...
  async updateOrderType(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreatePosOrderTypeSchema.partial()) dto: any,
  ) {
  ...
  async createDiscountRule(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosDiscountRuleSchema) dto: any,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.posExpansionService.createDiscountRule(
      req.user.tenantId,
      orgId,
      dto,
    );
  ...
  async updateDiscountRule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreatePosDiscountRuleSchema.partial()) dto: any,
  ) {
    return this.posExpansionService.updateDiscountRule(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async createTaxRule(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosTaxRuleSchema) dto: any,
  ) {
  ...
  async updateTaxRule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreatePosTaxRuleSchema.partial()) dto: any,
  ) {
  ...
  async createKitchenDisplay(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosKitchenDisplaySchema) dto: any,
  ) {
    return this.posExpansionService.createKitchenDisplay(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async updateKitchenDisplay(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreatePosKitchenDisplaySchema.partial()) dto: any,
  ) {
    return this.posExpansionService.updateKitchenDisplay(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async getKitchenOrders(
    ...
    return this.posExpansionService.getKitchenOrders(
      req.user.tenantId,
      id,
      status,
    );
  ...
  async updateKitchenOrderStatus(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(UpdatePosKitchenOrderStatusSchema) dto: any,
  ) {
    return this.posExpansionService.updateKitchenOrderStatus(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async processSplitPayment(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreatePosSplitPaymentSchema) dto: any,
  ) {
  ...
  async getSplitPayments(
    ...
    return this.posExpansionService.getSplitPayments(
      req.user.tenantId,
      orderId,
    );
  }
