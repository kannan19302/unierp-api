...
import {
  ...
  addTerritoryMemberSchema,
  createTerritoryRuleSchema,
  updateTerritoryRuleSchema,
  createTerritoryForecastSchema,
  updateTerritoryForecastSchema,
  realignTerritorySchema,
  assignEntitySchema,
  CreateTerritoryDto,
  UpdateTerritoryDto,
  AddTerritoryMemberDto,
  CreateTerritoryRuleDto,
  UpdateTerritoryRuleDto,
  CreateTerritoryForecastDto,
  UpdateTerritoryForecastDto,
  RealignTerritoryDto,
  AssignEntityDto,
...
export class SalesTerritoryController {
  ...
  async getAssignmentLogs(
    ...
    return this.service.getAssignmentLogs(
      req.user.tenantId,
      entityType,
      entityId,
    );
  ...
  async create(
    @Req() req: AuthReq,
    @ZodBody(createTerritorySchema) dto: CreateTerritoryDto,
  ) {
    return this.service.createTerritory(
      req.user.tenantId,
  ...
  async update(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateTerritorySchema) dto: UpdateTerritoryDto,
  ) {
  ...
  async addMember(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(addTerritoryMemberSchema) dto: AddTerritoryMemberDto,
  ) {
  ...
  async createRule(
    @Req() req: AuthReq,
    @ZodBody(createTerritoryRuleSchema) dto: CreateTerritoryRuleDto,
  ) {
  ...
  async updateRule(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateTerritoryRuleSchema) dto: UpdateTerritoryRuleDto,
  ) {
  ...
  async assignEntity(
    @Req() req: AuthReq,
    @ZodBody(assignEntitySchema) dto: AssignEntityDto,
  ) {
  ...
  async createForecast(
    @Req() req: AuthReq,
    @ZodBody(createTerritoryForecastSchema) dto: CreateTerritoryForecastDto,
  ) {
  ...
  async updateForecast(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateTerritoryForecastSchema) dto: UpdateTerritoryForecastDto,
  ) {
  ...
  async realign(
    @Req() req: AuthReq,
    @ZodBody(realignTerritorySchema) dto: RealignTerritoryDto,
  ) {
    return this.service.realignTerritory(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      dto,
      req.user.userId,
