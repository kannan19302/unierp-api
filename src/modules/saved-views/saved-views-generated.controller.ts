...
export class SavedViewsGeneratedController {
  ...
  @ApiOperation({ summary: "List saved-views-entity-22" })
  @Get("saved-views-entity-22")
  @Permissions("saved-views.savedViewsEntity22.read")
  async listSavedViewsEntity22(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity22(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-22" })
  @Get("saved-views-entity-22/:id")
  @Permissions("saved-views.savedViewsEntity22.read")
  async getSavedViewsEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-22" })
  @Post("saved-views-entity-22")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-22" })
  @Put("saved-views-entity-22/:id")
  @Permissions("saved-views.savedViewsEntity22.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-22" })
  @Delete("saved-views-entity-22/:id")
  @Permissions("saved-views.savedViewsEntity22.delete")
  async deleteSavedViewsEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-23" })
  @Get("saved-views-entity-23")
  @Permissions("saved-views.savedViewsEntity23.read")
  async listSavedViewsEntity23(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity23(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-23" })
  @Get("saved-views-entity-23/:id")
  @Permissions("saved-views.savedViewsEntity23.read")
  async getSavedViewsEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-23" })
  @Post("saved-views-entity-23")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-23" })
  @Put("saved-views-entity-23/:id")
  @Permissions("saved-views.savedViewsEntity23.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-23" })
  @Delete("saved-views-entity-23/:id")
  @Permissions("saved-views.savedViewsEntity23.delete")
  async deleteSavedViewsEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-24" })
  @Get("saved-views-entity-24")
  @Permissions("saved-views.savedViewsEntity24.read")
  async listSavedViewsEntity24(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity24(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-24" })
  @Get("saved-views-entity-24/:id")
  @Permissions("saved-views.savedViewsEntity24.read")
  async getSavedViewsEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-24" })
  @Post("saved-views-entity-24")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-24" })
  @Put("saved-views-entity-24/:id")
  @Permissions("saved-views.savedViewsEntity24.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-24" })
  @Delete("saved-views-entity-24/:id")
  @Permissions("saved-views.savedViewsEntity24.delete")
  async deleteSavedViewsEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-25" })
  @Get("saved-views-entity-25")
  @Permissions("saved-views.savedViewsEntity25.read")
  async listSavedViewsEntity25(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity25(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-25" })
  @Get("saved-views-entity-25/:id")
  @Permissions("saved-views.savedViewsEntity25.read")
  async getSavedViewsEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-25" })
  @Post("saved-views-entity-25")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-25" })
  @Put("saved-views-entity-25/:id")
  @Permissions("saved-views.savedViewsEntity25.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-25" })
  @Delete("saved-views-entity-25/:id")
  @Permissions("saved-views.savedViewsEntity25.delete")
  async deleteSavedViewsEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-26" })
  @Get("saved-views-entity-26")
  @Permissions("saved-views.savedViewsEntity26.read")
  async listSavedViewsEntity26(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity26(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-26" })
  @Get("saved-views-entity-26/:id")
  @Permissions("saved-views.savedViewsEntity26.read")
  async getSavedViewsEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-26" })
  @Post("saved-views-entity-26")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-26" })
  @Put("saved-views-entity-26/:id")
  @Permissions("saved-views.savedViewsEntity26.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-26" })
  @Delete("saved-views-entity-26/:id")
  @Permissions("saved-views.savedViewsEntity26.delete")
  async deleteSavedViewsEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-27" })
  @Get("saved-views-entity-27")
  @Permissions("saved-views.savedViewsEntity27.read")
  async listSavedViewsEntity27(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity27(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-27" })
  @Get("saved-views-entity-27/:id")
  @Permissions("saved-views.savedViewsEntity27.read")
  async getSavedViewsEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-27" })
  @Post("saved-views-entity-27")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-27" })
  @Put("saved-views-entity-27/:id")
  @Permissions("saved-views.savedViewsEntity27.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-27" })
  @Delete("saved-views-entity-27/:id")
  @Permissions("saved-views.savedViewsEntity27.delete")
  async deleteSavedViewsEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-28" })
  @Get("saved-views-entity-28")
  @Permissions("saved-views.savedViewsEntity28.read")
  async listSavedViewsEntity28(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity28(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-28" })
  @Get("saved-views-entity-28/:id")
  @Permissions("saved-views.savedViewsEntity28.read")
  async getSavedViewsEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-28" })
  @Post("saved-views-entity-28")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-28" })
  @Put("saved-views-entity-28/:id")
  @Permissions("saved-views.savedViewsEntity28.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-28" })
  @Delete("saved-views-entity-28/:id")
  @Permissions("saved-views.savedViewsEntity28.delete")
  async deleteSavedViewsEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-29" })
  @Get("saved-views-entity-29")
  @Permissions("saved-views.savedViewsEntity29.read")
  async listSavedViewsEntity29(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity29(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-29" })
  @Get("saved-views-entity-29/:id")
  @Permissions("saved-views.savedViewsEntity29.read")
  async getSavedViewsEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-29" })
  @Post("saved-views-entity-29")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-29" })
  @Put("saved-views-entity-29/:id")
  @Permissions("saved-views.savedViewsEntity29.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-29" })
  @Delete("saved-views-entity-29/:id")
  @Permissions("saved-views.savedViewsEntity29.delete")
  async deleteSavedViewsEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-30" })
  @Get("saved-views-entity-30")
  @Permissions("saved-views.savedViewsEntity30.read")
  async listSavedViewsEntity30(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity30(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-30" })
  @Get("saved-views-entity-30/:id")
  @Permissions("saved-views.savedViewsEntity30.read")
  async getSavedViewsEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-30" })
  @Post("saved-views-entity-30")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-30" })
  @Put("saved-views-entity-30/:id")
  @Permissions("saved-views.savedViewsEntity30.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-30" })
  @Delete("saved-views-entity-30/:id")
  @Permissions("saved-views.savedViewsEntity30.delete")
  async deleteSavedViewsEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-31" })
  @Get("saved-views-entity-31")
  @Permissions("saved-views.savedViewsEntity31.read")
  async listSavedViewsEntity31(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity31(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-31" })
  @Get("saved-views-entity-31/:id")
  @Permissions("saved-views.savedViewsEntity31.read")
  async getSavedViewsEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-31" })
  @Post("saved-views-entity-31")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-31" })
  @Put("saved-views-entity-31/:id")
  @Permissions("saved-views.savedViewsEntity31.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-31" })
  @Delete("saved-views-entity-31/:id")
  @Permissions("saved-views.savedViewsEntity31.delete")
  async deleteSavedViewsEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-32" })
  @Get("saved-views-entity-32")
  @Permissions("saved-views.savedViewsEntity32.read")
  async listSavedViewsEntity32(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity32(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-32" })
  @Get("saved-views-entity-32/:id")
  @Permissions("saved-views.savedViewsEntity32.read")
  async getSavedViewsEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-32" })
  @Post("saved-views-entity-32")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-32" })
  @Put("saved-views-entity-32/:id")
  @Permissions("saved-views.savedViewsEntity32.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-32" })
  @Delete("saved-views-entity-32/:id")
  @Permissions("saved-views.savedViewsEntity32.delete")
  async deleteSavedViewsEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-33" })
  @Get("saved-views-entity-33")
  @Permissions("saved-views.savedViewsEntity33.read")
  async listSavedViewsEntity33(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity33(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-33" })
  @Get("saved-views-entity-33/:id")
  @Permissions("saved-views.savedViewsEntity33.read")
  async getSavedViewsEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-33" })
  @Post("saved-views-entity-33")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-33" })
  @Put("saved-views-entity-33/:id")
  @Permissions("saved-views.savedViewsEntity33.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-33" })
  @Delete("saved-views-entity-33/:id")
  @Permissions("saved-views.savedViewsEntity33.delete")
  async deleteSavedViewsEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-34" })
  @Get("saved-views-entity-34")
  @Permissions("saved-views.savedViewsEntity34.read")
  async listSavedViewsEntity34(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity34(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-34" })
  @Get("saved-views-entity-34/:id")
  @Permissions("saved-views.savedViewsEntity34.read")
  async getSavedViewsEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-34" })
  @Post("saved-views-entity-34")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-34" })
  @Put("saved-views-entity-34/:id")
  @Permissions("saved-views.savedViewsEntity34.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-34" })
  @Delete("saved-views-entity-34/:id")
  @Permissions("saved-views.savedViewsEntity34.delete")
  async deleteSavedViewsEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-35" })
  @Get("saved-views-entity-35")
  @Permissions("saved-views.savedViewsEntity35.read")
  async listSavedViewsEntity35(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity35(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-35" })
  @Get("saved-views-entity-35/:id")
  @Permissions("saved-views.savedViewsEntity35.read")
  async getSavedViewsEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-35" })
  @Post("saved-views-entity-35")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-35" })
  @Put("saved-views-entity-35/:id")
  @Permissions("saved-views.savedViewsEntity35.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-35" })
  @Delete("saved-views-entity-35/:id")
  @Permissions("saved-views.savedViewsEntity35.delete")
  async deleteSavedViewsEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-36" })
  @Get("saved-views-entity-36")
  @Permissions("saved-views.savedViewsEntity36.read")
  async listSavedViewsEntity36(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity36(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-36" })
  @Get("saved-views-entity-36/:id")
  @Permissions("saved-views.savedViewsEntity36.read")
  async getSavedViewsEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-36" })
  @Post("saved-views-entity-36")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-36" })
  @Put("saved-views-entity-36/:id")
  @Permissions("saved-views.savedViewsEntity36.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-36" })
  @Delete("saved-views-entity-36/:id")
  @Permissions("saved-views.savedViewsEntity36.delete")
  async deleteSavedViewsEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-37" })
  @Get("saved-views-entity-37")
  @Permissions("saved-views.savedViewsEntity37.read")
  async listSavedViewsEntity37(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity37(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-37" })
  @Get("saved-views-entity-37/:id")
  @Permissions("saved-views.savedViewsEntity37.read")
  async getSavedViewsEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-37" })
  @Post("saved-views-entity-37")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-37" })
  @Put("saved-views-entity-37/:id")
  @Permissions("saved-views.savedViewsEntity37.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-37" })
  @Delete("saved-views-entity-37/:id")
  @Permissions("saved-views.savedViewsEntity37.delete")
  async deleteSavedViewsEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-38" })
  @Get("saved-views-entity-38")
  @Permissions("saved-views.savedViewsEntity38.read")
  async listSavedViewsEntity38(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity38(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-38" })
  @Get("saved-views-entity-38/:id")
  @Permissions("saved-views.savedViewsEntity38.read")
  async getSavedViewsEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-38" })
  @Post("saved-views-entity-38")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-38" })
  @Put("saved-views-entity-38/:id")
  @Permissions("saved-views.savedViewsEntity38.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-38" })
  @Delete("saved-views-entity-38/:id")
  @Permissions("saved-views.savedViewsEntity38.delete")
  async deleteSavedViewsEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-39" })
  @Get("saved-views-entity-39")
  @Permissions("saved-views.savedViewsEntity39.read")
  async listSavedViewsEntity39(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity39(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-39" })
  @Get("saved-views-entity-39/:id")
  @Permissions("saved-views.savedViewsEntity39.read")
  async getSavedViewsEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-39" })
  @Post("saved-views-entity-39")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-39" })
  @Put("saved-views-entity-39/:id")
  @Permissions("saved-views.savedViewsEntity39.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-39" })
  @Delete("saved-views-entity-39/:id")
  @Permissions("saved-views.savedViewsEntity39.delete")
  async deleteSavedViewsEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List saved-views-entity-40" })
  @Get("saved-views-entity-40")
  @Permissions("saved-views.savedViewsEntity40.read")
  async listSavedViewsEntity40(@Req() req: AuthenticatedRequest) {
    return this.svc.listSavedViewsEntity40(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get saved-views-entity-40" })
  @Get("saved-views-entity-40/:id")
  @Permissions("saved-views.savedViewsEntity40.read")
  async getSavedViewsEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getSavedViewsEntity40(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create saved-views-entity-40" })
  @Post("saved-views-entity-40")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update saved-views-entity-40" })
  @Put("saved-views-entity-40/:id")
  @Permissions("saved-views.savedViewsEntity40.update")
  ...
  @ApiOperation({ summary: "Delete saved-views-entity-40" })
  @Delete("saved-views-entity-40/:id")
  @Permissions("saved-views.savedViewsEntity40.delete")
  async deleteSavedViewsEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteSavedViewsEntity40(req.user.tenantId, id);
  }
}
