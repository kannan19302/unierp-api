...
export class PeopleGeneratedController {
  ...
  @ApiOperation({ summary: "List people-entity-41" })
  @Get("people-entity-41")
  @Permissions("people.peopleEntity41.read")
  async listPeopleEntity41(@Req() req: AuthenticatedRequest) {
    return this.svc.listPeopleEntity41(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get people-entity-41" })
  @Get("people-entity-41/:id")
  @Permissions("people.peopleEntity41.read")
  async getPeopleEntity41(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPeopleEntity41(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create people-entity-41" })
  @Post("people-entity-41")
  @HttpCode(HttpStatus.CREATED)
  @Permissions("people.peopleEntity41.create")
  async createPeopleEntity41(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.object({ name: z.string() })) body: any,
  ) {
    return this.svc.createPeopleEntity41(req.user.tenantId, body);
  }

  @ApiOperation({ summary: "Update people-entity-41" })
  @Put("people-entity-41/:id")
  @Permissions("people.peopleEntity41.update")
  async updatePeopleEntity41(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ name: z.string() })) body: any,
  ) {
    return this.svc.updatePeopleEntity41(req.user.tenantId, id, body);
  }

  @ApiOperation({ summary: "Delete people-entity-41" })
  @Delete("people-entity-41/:id")
  @Permissions("people.peopleEntity41.delete")
  async deletePeopleEntity41(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePeopleEntity41(req.user.tenantId, id);
  }
}
