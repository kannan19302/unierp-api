...
const createCommitmentSchema = z.object({
  ...
  commitmentType: z.string().min(1),
  description: z.string().optional(),
  amount: z.number().positive(),
  currency: z.string().optional(),
  commitmentDate: z.string().min(1),
  expectedLiquidationDate: z.string().optional(),
...
const createCarryForwardSchema = z.object({
  ...
  carryForwardPct: z.number().min(0).max(100),
  maxCarryAmount: z.number().optional(),
...
export class BudgetDeepController {
  ...
  async getTemplates(
    ...
    return this.budgetDeepService.getBudgetTemplates(
      req.user.tenantId,
      fiscalYear,
    );
  }
  ...
  async createTemplate(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createTemplateSchema) dto: any,
  ) {
    return this.budgetDeepService.createBudgetTemplate(
      req.user.tenantId,
  ...
  async updateTemplate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createTemplateSchema.partial()) dto: any,
  ) {
    return this.budgetDeepService.updateBudgetTemplate(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async generateFromTemplate(
    ...
    return this.budgetDeepService.generateBudgetsFromTemplate(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      id,
    );
  ...
  async getCommitments(
    ...
    return this.budgetDeepService.getBudgetCommitments(
      req.user.tenantId,
      budgetId,
      status,
    );
  ...
  async getCommitmentById(
    ...
    return this.budgetDeepService.getBudgetCommitmentById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createCommitment(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createCommitmentSchema) dto: any,
  ) {
    return this.budgetDeepService.createBudgetCommitment(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto,
    );
  ...
  async updateCommitment(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createCommitmentSchema.partial()) dto: any,
  ) {
    return this.budgetDeepService.updateBudgetCommitment(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async liquidateCommitment(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ liquidatedAmount: z.number().positive() })) dto: any,
  ) {
    return this.budgetDeepService.liquidateBudgetCommitment(
      req.user.tenantId,
      id,
      dto.liquidatedAmount,
    );
  }
  ...
  async cancelCommitment(
    ...
    return this.budgetDeepService.cancelBudgetCommitment(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async getCommitmentsByBudget(
    @Req() req: AuthenticatedRequest,
    @Param("budgetId") budgetId: string,
  ) {
    return this.budgetDeepService.getCommitmentsByBudget(
      req.user.tenantId,
      budgetId,
    );
  }
  ...
  async getCommitmentSummary(
    ...
    return this.budgetDeepService.getCommitmentSummary(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      budgetId,
    );
  ...
  async getCarryForwardRuleById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.budgetDeepService.getCarryForwardRuleById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createCarryForwardRule(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createCarryForwardSchema) dto: any,
  ) {
    return this.budgetDeepService.createCarryForwardRule(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto,
    );
  ...
  async updateCarryForwardRule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createCarryForwardSchema.partial()) dto: any,
  ) {
    return this.budgetDeepService.updateCarryForwardRule(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async computeCarryForward(
    @Req() req: AuthenticatedRequest,
    @Param("orgId") orgId: string,
    @Param("fromYear") fromYear: string,
    @Param("toYear") toYear: string,
  ) {
    return this.budgetDeepService.computeCarryForward(
      req.user.tenantId,
      orgId,
      fromYear,
      toYear,
  ...
  async getRevisions(
    ...
    return this.budgetDeepService.getBudgetRevisions(
      req.user.tenantId,
      budgetId,
    );
  }
  ...
  async createRevision(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createRevisionSchema) dto: any,
  ) {
    return this.budgetDeepService.createBudgetRevision(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto,
    );
  ...
  async approveRevision(
    ...
    return this.budgetDeepService.approveBudgetRevision(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async rejectRevision(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ rejectionReason: z.string().optional() })) dto: any,
  ) {
    return this.budgetDeepService.rejectBudgetRevision(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.rejectionReason,
  ...
  async getMultiYearPlan(
    ...
    @Param("endYear") endYear: string,
  ) {
    return this.budgetDeepService.getMultiYearPlan(
      req.user.tenantId,
      orgId,
      startYear,
      endYear,
  ...
  async getDashboard(
    ...
    return this.budgetDeepService.getBudgetDeepDashboard(
      req.user.tenantId,
      orgId,
    );
  }
