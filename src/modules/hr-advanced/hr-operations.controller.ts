...
import { createHrTicketSchema, createEmployeeGrievanceSchema, createBackgroundCheckRequestSchema, createVisaRecordSchema, createEmployeeWellnessProgramSchema } from '../../common/contracts/hr';
