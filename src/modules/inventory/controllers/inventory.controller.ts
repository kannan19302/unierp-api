...
export class InventoryController {
  ...
  async createProduct(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateProductInput,
  ) {
  ...
  async updateProduct(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateProductInput,
  ) {
  ...
  async bulkAction(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: BulkActionInput,
  ) {
    return this.inventoryService.bulkAction(
      req.user.tenantId,
      dto.action,
      dto.ids,
      dto.data,
  ...
  async getWarehouseById(
    ...
    return this.inventoryWarehousesService.getWarehouseById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createWarehouse(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateWarehouseInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryWarehousesService.createWarehouse(
      req.user.tenantId,
      orgId,
      dto,
    );
  ...
  async updateWarehouse(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateWarehouseInput,
  ) {
    return this.inventoryWarehousesService.updateWarehouse(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deleteWarehouse(
    ...
    return this.inventoryWarehousesService.deleteWarehouse(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createCategory(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCategoryInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
  ...
  async updateCategory(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateCategoryInput,
  ) {
  ...
  async createProductVariant(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateVariantInput,
  ) {
  ...
  async updateProductVariant(
    ...
    return this.inventoryService.updateProductVariant(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async getBinLocations(
    ...
    return this.inventoryService.getBinLocations(
      req.user.tenantId,
      warehouseId,
    );
  }
  ...
  async createBinLocation(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateBinLocationInput,
  ) {
  ...
  async createSerialNumber(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateSerialNumberInput,
  ) {
  ...
  async updateSerialNumber(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateSerialNumberInput,
  ) {
  ...
  async createBatch(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateBatchInput,
  ) {
  ...
  async updateBatch(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateBatchInput,
  ) {
  ...
  async createStockEntry(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateStockEntryInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
  ...
  async submitStockEntry(
    ...
    return this.inventoryService.submitStockEntry(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async cancelStockEntry(
    ...
    return this.inventoryService.cancelStockEntry(
      req.user.tenantId,
      id,
      req.user.userId,
      reason,
  ...
  async transferStock(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: TransferStockInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
  ...
  async createTransferApprovalRule(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateTransferApprovalRuleInput,
  ) {
    return this.inventoryService.createTransferApprovalRule(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async updateTransferApprovalRule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateTransferApprovalRuleInput,
  ) {
    return this.inventoryService.updateTransferApprovalRule(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deleteTransferApprovalRule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.inventoryService.deleteTransferApprovalRule(
      req.user.tenantId,
      id,
    );
  }
  ...
  @ApiOperation({
    summary:
      "Request approval to submit a transfer stock entry (auto-submits below threshold)",
  })
  ...
  async requestTransferApproval(
    ...
    return this.inventoryService.requestTransferApproval(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async getPendingTransferApprovals(
    ...
    return this.inventoryService.getPendingTransferApprovals(
      req.user.tenantId,
      {
        page: page ? parseInt(page) : undefined,
        limit: limit ? parseInt(limit) : undefined,
  ...
  @ApiOperation({
    summary: "Approve a pending transfer (submits the stock entry)",
  })
  ...
  async rejectTransfer(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: RejectTransferInput,
  ) {
  ...
  async getMovementHistory(
    ...
    return this.inventoryService.getMovementHistory(req.user.tenantId, {
      productId,
      warehouseId,
      limit: limit ? parseInt(limit) : undefined,
    });
  ...
  async createPickWave(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreatePickWaveInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryService.createPickWave(
      req.user.tenantId,
      orgId,
      req.user.userId,
      dto,
  ...
  async recordPick(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: RecordPickInput,
  ) {
  ...
  async createConsignmentStock(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateConsignmentStockInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryService.createConsignmentStock(
      req.user.tenantId,
      orgId,
      dto,
    );
  ...
  @ApiOperation({
    summary: "Record consignment consumption (consumption-triggered billing)",
  })
  ...
  async recordConsignmentConsumption(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: RecordConsignmentConsumptionInput,
  ) {
    return this.inventoryService.recordConsignmentConsumption(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async getUnbilledConsignmentConsumptions(@Req() req: AuthenticatedRequest) {
    return this.inventoryService.getUnbilledConsignmentConsumptions(
      req.user.tenantId,
    );
  }
  ...
  @Permissions("inventory.stock.update")
  async markConsignmentConsumptionBilled(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.inventoryService.markConsignmentConsumptionBilled(
      req.user.tenantId,
      id,
    );
  }
  ...
  @ApiOperation({
    summary: "Receive stock with serial/lot traceability captured at receipt",
  })
  @Post("receive-with-traceability")
  @Permissions("inventory.stock.create")
  async receiveWithTraceability(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: ReceiveWithTraceabilityInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryService.receiveWithTraceability(
      req.user.tenantId,
      orgId,
      req.user.userId,
      dto,
  ...
  async createCycleCount(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCycleCountInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
  ...
  async submitCycleCount(
    ...
    return this.inventoryService.submitCycleCount(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  async approveCycleCount(
    ...
    return this.inventoryService.approveCycleCount(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async getCycleCountAccuracy(
    ...
    return this.inventoryService.getCycleCountAccuracy(
      req.user.tenantId,
      warehouseId,
      sinceDays ? parseInt(sinceDays) : undefined,
    );
  }
  ...
  async createCycleCountSchedule(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateCycleCountScheduleInput,
  ) {
    return this.inventoryService.createCycleCountSchedule(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async updateCycleCountSchedule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateCycleCountScheduleInput,
  ) {
    return this.inventoryService.updateCycleCountSchedule(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  @Permissions("inventory.stock.update")
  async rollForwardCycleCountSchedule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.inventoryService.rollForwardCycleCountSchedule(
      req.user.tenantId,
      id,
    );
  }
  ...
  @Permissions("inventory.stock.delete")
  async deleteCycleCountSchedule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.inventoryService.deleteCycleCountSchedule(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createLicensePlate(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateLicensePlateInput,
  ) {
  ...
  async addLicensePlateItem(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: AddLicensePlateItemInput,
  ) {
    return this.inventoryService.addLicensePlateItem(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  @ApiOperation({
    summary: "Move license plate to another bin (barcode scan move)",
  })
  ...
  async moveLicensePlate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: MoveLicensePlateInput,
  ) {
  ...
  @ApiOperation({
    summary:
      "Suggest putaway bin for an inventory item (zone-based optimization)",
  })
  ...
  async suggestPutawayBin(
    ...
    return this.inventoryService.suggestPutawayBin(
      req.user.tenantId,
      inventoryItemId,
    );
  }
  ...
  async createPutawayTask(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreatePutawayTaskInput,
  ) {
  ...
  async completePutawayTask(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: CompletePutawayTaskInput,
  ) {
    return this.inventoryService.completePutawayTask(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async createDockAppointment(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateDockAppointmentInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryService.createDockAppointment(
      req.user.tenantId,
      orgId,
      dto,
    );
  ...
  @ApiOperation({
    summary: "Update dock appointment (re-validates conflicts if rescheduled)",
  })
  ...
  async updateDockAppointment(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateDockAppointmentInput,
  ) {
    return this.inventoryService.updateDockAppointment(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async getDockUtilization(
    ...
    return this.inventoryService.getDockUtilization(
      req.user.tenantId,
      warehouseId,
      sinceDays ? parseInt(sinceDays) : undefined,
    );
  ...
  @ApiOperation({
    summary: "Get dynamic slotting recommendations for a warehouse",
  })
  ...
  async getSlottingRecommendations(
    ...
    return this.inventoryService.getSlottingRecommendations(
      req.user.tenantId,
      warehouseId,
      sinceDays ? parseInt(sinceDays) : undefined,
    );
  ...
  @ApiOperation({
    summary: "Execute a slotting move (relocate bin-level quantity)",
  })
  ...
  async executeSlottingMove(
    ...
    return this.inventoryService.executeSlottingMove(
      req.user.tenantId,
      productId,
      warehouseId,
      fromBinId,
  ...
  @ApiOperation({
    summary:
      "Get cross-dock opportunities (inbound receipts that can bypass storage)",
  })
  @Get("cross-dock/opportunities")
  @Permissions("inventory.stock.read")
  async getCrossDockOpportunities(
    @Req() req: AuthenticatedRequest,
    @Query("warehouseId") warehouseId?: string,
  ) {
    return this.inventoryService.getCrossDockOpportunities(
      req.user.tenantId,
      warehouseId,
    );
  }
  ...
  @ApiOperation({
    summary:
      "Execute a cross-dock (receipt bypasses storage straight to an open pick)",
  })
  @Post("cross-dock/execute")
  @Permissions("inventory.stock.update")
  async executeCrossDock(
    @Req() req: AuthenticatedRequest,
    @Query("putawayTaskId") putawayTaskId: string,
    @Query("pickWaveItemId") pickWaveItemId: string,
  ) {
    return this.inventoryService.executeCrossDock(
      req.user.tenantId,
      putawayTaskId,
      pickWaveItemId,
    );
  ...
  async quarantineBatch(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: QuarantineBatchInput,
  ) {
    return this.inventoryService.quarantineBatch(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  async releaseBatchQuarantine(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: ReleaseBatchQuarantineInput,
  ) {
    return this.inventoryService.releaseBatchQuarantine(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  @ApiOperation({
    summary: "Reject a quarantined batch (mark expired/unusable)",
  })
  ...
  async rejectBatchQuarantine(
    ...
    return this.inventoryService.rejectBatchQuarantine(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  @ApiOperation({
    summary: "Get batch recall notice (genealogy + affected sales orders)",
  })
  @Get("batches/:id/recall-notice")
  @Permissions("inventory.stock.read")
  async getBatchRecallNotice(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
  ...
  async getExpiringBatchesReport(
    ...
    return this.inventoryService.getExpiringBatchesReport(
      req.user.tenantId,
  ...
  @ApiOperation({
    summary: "Get FEFO pick suggestion for a product/warehouse/quantity",
  })
  ...
  async getFefoPickSuggestion(
    ...
    return this.inventoryService.getFefoPickSuggestion(
      req.user.tenantId,
      productId,
      warehouseId,
      parseFloat(quantity),
  ...
  @ApiOperation({
    summary: "Get allocation summary for a product in a warehouse",
  })
  ...
  async createStockReservation(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateStockReservationInput,
  ) {
    return this.inventoryService.createStockReservation(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  async getAbcClassification(
    ...
    return this.inventoryService.getAbcClassification(
      req.user.tenantId,
      warehouseId,
    );
  }
  ...
  async getDeadStockReport(
    ...
    return this.inventoryService.getDeadStockReport(
      req.user.tenantId,
      warehouseId,
      sinceDays ? parseInt(sinceDays) : undefined,
    );
  ...
  async createQAInspection(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateQAInspectionInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryQaService.createQAInspection(
      req.user.tenantId,
      orgId,
      req.user.userId,
      dto,
  ...
  async submitQAInspection(
    ...
    return this.inventoryQaService.submitQAInspection(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  @ApiOperation({
    summary:
      "Route a resolved inspection disposition to a downstream action (e.g. batch quarantine)",
  })
  ...
  async routeQAInspectionDisposition(
    ...
    return this.inventoryQaService.routeQAInspectionDisposition(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async createQAInspectionTemplate(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateQAInspectionTemplateInput,
  ) {
    return this.inventoryQaService.createQAInspectionTemplate(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async updateQAInspectionTemplate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: UpdateQAInspectionTemplateInput,
  ) {
    return this.inventoryQaService.updateQAInspectionTemplate(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  @Permissions("inventory.stock.delete")
  async deleteQAInspectionTemplate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.inventoryQaService.deleteQAInspectionTemplate(
      req.user.tenantId,
      id,
    );
  }
  ...
  @ApiOperation({
    summary: "Create QA inspection pre-populated from a template",
  })
  ...
  async createQAInspectionFromTemplate(
    ...
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryQaService.createQAInspectionFromTemplate(
      req.user.tenantId,
      orgId,
      req.user.userId,
      id,
  ...
  async createReorderRule(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateReorderRuleInput,
  ) {
  ...
  @ApiOperation({
    summary:
      "Get reorder dashboard (triggered rules with lead-time-aware suggested order date)",
  })
  ...
  @ApiOperation({
    summary: "Create purchase requisition from a triggered reorder rule",
  })
  ...
  async createRequisitionFromReorderRule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: CreateRequisitionFromReorderRuleInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryService.createRequisitionFromReorderRule(
      req.user.tenantId,
      orgId,
      req.user.userId,
      id,
  ...
  async createProductKit(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateKitInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryService.createProductKit(
      req.user.tenantId,
      orgId,
      dto,
    );
  ...
  async createKitVersion(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: CreateKitVersionInput,
  ) {
    return this.inventoryService.createKitVersion(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  @Permissions("inventory.stock.update")
  async activateKitVersion(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Param("versionId") versionId: string,
  ) {
    return this.inventoryService.activateKitVersion(
      req.user.tenantId,
      id,
      versionId,
    );
  ...
  @ApiOperation({
    summary: "Get kit component availability / max buildable quantity",
  })
  ...
  async getKitAvailability(
    ...
    return this.inventoryService.getKitAvailability(
      req.user.tenantId,
      id,
      warehouseId,
    );
  ...
  @ApiOperation({
    summary: "Assemble kits (consume components, produce finished kit stock)",
  })
  ...
  async assembleKit(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: AssembleKitInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryService.assembleKit(
      req.user.tenantId,
      orgId,
      req.user.userId,
      id,
  ...
  @ApiOperation({
    summary:
      "Disassemble kits (consume finished kit stock, produce components)",
  })
  ...
  async disassembleKit(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: DisassembleKitInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.inventoryService.disassembleKit(
      req.user.tenantId,
      orgId,
      req.user.userId,
      id,
  ...
  async getInventoryAging(
    ...
    return this.inventoryService.getInventoryAging(req.user.tenantId, {
      warehouseId,
    });
  }
}
