...
export class ServiceManagementGeneratedController {
  ...
  @ApiOperation({ summary: "List service-management-entity-41" }) @Get("service-management-entity-41") @Permissions("service-management.serviceManagementEntity41.read")
  async listServiceManagementEntity41(@Req() req: AuthenticatedRequest) { return this.svc.listServiceManagementEntity41(req.user.tenantId); }

  @ApiOperation({ summary: "Get service-management-entity-41" }) @Get("service-management-entity-41/:id") @Permissions("service-management.serviceManagementEntity41.read")
  async getServiceManagementEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getServiceManagementEntity41(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create service-management-entity-41" }) @Post("service-management-entity-41") @HttpCode(HttpStatus.CREATED) @Permissions("service-management.serviceManagementEntity41.create")
  async createServiceManagementEntity41(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createServiceManagementEntity41(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update service-management-entity-41" }) @Put("service-management-entity-41/:id") @Permissions("service-management.serviceManagementEntity41.update")
  async updateServiceManagementEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateServiceManagementEntity41(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete service-management-entity-41" }) @Delete("service-management-entity-41/:id") @Permissions("service-management.serviceManagementEntity41.delete")
  async deleteServiceManagementEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteServiceManagementEntity41(req.user.tenantId, id); }

  @ApiOperation({ summary: "List service-management-entity-42" }) @Get("service-management-entity-42") @Permissions("service-management.serviceManagementEntity42.read")
  async listServiceManagementEntity42(@Req() req: AuthenticatedRequest) { return this.svc.listServiceManagementEntity42(req.user.tenantId); }

  @ApiOperation({ summary: "Get service-management-entity-42" }) @Get("service-management-entity-42/:id") @Permissions("service-management.serviceManagementEntity42.read")
  async getServiceManagementEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getServiceManagementEntity42(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create service-management-entity-42" }) @Post("service-management-entity-42") @HttpCode(HttpStatus.CREATED) @Permissions("service-management.serviceManagementEntity42.create")
  async createServiceManagementEntity42(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createServiceManagementEntity42(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update service-management-entity-42" }) @Put("service-management-entity-42/:id") @Permissions("service-management.serviceManagementEntity42.update")
  async updateServiceManagementEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateServiceManagementEntity42(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete service-management-entity-42" }) @Delete("service-management-entity-42/:id") @Permissions("service-management.serviceManagementEntity42.delete")
  async deleteServiceManagementEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteServiceManagementEntity42(req.user.tenantId, id); }

  @ApiOperation({ summary: "List service-management-entity-43" }) @Get("service-management-entity-43") @Permissions("service-management.serviceManagementEntity43.read")
  async listServiceManagementEntity43(@Req() req: AuthenticatedRequest) { return this.svc.listServiceManagementEntity43(req.user.tenantId); }

  @ApiOperation({ summary: "Get service-management-entity-43" }) @Get("service-management-entity-43/:id") @Permissions("service-management.serviceManagementEntity43.read")
  async getServiceManagementEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getServiceManagementEntity43(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create service-management-entity-43" }) @Post("service-management-entity-43") @HttpCode(HttpStatus.CREATED) @Permissions("service-management.serviceManagementEntity43.create")
  async createServiceManagementEntity43(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createServiceManagementEntity43(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update service-management-entity-43" }) @Put("service-management-entity-43/:id") @Permissions("service-management.serviceManagementEntity43.update")
  async updateServiceManagementEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateServiceManagementEntity43(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete service-management-entity-43" }) @Delete("service-management-entity-43/:id") @Permissions("service-management.serviceManagementEntity43.delete")
  async deleteServiceManagementEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteServiceManagementEntity43(req.user.tenantId, id); }

  @ApiOperation({ summary: "List service-management-entity-44" }) @Get("service-management-entity-44") @Permissions("service-management.serviceManagementEntity44.read")
  async listServiceManagementEntity44(@Req() req: AuthenticatedRequest) { return this.svc.listServiceManagementEntity44(req.user.tenantId); }

  @ApiOperation({ summary: "Get service-management-entity-44" }) @Get("service-management-entity-44/:id") @Permissions("service-management.serviceManagementEntity44.read")
  async getServiceManagementEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getServiceManagementEntity44(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create service-management-entity-44" }) @Post("service-management-entity-44") @HttpCode(HttpStatus.CREATED) @Permissions("service-management.serviceManagementEntity44.create")
  async createServiceManagementEntity44(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createServiceManagementEntity44(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update service-management-entity-44" }) @Put("service-management-entity-44/:id") @Permissions("service-management.serviceManagementEntity44.update")
  async updateServiceManagementEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateServiceManagementEntity44(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete service-management-entity-44" }) @Delete("service-management-entity-44/:id") @Permissions("service-management.serviceManagementEntity44.delete")
  async deleteServiceManagementEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteServiceManagementEntity44(req.user.tenantId, id); }

  @ApiOperation({ summary: "List service-management-entity-45" }) @Get("service-management-entity-45") @Permissions("service-management.serviceManagementEntity45.read")
  async listServiceManagementEntity45(@Req() req: AuthenticatedRequest) { return this.svc.listServiceManagementEntity45(req.user.tenantId); }

  @ApiOperation({ summary: "Get service-management-entity-45" }) @Get("service-management-entity-45/:id") @Permissions("service-management.serviceManagementEntity45.read")
  async getServiceManagementEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getServiceManagementEntity45(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create service-management-entity-45" }) @Post("service-management-entity-45") @HttpCode(HttpStatus.CREATED) @Permissions("service-management.serviceManagementEntity45.create")
  async createServiceManagementEntity45(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createServiceManagementEntity45(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update service-management-entity-45" }) @Put("service-management-entity-45/:id") @Permissions("service-management.serviceManagementEntity45.update")
  async updateServiceManagementEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateServiceManagementEntity45(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete service-management-entity-45" }) @Delete("service-management-entity-45/:id") @Permissions("service-management.serviceManagementEntity45.delete")
  async deleteServiceManagementEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteServiceManagementEntity45(req.user.tenantId, id); }
