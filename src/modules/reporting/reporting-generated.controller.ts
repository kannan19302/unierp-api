...
export class ReportingGeneratedController {
  ...
  @ApiOperation({ summary: "List reporting-entity-18" })
  @Get("reporting-entity-18")
  @Permissions("reporting.reportingEntity18.read")
  async listReportingEntity18(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity18(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-18" })
  @Get("reporting-entity-18/:id")
  @Permissions("reporting.reportingEntity18.read")
  async getReportingEntity18(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity18(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-18" })
  @Post("reporting-entity-18")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-18" })
  @Put("reporting-entity-18/:id")
  @Permissions("reporting.reportingEntity18.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-18" })
  @Delete("reporting-entity-18/:id")
  @Permissions("reporting.reportingEntity18.delete")
  async deleteReportingEntity18(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity18(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-19" })
  @Get("reporting-entity-19")
  @Permissions("reporting.reportingEntity19.read")
  async listReportingEntity19(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity19(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-19" })
  @Get("reporting-entity-19/:id")
  @Permissions("reporting.reportingEntity19.read")
  async getReportingEntity19(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity19(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-19" })
  @Post("reporting-entity-19")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-19" })
  @Put("reporting-entity-19/:id")
  @Permissions("reporting.reportingEntity19.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-19" })
  @Delete("reporting-entity-19/:id")
  @Permissions("reporting.reportingEntity19.delete")
  async deleteReportingEntity19(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity19(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-20" })
  @Get("reporting-entity-20")
  @Permissions("reporting.reportingEntity20.read")
  async listReportingEntity20(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity20(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-20" })
  @Get("reporting-entity-20/:id")
  @Permissions("reporting.reportingEntity20.read")
  async getReportingEntity20(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity20(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-20" })
  @Post("reporting-entity-20")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-20" })
  @Put("reporting-entity-20/:id")
  @Permissions("reporting.reportingEntity20.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-20" })
  @Delete("reporting-entity-20/:id")
  @Permissions("reporting.reportingEntity20.delete")
  async deleteReportingEntity20(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity20(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-21" })
  @Get("reporting-entity-21")
  @Permissions("reporting.reportingEntity21.read")
  async listReportingEntity21(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity21(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-21" })
  @Get("reporting-entity-21/:id")
  @Permissions("reporting.reportingEntity21.read")
  async getReportingEntity21(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity21(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-21" })
  @Post("reporting-entity-21")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-21" })
  @Put("reporting-entity-21/:id")
  @Permissions("reporting.reportingEntity21.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-21" })
  @Delete("reporting-entity-21/:id")
  @Permissions("reporting.reportingEntity21.delete")
  async deleteReportingEntity21(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity21(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-22" })
  @Get("reporting-entity-22")
  @Permissions("reporting.reportingEntity22.read")
  async listReportingEntity22(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity22(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-22" })
  @Get("reporting-entity-22/:id")
  @Permissions("reporting.reportingEntity22.read")
  async getReportingEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-22" })
  @Post("reporting-entity-22")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-22" })
  @Put("reporting-entity-22/:id")
  @Permissions("reporting.reportingEntity22.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-22" })
  @Delete("reporting-entity-22/:id")
  @Permissions("reporting.reportingEntity22.delete")
  async deleteReportingEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-23" })
  @Get("reporting-entity-23")
  @Permissions("reporting.reportingEntity23.read")
  async listReportingEntity23(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity23(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-23" })
  @Get("reporting-entity-23/:id")
  @Permissions("reporting.reportingEntity23.read")
  async getReportingEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-23" })
  @Post("reporting-entity-23")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-23" })
  @Put("reporting-entity-23/:id")
  @Permissions("reporting.reportingEntity23.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-23" })
  @Delete("reporting-entity-23/:id")
  @Permissions("reporting.reportingEntity23.delete")
  async deleteReportingEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-24" })
  @Get("reporting-entity-24")
  @Permissions("reporting.reportingEntity24.read")
  async listReportingEntity24(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity24(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-24" })
  @Get("reporting-entity-24/:id")
  @Permissions("reporting.reportingEntity24.read")
  async getReportingEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-24" })
  @Post("reporting-entity-24")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-24" })
  @Put("reporting-entity-24/:id")
  @Permissions("reporting.reportingEntity24.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-24" })
  @Delete("reporting-entity-24/:id")
  @Permissions("reporting.reportingEntity24.delete")
  async deleteReportingEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-25" })
  @Get("reporting-entity-25")
  @Permissions("reporting.reportingEntity25.read")
  async listReportingEntity25(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity25(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-25" })
  @Get("reporting-entity-25/:id")
  @Permissions("reporting.reportingEntity25.read")
  async getReportingEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-25" })
  @Post("reporting-entity-25")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-25" })
  @Put("reporting-entity-25/:id")
  @Permissions("reporting.reportingEntity25.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-25" })
  @Delete("reporting-entity-25/:id")
  @Permissions("reporting.reportingEntity25.delete")
  async deleteReportingEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-26" })
  @Get("reporting-entity-26")
  @Permissions("reporting.reportingEntity26.read")
  async listReportingEntity26(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity26(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-26" })
  @Get("reporting-entity-26/:id")
  @Permissions("reporting.reportingEntity26.read")
  async getReportingEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-26" })
  @Post("reporting-entity-26")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-26" })
  @Put("reporting-entity-26/:id")
  @Permissions("reporting.reportingEntity26.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-26" })
  @Delete("reporting-entity-26/:id")
  @Permissions("reporting.reportingEntity26.delete")
  async deleteReportingEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-27" })
  @Get("reporting-entity-27")
  @Permissions("reporting.reportingEntity27.read")
  async listReportingEntity27(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity27(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-27" })
  @Get("reporting-entity-27/:id")
  @Permissions("reporting.reportingEntity27.read")
  async getReportingEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-27" })
  @Post("reporting-entity-27")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-27" })
  @Put("reporting-entity-27/:id")
  @Permissions("reporting.reportingEntity27.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-27" })
  @Delete("reporting-entity-27/:id")
  @Permissions("reporting.reportingEntity27.delete")
  async deleteReportingEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-28" })
  @Get("reporting-entity-28")
  @Permissions("reporting.reportingEntity28.read")
  async listReportingEntity28(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity28(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-28" })
  @Get("reporting-entity-28/:id")
  @Permissions("reporting.reportingEntity28.read")
  async getReportingEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-28" })
  @Post("reporting-entity-28")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-28" })
  @Put("reporting-entity-28/:id")
  @Permissions("reporting.reportingEntity28.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-28" })
  @Delete("reporting-entity-28/:id")
  @Permissions("reporting.reportingEntity28.delete")
  async deleteReportingEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-29" })
  @Get("reporting-entity-29")
  @Permissions("reporting.reportingEntity29.read")
  async listReportingEntity29(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity29(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-29" })
  @Get("reporting-entity-29/:id")
  @Permissions("reporting.reportingEntity29.read")
  async getReportingEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-29" })
  @Post("reporting-entity-29")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-29" })
  @Put("reporting-entity-29/:id")
  @Permissions("reporting.reportingEntity29.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-29" })
  @Delete("reporting-entity-29/:id")
  @Permissions("reporting.reportingEntity29.delete")
  async deleteReportingEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-30" })
  @Get("reporting-entity-30")
  @Permissions("reporting.reportingEntity30.read")
  async listReportingEntity30(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity30(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-30" })
  @Get("reporting-entity-30/:id")
  @Permissions("reporting.reportingEntity30.read")
  async getReportingEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-30" })
  @Post("reporting-entity-30")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-30" })
  @Put("reporting-entity-30/:id")
  @Permissions("reporting.reportingEntity30.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-30" })
  @Delete("reporting-entity-30/:id")
  @Permissions("reporting.reportingEntity30.delete")
  async deleteReportingEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-31" })
  @Get("reporting-entity-31")
  @Permissions("reporting.reportingEntity31.read")
  async listReportingEntity31(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity31(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-31" })
  @Get("reporting-entity-31/:id")
  @Permissions("reporting.reportingEntity31.read")
  async getReportingEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-31" })
  @Post("reporting-entity-31")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-31" })
  @Put("reporting-entity-31/:id")
  @Permissions("reporting.reportingEntity31.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-31" })
  @Delete("reporting-entity-31/:id")
  @Permissions("reporting.reportingEntity31.delete")
  async deleteReportingEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-32" })
  @Get("reporting-entity-32")
  @Permissions("reporting.reportingEntity32.read")
  async listReportingEntity32(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity32(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-32" })
  @Get("reporting-entity-32/:id")
  @Permissions("reporting.reportingEntity32.read")
  async getReportingEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-32" })
  @Post("reporting-entity-32")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-32" })
  @Put("reporting-entity-32/:id")
  @Permissions("reporting.reportingEntity32.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-32" })
  @Delete("reporting-entity-32/:id")
  @Permissions("reporting.reportingEntity32.delete")
  async deleteReportingEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-33" })
  @Get("reporting-entity-33")
  @Permissions("reporting.reportingEntity33.read")
  async listReportingEntity33(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity33(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-33" })
  @Get("reporting-entity-33/:id")
  @Permissions("reporting.reportingEntity33.read")
  async getReportingEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-33" })
  @Post("reporting-entity-33")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-33" })
  @Put("reporting-entity-33/:id")
  @Permissions("reporting.reportingEntity33.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-33" })
  @Delete("reporting-entity-33/:id")
  @Permissions("reporting.reportingEntity33.delete")
  async deleteReportingEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-34" })
  @Get("reporting-entity-34")
  @Permissions("reporting.reportingEntity34.read")
  async listReportingEntity34(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity34(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-34" })
  @Get("reporting-entity-34/:id")
  @Permissions("reporting.reportingEntity34.read")
  async getReportingEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-34" })
  @Post("reporting-entity-34")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-34" })
  @Put("reporting-entity-34/:id")
  @Permissions("reporting.reportingEntity34.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-34" })
  @Delete("reporting-entity-34/:id")
  @Permissions("reporting.reportingEntity34.delete")
  async deleteReportingEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-35" })
  @Get("reporting-entity-35")
  @Permissions("reporting.reportingEntity35.read")
  async listReportingEntity35(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity35(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-35" })
  @Get("reporting-entity-35/:id")
  @Permissions("reporting.reportingEntity35.read")
  async getReportingEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-35" })
  @Post("reporting-entity-35")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-35" })
  @Put("reporting-entity-35/:id")
  @Permissions("reporting.reportingEntity35.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-35" })
  @Delete("reporting-entity-35/:id")
  @Permissions("reporting.reportingEntity35.delete")
  async deleteReportingEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-36" })
  @Get("reporting-entity-36")
  @Permissions("reporting.reportingEntity36.read")
  async listReportingEntity36(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity36(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-36" })
  @Get("reporting-entity-36/:id")
  @Permissions("reporting.reportingEntity36.read")
  async getReportingEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-36" })
  @Post("reporting-entity-36")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-36" })
  @Put("reporting-entity-36/:id")
  @Permissions("reporting.reportingEntity36.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-36" })
  @Delete("reporting-entity-36/:id")
  @Permissions("reporting.reportingEntity36.delete")
  async deleteReportingEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-37" })
  @Get("reporting-entity-37")
  @Permissions("reporting.reportingEntity37.read")
  async listReportingEntity37(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity37(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-37" })
  @Get("reporting-entity-37/:id")
  @Permissions("reporting.reportingEntity37.read")
  async getReportingEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-37" })
  @Post("reporting-entity-37")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-37" })
  @Put("reporting-entity-37/:id")
  @Permissions("reporting.reportingEntity37.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-37" })
  @Delete("reporting-entity-37/:id")
  @Permissions("reporting.reportingEntity37.delete")
  async deleteReportingEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-38" })
  @Get("reporting-entity-38")
  @Permissions("reporting.reportingEntity38.read")
  async listReportingEntity38(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity38(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-38" })
  @Get("reporting-entity-38/:id")
  @Permissions("reporting.reportingEntity38.read")
  async getReportingEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-38" })
  @Post("reporting-entity-38")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-38" })
  @Put("reporting-entity-38/:id")
  @Permissions("reporting.reportingEntity38.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-38" })
  @Delete("reporting-entity-38/:id")
  @Permissions("reporting.reportingEntity38.delete")
  async deleteReportingEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-39" })
  @Get("reporting-entity-39")
  @Permissions("reporting.reportingEntity39.read")
  async listReportingEntity39(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity39(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-39" })
  @Get("reporting-entity-39/:id")
  @Permissions("reporting.reportingEntity39.read")
  async getReportingEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-39" })
  @Post("reporting-entity-39")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-39" })
  @Put("reporting-entity-39/:id")
  @Permissions("reporting.reportingEntity39.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-39" })
  @Delete("reporting-entity-39/:id")
  @Permissions("reporting.reportingEntity39.delete")
  async deleteReportingEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List reporting-entity-40" })
  @Get("reporting-entity-40")
  @Permissions("reporting.reportingEntity40.read")
  async listReportingEntity40(@Req() req: AuthenticatedRequest) {
    return this.svc.listReportingEntity40(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get reporting-entity-40" })
  @Get("reporting-entity-40/:id")
  @Permissions("reporting.reportingEntity40.read")
  async getReportingEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getReportingEntity40(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create reporting-entity-40" })
  @Post("reporting-entity-40")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update reporting-entity-40" })
  @Put("reporting-entity-40/:id")
  @Permissions("reporting.reportingEntity40.update")
  ...
  @ApiOperation({ summary: "Delete reporting-entity-40" })
  @Delete("reporting-entity-40/:id")
  @Permissions("reporting.reportingEntity40.delete")
  async deleteReportingEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteReportingEntity40(req.user.tenantId, id);
  }
}
