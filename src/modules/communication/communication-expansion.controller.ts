...
export class CommunicationExpansionController {
  ...
  async createChatRoom(
    @Req() req: AuthReq,
    @ZodBody(createChatRoomSchema) body: CreateChatRoomInput,
  ) {
  ...
  async updateChatRoom(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateChatRoomSchema) body: UpdateChatRoomInput,
  ) {
  ...
  async sendMessage(
    @Req() req: AuthReq,
    @ZodBody(sendChatMessageSchema) body: SendChatMessageInput,
  ) {
  ...
  async updateMessage(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateChatMessageSchema) body: UpdateChatMessageInput,
  ) {
  ...
  async addReaction(
    ...
    @ZodBody(createMessageReactionSchema) body: CreateMessageReactionInput,
  ) {
    return this.svc.addReaction(
      req.user.tenantId,
      req.user.userId,
      messageId,
      body,
  ...
  async typingIndicator(
    @Req() req: AuthReq,
    @ZodBody(typingIndicatorSchema) body: { roomId: string; isTyping: boolean },
  ) {
    return {
      roomId: body.roomId,
  ...
  async createVideoCall(
    @Req() req: AuthReq,
    @ZodBody(createVideoCallRoomSchema) body: CreateVideoCallRoomInput,
  ) {
  ...
  async createFileShare(
    @Req() req: AuthReq,
    @ZodBody(createFileShareSchema) body: CreateFileShareInput,
  ) {
  ...
  async createAnnouncement(
    @Req() req: AuthReq,
    @ZodBody(createAnnouncementSchema) body: CreateAnnouncementInput,
  ) {
    return this.svc.createAnnouncement(
      req.user.tenantId,
      req.user.userId,
      body,
    );
  ...
  async updateAnnouncement(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateAnnouncementSchema) body: UpdateAnnouncementInput,
  ) {
