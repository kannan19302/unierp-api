...
export class ProcurementController {
  ...
  async createPurchaseOrder(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreatePurchaseOrderInput,
  ): Promise<unknown> {
  ...
  async createPurchaseReceipt(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreatePurchaseReceiptInput,
  ) {
    return this.procurementService.createPurchaseReceipt(
      req.user.tenantId,
      dto,
      req.user.userId || "system",
    );
  ...
  async createRFQ(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateRFQInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
  ...
  async getSupplierQuotationById(
    ...
    return this.procurementService.getSupplierQuotationById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createSupplierQuotation(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateSupplierQuotationInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.procurementService.createSupplierQuotation(
      req.user.tenantId,
      orgId,
      dto,
    );
  ...
  async updateSupplierQuotationStatus(
    ...
    return this.procurementService.updateSupplierQuotationStatus(
      req.user.tenantId,
      id,
      dto.status,
    );
  ...
  async convertSupplierQuotationToPO(
    ...
    return this.procurementService.convertSupplierQuotationToPO(
      req.user.tenantId,
      id,
      req.user.userId || "system",
    );
  ...
  async createPurchaseReturn(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreatePurchaseReturnInput,
  ): Promise<unknown> {
    const orgId = req.user.orgId || "org-system-default";
    return this.procurementService.createPurchaseReturn(
      req.user.tenantId,
      orgId,
      dto,
      req.user.userId || "system",
  ...
  async createRequisition(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createPurchaseRequisitionSchema))
    dto: CreatePurchaseRequisitionInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.procurementService.createRequisition(
      req.user.tenantId,
      orgId,
      dto,
      req.user.userId || "system",
  ...
  async approveRequisition(
    ...
    return this.procurementService.updateRequisitionStatus(
      req.user.tenantId,
      id,
      "APPROVED",
      req.user.userId || "system",
  ...
  async convertRequisitionToPO(
    ...
    return this.procurementService.convertRequisitionToPO(
      req.user.tenantId,
      id,
      req.user.userId || "system",
    );
  ...
  @Permissions("procurement.purchase-order.read")
  async getBlanketAgreementById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.procurementService.getBlanketAgreementById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createBlanketAgreement(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createBlanketPurchaseAgreementSchema))
    dto: CreateBlanketPurchaseAgreementInput,
  ) {
    const orgId = req.user.orgId || "org-system-default";
    return this.procurementService.createBlanketAgreement(
      req.user.tenantId,
      orgId,
      dto,
      req.user.userId || "system",
  ...
  async createReleaseOrder(
    ...
    return this.procurementService.createReleaseOrder(
      req.user.tenantId,
      id,
      dto,
      req.user.userId || "system",
  ...
  async getVendorPerformanceMetrics(
    ...
    return this.procurementService.getVendorPerformanceMetrics(
      req.user.tenantId,
      id,
    );
  }
  ...
  @Permissions("procurement.purchase-order.read")
  async getThreeWayMatchReport(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.procurementService.getThreeWayMatchReport(
      req.user.tenantId,
      id,
    );
  }
  ...
  async invitePortalUser(
    ...
    return this.vendorPortalService.inviteUser(
      req.user.tenantId,
      vendorId,
      body.email,
    );
  ...
  async getPortalPurchaseOrders(
    ...
    return this.vendorPortalService.getMyPurchaseOrders(
      req.user.tenantId,
      vendorId,
    );
  }
