...
import {
  CreateEcommerceStoreSchema,
  UpdateEcommerceStoreSchema,
  CreateEcommerceCategorySchema,
  UpdateEcommerceCategorySchema,
  CreateEcommerceProductListingSchema,
  UpdateEcommerceProductListingSchema,
  CreateEcommerceCouponSchema,
  CreateEcommerceShippingZoneSchema,
  CreateEcommerceShippingRateSchema,
  CreateEcommerceTaxClassSchema,
  CreateEcommerceTaxRateSchema,
  CreateEcommerceStoreSettingSchema,
  CreateEcommerceStoreThemeSchema,
  CreateEcommerceReviewSchema,
...
export class EcommerceExpansionController {
  ...
  async createStore(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateEcommerceStoreSchema) dto: any,
  ) {
  ...
  async updateStore(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(UpdateEcommerceStoreSchema) dto: any,
  ) {
  ...
  async createCategory(
    @Req() req: AuthenticatedRequest,
    @Param("storeId") storeId: string,
    @ZodBody(CreateEcommerceCategorySchema) dto: any,
  ) {
    return this.expansionService.createCategory(
      req.user.tenantId,
      storeId,
      dto,
    );
  ...
  async updateCategory(
    ...
    @Param("storeId") _storeId: string,
    @Param("id") id: string,
    @ZodBody(UpdateEcommerceCategorySchema) dto: any,
  ) {
  ...
  async createListing(
    @Req() req: AuthenticatedRequest,
    @Param("storeId") storeId: string,
    @ZodBody(CreateEcommerceProductListingSchema) dto: any,
  ) {
  ...
  async updateListing(
    ...
    @Param("storeId") _storeId: string,
    @Param("id") id: string,
    @ZodBody(UpdateEcommerceProductListingSchema) dto: any,
  ) {
  ...
  async createVariant(
    ...
    return this.expansionService.createVariant(
      req.user.tenantId,
      listingId,
      dto,
    );
  ...
  async updateInventory(
    ...
    @ZodBody(z.object({ quantity: z.number().int() })) dto: any,
  ) {
    return this.expansionService.updateInventory(
      req.user.tenantId,
      variantId,
      dto.quantity,
    );
  ...
  async createCoupon(
    @Req() req: AuthenticatedRequest,
    @Param("storeId") storeId: string,
    @ZodBody(CreateEcommerceCouponSchema) dto: any,
  ) {
  ...
  async updateCoupon(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreateEcommerceCouponSchema.partial()) dto: any,
  ) {
  ...
  async createShippingZone(
    @Req() req: AuthenticatedRequest,
    @Param("storeId") storeId: string,
    @ZodBody(CreateEcommerceShippingZoneSchema) dto: any,
  ) {
    return this.expansionService.createShippingZone(
      req.user.tenantId,
      storeId,
      dto,
    );
  ...
  async updateShippingZone(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreateEcommerceShippingZoneSchema.partial()) dto: any,
  ) {
  ...
  async createShippingRate(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateEcommerceShippingRateSchema) dto: any,
  ) {
  ...
  async updateShippingRate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreateEcommerceShippingRateSchema.partial()) dto: any,
  ) {
  ...
  async createTaxClass(
    @Req() req: AuthenticatedRequest,
    @Param("storeId") storeId: string,
    @ZodBody(CreateEcommerceTaxClassSchema) dto: any,
  ) {
    return this.expansionService.createTaxClass(
      req.user.tenantId,
      storeId,
      dto,
    );
  ...
  async createTaxRate(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateEcommerceTaxRateSchema) dto: any,
  ) {
  ...
  async updateTaxRate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreateEcommerceTaxRateSchema.partial()) dto: any,
  ) {
  ...
  async upsertStoreSetting(
    @Req() req: AuthenticatedRequest,
    @Param("storeId") storeId: string,
    @ZodBody(CreateEcommerceStoreSettingSchema) dto: any,
  ) {
    return this.expansionService.upsertStoreSetting(
      req.user.tenantId,
      storeId,
      dto,
    );
  ...
  async deleteStoreSetting(
    @Req() req: AuthenticatedRequest,
    @Param("storeId") storeId: string,
    @Param("key") key: string,
  ) {
    return this.expansionService.deleteStoreSetting(
      req.user.tenantId,
      storeId,
      key,
    );
  ...
  async createTheme(
    @Req() req: AuthenticatedRequest,
    @Param("storeId") storeId: string,
    @ZodBody(CreateEcommerceStoreThemeSchema) dto: any,
  ) {
  ...
  async getReviews(
    ...
    return this.expansionService.getReviews(
      req.user.tenantId,
      listingId,
      query,
    );
  ...
  async createReview(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateEcommerceReviewSchema) dto: any,
  ) {
    return this.expansionService.createReview(
      req.user.tenantId,
      dto,
      req.user.userId,
      req.user.email,
  ...
  async moderateReview(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ approved: z.boolean() })) dto: any,
  ) {
    return this.expansionService.moderateReview(
      req.user.tenantId,
      id,
      dto.approved,
    );
  ...
  async updateOrderStatus(
    ...
    return this.expansionService.updateOrderStatus(
      req.user.tenantId,
      id,
      dto.status,
    );
