...
const createRmaSchema = z.object({
  ...
  source: z.enum(["CUSTOMER_RETURN", "VENDOR_RETURN", "INTERNAL", "QUALITY"]),
...
export class InventoryRmaController {
  ...
  list(
    ...
    return this.rmaSvc.getRmas(req.user.tenantId, {
  ...
  create(
    @Req() req: AuthRequest,
    @ZodBody(createRmaSchema) body: z.infer<typeof createRmaSchema>,
  ) {
    return this.rmaSvc.createRma(req.user.tenantId, body);
  }
  ...
  updateStatus(
    ...
    return this.rmaSvc.updateRmaStatus(req.user.tenantId, id, body);
  }
  ...
  receive(
    @Req() req: AuthRequest,
    @Param("id") id: string,
    @ZodBody(receiveRmaSchema) body: z.infer<typeof receiveRmaSchema>,
  ) {
  ...
  inspect(
    @Req() req: AuthRequest,
    @Param("id") id: string,
    @ZodBody(inspectRmaSchema) body: z.infer<typeof inspectRmaSchema>,
  ) {
