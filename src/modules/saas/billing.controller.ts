import { Controller, Get, Post, UseGuards, UseInterceptors, Req, HttpCode, HttpStatus } from '@nestjs/common';
...
export class BillingController {
  ...
  @Post('checkout')
  async createCheckout(@Req() req: AuthReq, @ZodBody(z.any()) body: { planId: string; successUrl: string }) {
  ...
  @Permissions('saas.create')
  @Post('change-plan')
  async changePlan(@Req() req: AuthReq, @ZodBody(z.any()) body: { planId: string }) {
  ...
  async stripeWebhook(@ZodBody(z.any()) body: any) {
