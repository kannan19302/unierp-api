...
export class NotificationsGeneratedController {
  ...
  @ApiOperation({ summary: "List notifications-entity-22" })
  @Get("notifications-entity-22")
  @Permissions("notifications.notificationsEntity22.read")
  async listNotificationsEntity22(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity22(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-22" })
  @Get("notifications-entity-22/:id")
  @Permissions("notifications.notificationsEntity22.read")
  async getNotificationsEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-22" })
  @Post("notifications-entity-22")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-22" })
  @Put("notifications-entity-22/:id")
  @Permissions("notifications.notificationsEntity22.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-22" })
  @Delete("notifications-entity-22/:id")
  @Permissions("notifications.notificationsEntity22.delete")
  async deleteNotificationsEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-23" })
  @Get("notifications-entity-23")
  @Permissions("notifications.notificationsEntity23.read")
  async listNotificationsEntity23(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity23(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-23" })
  @Get("notifications-entity-23/:id")
  @Permissions("notifications.notificationsEntity23.read")
  async getNotificationsEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-23" })
  @Post("notifications-entity-23")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-23" })
  @Put("notifications-entity-23/:id")
  @Permissions("notifications.notificationsEntity23.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-23" })
  @Delete("notifications-entity-23/:id")
  @Permissions("notifications.notificationsEntity23.delete")
  async deleteNotificationsEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-24" })
  @Get("notifications-entity-24")
  @Permissions("notifications.notificationsEntity24.read")
  async listNotificationsEntity24(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity24(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-24" })
  @Get("notifications-entity-24/:id")
  @Permissions("notifications.notificationsEntity24.read")
  async getNotificationsEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-24" })
  @Post("notifications-entity-24")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-24" })
  @Put("notifications-entity-24/:id")
  @Permissions("notifications.notificationsEntity24.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-24" })
  @Delete("notifications-entity-24/:id")
  @Permissions("notifications.notificationsEntity24.delete")
  async deleteNotificationsEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-25" })
  @Get("notifications-entity-25")
  @Permissions("notifications.notificationsEntity25.read")
  async listNotificationsEntity25(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity25(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-25" })
  @Get("notifications-entity-25/:id")
  @Permissions("notifications.notificationsEntity25.read")
  async getNotificationsEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-25" })
  @Post("notifications-entity-25")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-25" })
  @Put("notifications-entity-25/:id")
  @Permissions("notifications.notificationsEntity25.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-25" })
  @Delete("notifications-entity-25/:id")
  @Permissions("notifications.notificationsEntity25.delete")
  async deleteNotificationsEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-26" })
  @Get("notifications-entity-26")
  @Permissions("notifications.notificationsEntity26.read")
  async listNotificationsEntity26(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity26(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-26" })
  @Get("notifications-entity-26/:id")
  @Permissions("notifications.notificationsEntity26.read")
  async getNotificationsEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-26" })
  @Post("notifications-entity-26")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-26" })
  @Put("notifications-entity-26/:id")
  @Permissions("notifications.notificationsEntity26.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-26" })
  @Delete("notifications-entity-26/:id")
  @Permissions("notifications.notificationsEntity26.delete")
  async deleteNotificationsEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-27" })
  @Get("notifications-entity-27")
  @Permissions("notifications.notificationsEntity27.read")
  async listNotificationsEntity27(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity27(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-27" })
  @Get("notifications-entity-27/:id")
  @Permissions("notifications.notificationsEntity27.read")
  async getNotificationsEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-27" })
  @Post("notifications-entity-27")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-27" })
  @Put("notifications-entity-27/:id")
  @Permissions("notifications.notificationsEntity27.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-27" })
  @Delete("notifications-entity-27/:id")
  @Permissions("notifications.notificationsEntity27.delete")
  async deleteNotificationsEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-28" })
  @Get("notifications-entity-28")
  @Permissions("notifications.notificationsEntity28.read")
  async listNotificationsEntity28(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity28(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-28" })
  @Get("notifications-entity-28/:id")
  @Permissions("notifications.notificationsEntity28.read")
  async getNotificationsEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-28" })
  @Post("notifications-entity-28")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-28" })
  @Put("notifications-entity-28/:id")
  @Permissions("notifications.notificationsEntity28.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-28" })
  @Delete("notifications-entity-28/:id")
  @Permissions("notifications.notificationsEntity28.delete")
  async deleteNotificationsEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-29" })
  @Get("notifications-entity-29")
  @Permissions("notifications.notificationsEntity29.read")
  async listNotificationsEntity29(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity29(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-29" })
  @Get("notifications-entity-29/:id")
  @Permissions("notifications.notificationsEntity29.read")
  async getNotificationsEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-29" })
  @Post("notifications-entity-29")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-29" })
  @Put("notifications-entity-29/:id")
  @Permissions("notifications.notificationsEntity29.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-29" })
  @Delete("notifications-entity-29/:id")
  @Permissions("notifications.notificationsEntity29.delete")
  async deleteNotificationsEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-30" })
  @Get("notifications-entity-30")
  @Permissions("notifications.notificationsEntity30.read")
  async listNotificationsEntity30(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity30(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-30" })
  @Get("notifications-entity-30/:id")
  @Permissions("notifications.notificationsEntity30.read")
  async getNotificationsEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-30" })
  @Post("notifications-entity-30")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-30" })
  @Put("notifications-entity-30/:id")
  @Permissions("notifications.notificationsEntity30.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-30" })
  @Delete("notifications-entity-30/:id")
  @Permissions("notifications.notificationsEntity30.delete")
  async deleteNotificationsEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-31" })
  @Get("notifications-entity-31")
  @Permissions("notifications.notificationsEntity31.read")
  async listNotificationsEntity31(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity31(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-31" })
  @Get("notifications-entity-31/:id")
  @Permissions("notifications.notificationsEntity31.read")
  async getNotificationsEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-31" })
  @Post("notifications-entity-31")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-31" })
  @Put("notifications-entity-31/:id")
  @Permissions("notifications.notificationsEntity31.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-31" })
  @Delete("notifications-entity-31/:id")
  @Permissions("notifications.notificationsEntity31.delete")
  async deleteNotificationsEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-32" })
  @Get("notifications-entity-32")
  @Permissions("notifications.notificationsEntity32.read")
  async listNotificationsEntity32(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity32(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-32" })
  @Get("notifications-entity-32/:id")
  @Permissions("notifications.notificationsEntity32.read")
  async getNotificationsEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-32" })
  @Post("notifications-entity-32")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-32" })
  @Put("notifications-entity-32/:id")
  @Permissions("notifications.notificationsEntity32.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-32" })
  @Delete("notifications-entity-32/:id")
  @Permissions("notifications.notificationsEntity32.delete")
  async deleteNotificationsEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-33" })
  @Get("notifications-entity-33")
  @Permissions("notifications.notificationsEntity33.read")
  async listNotificationsEntity33(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity33(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-33" })
  @Get("notifications-entity-33/:id")
  @Permissions("notifications.notificationsEntity33.read")
  async getNotificationsEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-33" })
  @Post("notifications-entity-33")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-33" })
  @Put("notifications-entity-33/:id")
  @Permissions("notifications.notificationsEntity33.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-33" })
  @Delete("notifications-entity-33/:id")
  @Permissions("notifications.notificationsEntity33.delete")
  async deleteNotificationsEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-34" })
  @Get("notifications-entity-34")
  @Permissions("notifications.notificationsEntity34.read")
  async listNotificationsEntity34(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity34(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-34" })
  @Get("notifications-entity-34/:id")
  @Permissions("notifications.notificationsEntity34.read")
  async getNotificationsEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-34" })
  @Post("notifications-entity-34")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-34" })
  @Put("notifications-entity-34/:id")
  @Permissions("notifications.notificationsEntity34.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-34" })
  @Delete("notifications-entity-34/:id")
  @Permissions("notifications.notificationsEntity34.delete")
  async deleteNotificationsEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-35" })
  @Get("notifications-entity-35")
  @Permissions("notifications.notificationsEntity35.read")
  async listNotificationsEntity35(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity35(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-35" })
  @Get("notifications-entity-35/:id")
  @Permissions("notifications.notificationsEntity35.read")
  async getNotificationsEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-35" })
  @Post("notifications-entity-35")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-35" })
  @Put("notifications-entity-35/:id")
  @Permissions("notifications.notificationsEntity35.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-35" })
  @Delete("notifications-entity-35/:id")
  @Permissions("notifications.notificationsEntity35.delete")
  async deleteNotificationsEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-36" })
  @Get("notifications-entity-36")
  @Permissions("notifications.notificationsEntity36.read")
  async listNotificationsEntity36(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity36(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-36" })
  @Get("notifications-entity-36/:id")
  @Permissions("notifications.notificationsEntity36.read")
  async getNotificationsEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-36" })
  @Post("notifications-entity-36")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-36" })
  @Put("notifications-entity-36/:id")
  @Permissions("notifications.notificationsEntity36.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-36" })
  @Delete("notifications-entity-36/:id")
  @Permissions("notifications.notificationsEntity36.delete")
  async deleteNotificationsEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-37" })
  @Get("notifications-entity-37")
  @Permissions("notifications.notificationsEntity37.read")
  async listNotificationsEntity37(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity37(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-37" })
  @Get("notifications-entity-37/:id")
  @Permissions("notifications.notificationsEntity37.read")
  async getNotificationsEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-37" })
  @Post("notifications-entity-37")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-37" })
  @Put("notifications-entity-37/:id")
  @Permissions("notifications.notificationsEntity37.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-37" })
  @Delete("notifications-entity-37/:id")
  @Permissions("notifications.notificationsEntity37.delete")
  async deleteNotificationsEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-38" })
  @Get("notifications-entity-38")
  @Permissions("notifications.notificationsEntity38.read")
  async listNotificationsEntity38(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity38(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-38" })
  @Get("notifications-entity-38/:id")
  @Permissions("notifications.notificationsEntity38.read")
  async getNotificationsEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-38" })
  @Post("notifications-entity-38")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-38" })
  @Put("notifications-entity-38/:id")
  @Permissions("notifications.notificationsEntity38.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-38" })
  @Delete("notifications-entity-38/:id")
  @Permissions("notifications.notificationsEntity38.delete")
  async deleteNotificationsEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-39" })
  @Get("notifications-entity-39")
  @Permissions("notifications.notificationsEntity39.read")
  async listNotificationsEntity39(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity39(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-39" })
  @Get("notifications-entity-39/:id")
  @Permissions("notifications.notificationsEntity39.read")
  async getNotificationsEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-39" })
  @Post("notifications-entity-39")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-39" })
  @Put("notifications-entity-39/:id")
  @Permissions("notifications.notificationsEntity39.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-39" })
  @Delete("notifications-entity-39/:id")
  @Permissions("notifications.notificationsEntity39.delete")
  async deleteNotificationsEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List notifications-entity-40" })
  @Get("notifications-entity-40")
  @Permissions("notifications.notificationsEntity40.read")
  async listNotificationsEntity40(@Req() req: AuthenticatedRequest) {
    return this.svc.listNotificationsEntity40(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get notifications-entity-40" })
  @Get("notifications-entity-40/:id")
  @Permissions("notifications.notificationsEntity40.read")
  async getNotificationsEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getNotificationsEntity40(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create notifications-entity-40" })
  @Post("notifications-entity-40")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update notifications-entity-40" })
  @Put("notifications-entity-40/:id")
  @Permissions("notifications.notificationsEntity40.update")
  ...
  @ApiOperation({ summary: "Delete notifications-entity-40" })
  @Delete("notifications-entity-40/:id")
  @Permissions("notifications.notificationsEntity40.delete")
  async deleteNotificationsEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteNotificationsEntity40(req.user.tenantId, id);
  }
}
