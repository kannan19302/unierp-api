...
export class EducationController {
  ...
  async getStudents(@Req() req: AuthRequest) {
    return this.svc.getStudents(req.user.tenantId);
  }

  @Get("students/:id")
  @Permissions("education.student.read")
  async getStudent(@Req() req: AuthRequest, @Param("id") id: string) {
    return this.svc.getStudentById(req.user.tenantId, id);
  }

  @Post("students")
  @Permissions("education.student.create")
  async createStudent(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createStudent(req.user.tenantId, body);
  }
  ...
  async updateStudent(
    ...
    return this.svc.updateStudent(req.user.tenantId, id, body);
  }
  ...
  async getCourses(@Req() req: AuthRequest) {
    return this.svc.getCourses(req.user.tenantId);
  }

  @Get("courses/:id")
  @Permissions("education.course.read")
  async getCourse(@Req() req: AuthRequest, @Param("id") id: string) {
    return this.svc.getCourseById(req.user.tenantId, id);
  }

  @Post("courses")
  @Permissions("education.course.create")
  async createCourse(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createCourse(req.user.tenantId, body);
  }
  ...
  async getFeeStructures(@Req() req: AuthRequest) {
    return this.svc.getFeeStructures(req.user.tenantId);
  }

  @Post("fee-structures")
  @Permissions("education.fee.create")
  async createFeeStructure(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createFeeStructure(req.user.tenantId, body);
  }
  ...
  async getStudentFees(@Req() req: AuthRequest) {
    return this.svc.getStudentFees(req.user.tenantId);
  }
  ...
  async getBooks(@Req() req: AuthRequest) {
    return this.svc.getBooks(req.user.tenantId);
  }

  @Post("books")
  @Permissions("education.library.create")
  async createBook(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createBook(req.user.tenantId, body);
  }

  @Post("books/checkout")
  @Permissions("education.library.create")
  async checkoutBook(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.checkoutBook(req.user.tenantId, body);
  }

  // ── Book Transactions ──
  @Get("book-transactions")
  @Permissions("education.library.read")
  async getBookTransactions(@Req() req: AuthRequest) {
    return this.svc.getBookTransactions(req.user.tenantId);
  }
  ...
  async getTimetables(@Req() req: AuthRequest) {
    return this.svc.getTimetables(req.user.tenantId);
  }

  @Post("timetables")
  @Permissions("education.timetable.manage")
  async createTimetable(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createTimetable(req.user.tenantId, body);
  }
  ...
  async getAttendance(
    ...
    return this.svc.getAttendance(req.user.tenantId, {
      studentId,
      courseId,
      date,
    });
