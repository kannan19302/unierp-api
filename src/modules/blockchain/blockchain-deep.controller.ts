...
export class BlockchainDeepController {
  ...
  async updateContract(
    ...
    return this.blockchainDeepService.updateContract(
      req.user.tenantId,
      id,
      body,
    );
  ...
  async listAuditTrails(
    ...
    return this.blockchainDeepService.listAuditTrails(req.user.tenantId, {
      page: page ? parseInt(page) : 1,
  ...
  async createAuditTrail(
    ...
    return this.blockchainDeepService.createAuditTrail(req.user.tenantId, {
      ...body,
