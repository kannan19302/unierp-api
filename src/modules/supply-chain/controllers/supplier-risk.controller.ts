...
export class SupplierRiskController {
  ...
  listProfiles(
    ...
    return this.riskSvc.getRiskProfiles(req.user.tenantId, {
  ...
  resolveAlert(
    ...
    return this.riskSvc.resolveRiskAlert(
      req.user.tenantId,
      id,
      body.resolution,
      req.user.userId,
  ...
  listDiversity(
    @Req() req: AuthRequest,
    @Query("diversityType") diversityType?: string,
  ) {
  ...
  createDiversity(
    ...
    return this.riskSvc.createSupplierDiversity(
      req.user.tenantId,
      profileId,
      body,
    );
