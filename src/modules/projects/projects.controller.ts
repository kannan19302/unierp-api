...
export class ProjectsController {
  ...
  @ApiOperation({
    summary: "Get resource workload for a week (defaults to the current week)",
  })
  ...
  async getResourceWorkload(
    ...
    return this.projectsService.getResourceWorkload(
      req.user.tenantId,
      weekStart,
    );
  }
  ...
  @ApiOperation({
    summary:
      "Get project revenue recognition schedule (time-based percentage-of-completion)",
  })
  ...
  async createChangeRequest(
    ...
    return this.projectsService.createChangeRequest(
      req.user.tenantId,
      projectId,
      dto,
    );
  ...
  async approveChangeRequest(
    ...
    return this.projectsService.approveChangeRequest(
      req.user.tenantId,
      changeRequestId,
      req.user.userId || "system",
    );
  ...
  async generateProjectInvoice(
    ...
    return this.projectsService.generateProjectInvoice(
      req.user.tenantId,
      id,
      req.user.userId || "system",
    );
