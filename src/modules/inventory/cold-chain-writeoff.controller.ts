...
export class ColdChainWriteoffController {
  ...
  logExcursion(@Request() req: AuthRequest, @Body() body: any) {
    return this.svc.logExcursion(req.user.tenantId, {
      ...body,
  ...
  reviewExcursion(
    ...
    return this.svc.reviewExcursion(req.user.tenantId, id, {
      ...body,
  ...
  createWriteDown(@Request() req: AuthRequest, @Body() body: any) {
    return this.svc.createWriteDown(req.user.tenantId, {
      ...body,
  ...
  createWriteOff(@Request() req: AuthRequest, @Body() body: any) {
    return this.svc.createWriteOff(req.user.tenantId, {
      ...body,
      requestedById: req.user.userId,
    });
  }
