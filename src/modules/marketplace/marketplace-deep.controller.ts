...
export class MarketplaceDeepController {
  constructor(
    private readonly marketplaceDeepService: MarketplaceDeepService,
  ) {}
  ...
  async getAppReviews(
    ...
    return this.marketplaceDeepService.getAppReviews(id, {
  ...
  async createAppReview(
    ...
    return this.marketplaceDeepService.createAppReview(
      id,
      req.user.userId,
  ...
  async updateAppReview(
    ...
    return this.marketplaceDeepService.updateAppReview(
      req.user.tenantId,
      req.user.userId,
      id,
      body,
  ...
  async deleteAppReview(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.marketplaceDeepService.deleteAppReview(
      req.user.tenantId,
      req.user.userId,
      id,
    );
  ...
  async createAppVersion(
    ...
    body: { version: string; changelog?: string; fileUrl?: string },
  ) {
  ...
  async listSubmissions(
    ...
    return this.marketplaceDeepService.listSubmissions(
      req.user.tenantId,
      status,
    );
  }
  ...
  async createSubmission(
    ...
    return this.marketplaceDeepService.createSubmission(
      req.user.tenantId,
      req.user.userId,
      body,
    );
  ...
  async approveSubmission(
    ...
    return this.marketplaceDeepService.reviewSubmission(
      req.user.tenantId,
      id,
      req.user.userId,
      "APPROVED",
  ...
  async getAnalytics(
    ...
    return this.marketplaceDeepService.getAnalytics({
      from,
      to,
      appId,
