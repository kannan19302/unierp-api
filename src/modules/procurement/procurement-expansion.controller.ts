...
export class ProcurementExpansionController {
  ...
  async updateSubcontractingStatus(
    ...
    return this.subcontractingService.updateStatus(
      req.user.tenantId,
      id,
      dto.status,
    );
  ...
  @Permissions("procurement.purchase-order.update")
  async issueSubcontractingMaterial(
    @Req() req: AuthRequest,
    @Param("id") id: string,
    @Param("materialId") materialId: string,
    @Body() dto: { issuedQty: number },
  ) {
    return this.subcontractingService.issueMaterial(
      req.user.tenantId,
      id,
      materialId,
      dto.issuedQty,
  ...
  @Permissions("procurement.purchase-order.update")
  async recordSubcontractingConsumption(
    @Req() req: AuthRequest,
    @Param("id") id: string,
    @Param("materialId") materialId: string,
    @Body() dto: { consumedQty: number },
  ) {
    return this.subcontractingService.recordConsumption(
      req.user.tenantId,
      id,
      materialId,
      dto.consumedQty,
  ...
  @Permissions("procurement.purchase-order.read")
  async listSubcontractingByVendor(
    @Req() req: AuthRequest,
    @Param("vendorId") vendorId: string,
    @Query() q: any,
  ) {
    return this.subcontractingService.getOrdersBySubcontractor(
      req.user.tenantId,
      vendorId,
      q,
    );
  ...
  async subcontractingMaterialConsumption(
    @Req() req: AuthRequest,
    @Query() q: { vendorId?: string; startDate?: string; endDate?: string },
  ) {
    return this.subcontractingService.getMaterialConsumptionReport(
      req.user.tenantId,
      q.vendorId,
      q.startDate,
      q.endDate,
  ...
  @Permissions("procurement.purchase-order.read")
  async listDebitNotesByVendor(
    @Req() req: AuthRequest,
    @Param("vendorId") vendorId: string,
    @Query() q: any,
  ) {
    return this.debitNotesService.getDebitNotesByVendor(
      req.user.tenantId,
      vendorId,
      q,
    );
  ...
  async listDebitNotesByDateRange(@Req() req: AuthRequest, @Query() q: any) {
    return this.debitNotesService.getDebitNotesByDateRange(
      req.user.tenantId,
      q.startDate,
      q.endDate,
      q,
  ...
  async processDebitNoteRefund(
    @Req() req: AuthRequest,
    @Param("id") id: string,
    @Body() dto: any,
  ) {
    return this.debitNotesService.processDebitNoteRefund(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async createRma(@Req() req: AuthRequest, @Body() dto: any) {
    const orgId = req.user.orgId || "org-system-default";
    return this.vendorRmaService.createRma(
      req.user.tenantId,
      orgId,
      dto,
      req.user.userId || "system",
  ...
  async updateRmaStatus(
    ...
    return this.vendorRmaService.updateRmaStatus(
      req.user.tenantId,
      id,
      dto.status,
      dto.rejectionReason,
  ...
  @Permissions("procurement.purchase-order.read")
  async listRmasByVendor(
    @Req() req: AuthRequest,
    @Param("vendorId") vendorId: string,
    @Query() q: any,
  ) {
    return this.vendorRmaService.getRmasByVendor(
      req.user.tenantId,
      vendorId,
      q,
    );
  ...
  async listRmasByDateRange(@Req() req: AuthRequest, @Query() q: any) {
    return this.vendorRmaService.getRmasByDateRange(
      req.user.tenantId,
      q.startDate,
      q.endDate,
      q,
  ...
  @Permissions("procurement.purchase-order.create")
  async createRmaShipment(
    @Req() req: AuthRequest,
    @Param("rmaId") rmaId: string,
    @Body() dto: any,
  ) {
    return this.vendorRmaService.createShipment(req.user.tenantId, {
      ...dto,
      rmaRequestId: rmaId,
    });
  }
  ...
  async updateShipmentStatus(
    ...
    return this.vendorRmaService.updateShipmentStatus(
      req.user.tenantId,
      id,
      dto.status,
      dto.creditMemoRef,
  ...
  async createNcr(@Req() req: AuthRequest, @Body() dto: any) {
    return this.supplierNcrCarService.createNcr(
      req.user.tenantId,
      dto,
      req.user.userId || "system",
    );
  ...
  async updateNcrStatus(
    ...
    return this.supplierNcrCarService.updateNcrStatus(
      req.user.tenantId,
      id,
      dto.status,
      dto.resolution,
  ...
  @Permissions("procurement.purchase-order.read")
  async listNcrsBySupplier(
    @Req() req: AuthRequest,
    @Param("vendorId") vendorId: string,
    @Query() q: any,
  ) {
    return this.supplierNcrCarService.getNcrsBySupplier(
      req.user.tenantId,
      vendorId,
      q,
    );
  ...
  async qualityMetrics(
    ...
    return this.supplierNcrCarService.getQualityMetrics(
      req.user.tenantId,
      q.vendorId,
      q.startDate,
      q.endDate,
  ...
  @Permissions("procurement.purchase-order.create")
  async createCarFromNcr(
    @Req() req: AuthRequest,
    @Param("ncrId") ncrId: string,
    @Body() dto: any,
  ) {
    return this.supplierNcrCarService.createCarFromNcr(
      req.user.tenantId,
      ncrId,
      dto,
    );
  ...
  async updateCarStatus(
    @Req() req: AuthRequest,
    @Param("id") id: string,
    @Body() dto: { status: string; vendorResponse?: string },
  ) {
    return this.supplierNcrCarService.updateCarStatus(
      req.user.tenantId,
      id,
      dto.status,
      dto.vendorResponse,
  ...
  @Permissions("procurement.purchase-order.read")
  async listCarsBySupplier(
    @Req() req: AuthRequest,
    @Param("vendorId") vendorId: string,
    @Query() q: any,
  ) {
    return this.supplierNcrCarService.getCarsBySupplier(
      req.user.tenantId,
      vendorId,
      q,
    );
  ...
  async reopenCar(
    ...
    return this.supplierNcrCarService.reopenCar(
      req.user.tenantId,
      id,
      dto.reason,
    );
