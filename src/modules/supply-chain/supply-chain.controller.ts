...
export class SupplyChainController {
  ...
  async createShipment(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: CreateShipmentInput,
  ): Promise<unknown> {
    const orgId = req.user.orgId || "org-system-default";
    return this.supplyChainService.createShipment(
      req.user.tenantId,
      orgId,
      dto,
  ...
  async updateShipmentStatus(
    ...
    return this.supplyChainService.updateShipmentStatus(
      req.user.tenantId,
      id,
      dto.status,
    );
  ...
  async createCarrier(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createCarrierSchema) dto: CreateCarrierDto,
  ) {
  ...
  @Permissions("supply-chain.carrier.read")
  async getCarrierServiceLevels(
    @Req() req: AuthenticatedRequest,
    @Param("id") carrierId: string,
  ) {
    return this.supplyChainService.getCarrierServiceLevels(
      req.user.tenantId,
      carrierId,
    );
  }
  ...
  async createCarrierServiceLevel(
    ...
    return this.supplyChainService.createCarrierServiceLevel(
      req.user.tenantId,
      carrierId,
      dto,
    );
  ...
  async createAsn(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createAsnSchema) dto: CreateAsnDto,
  ) {
  ...
  async receiveAsn(
    ...
    return this.supplyChainService.receiveAsn(
      req.user.tenantId,
      id,
      dto,
      req.user.userId || "system",
  ...
  @Permissions("supply-chain.asn.read")
  async getAsnDiscrepancies(
    @Req() req: AuthenticatedRequest,
    @Param("id") asnId: string,
  ) {
    return this.supplyChainService.getAsnDiscrepancies(
      req.user.tenantId,
      asnId,
    );
  }
  ...
  @Permissions("supply-chain.shipment.read")
  async getInboundShipmentById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.supplyChainService.getInboundShipmentById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createInboundShipment(
    ...
    return this.supplyChainService.createInboundShipment(
      req.user.tenantId,
      dto,
    );
  }
  ...
  @Permissions("supply-chain.shipment.read")
  async getOutboundShipmentById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.supplyChainService.getOutboundShipmentById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createOutboundShipment(
    ...
    return this.supplyChainService.createOutboundShipment(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async addTrackingEvent(
    ...
    if (shipmentType !== "inbound" && shipmentType !== "outbound") {
      throw new BadRequestException(
        "Invalid shipment type. Must be inbound or outbound.",
      );
    }
    return this.supplyChainService.addTrackingEvent(
      req.user.tenantId,
      shipmentType,
      shipmentId,
      dto,
  ...
  async getTrackingEvents(
    ...
    return this.supplyChainService.getTrackingEvents(
      req.user.tenantId,
      shipmentType,
      shipmentId,
    );
  ...
  async reportException(
    ...
    return this.supplyChainService.reportException(
      req.user.tenantId,
      shipmentId,
      dto,
      req.user.userId || "system",
  ...
  async resolveException(
    ...
    return this.supplyChainService.resolveException(
      req.user.tenantId,
      exceptionId,
      dto,
      req.user.userId || "system",
