...
export class SubscriptionsGeneratedController {
  ...
  @ApiOperation({ summary: "List subscriptions-entity-41" }) @Get("subscriptions-entity-41") @Permissions("subscriptions.subscriptionsEntity41.read")
  async listSubscriptionsEntity41(@Req() req: AuthenticatedRequest) { return this.svc.listSubscriptionsEntity41(req.user.tenantId); }

  @ApiOperation({ summary: "Get subscriptions-entity-41" }) @Get("subscriptions-entity-41/:id") @Permissions("subscriptions.subscriptionsEntity41.read")
  async getSubscriptionsEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getSubscriptionsEntity41(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create subscriptions-entity-41" }) @Post("subscriptions-entity-41") @HttpCode(HttpStatus.CREATED) @Permissions("subscriptions.subscriptionsEntity41.create")
  async createSubscriptionsEntity41(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createSubscriptionsEntity41(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update subscriptions-entity-41" }) @Put("subscriptions-entity-41/:id") @Permissions("subscriptions.subscriptionsEntity41.update")
  async updateSubscriptionsEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateSubscriptionsEntity41(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete subscriptions-entity-41" }) @Delete("subscriptions-entity-41/:id") @Permissions("subscriptions.subscriptionsEntity41.delete")
  async deleteSubscriptionsEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteSubscriptionsEntity41(req.user.tenantId, id); }

  @ApiOperation({ summary: "List subscriptions-entity-42" }) @Get("subscriptions-entity-42") @Permissions("subscriptions.subscriptionsEntity42.read")
  async listSubscriptionsEntity42(@Req() req: AuthenticatedRequest) { return this.svc.listSubscriptionsEntity42(req.user.tenantId); }

  @ApiOperation({ summary: "Get subscriptions-entity-42" }) @Get("subscriptions-entity-42/:id") @Permissions("subscriptions.subscriptionsEntity42.read")
  async getSubscriptionsEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getSubscriptionsEntity42(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create subscriptions-entity-42" }) @Post("subscriptions-entity-42") @HttpCode(HttpStatus.CREATED) @Permissions("subscriptions.subscriptionsEntity42.create")
  async createSubscriptionsEntity42(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createSubscriptionsEntity42(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update subscriptions-entity-42" }) @Put("subscriptions-entity-42/:id") @Permissions("subscriptions.subscriptionsEntity42.update")
  async updateSubscriptionsEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateSubscriptionsEntity42(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete subscriptions-entity-42" }) @Delete("subscriptions-entity-42/:id") @Permissions("subscriptions.subscriptionsEntity42.delete")
  async deleteSubscriptionsEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteSubscriptionsEntity42(req.user.tenantId, id); }

  @ApiOperation({ summary: "List subscriptions-entity-43" }) @Get("subscriptions-entity-43") @Permissions("subscriptions.subscriptionsEntity43.read")
  async listSubscriptionsEntity43(@Req() req: AuthenticatedRequest) { return this.svc.listSubscriptionsEntity43(req.user.tenantId); }

  @ApiOperation({ summary: "Get subscriptions-entity-43" }) @Get("subscriptions-entity-43/:id") @Permissions("subscriptions.subscriptionsEntity43.read")
  async getSubscriptionsEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getSubscriptionsEntity43(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create subscriptions-entity-43" }) @Post("subscriptions-entity-43") @HttpCode(HttpStatus.CREATED) @Permissions("subscriptions.subscriptionsEntity43.create")
  async createSubscriptionsEntity43(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createSubscriptionsEntity43(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update subscriptions-entity-43" }) @Put("subscriptions-entity-43/:id") @Permissions("subscriptions.subscriptionsEntity43.update")
  async updateSubscriptionsEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateSubscriptionsEntity43(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete subscriptions-entity-43" }) @Delete("subscriptions-entity-43/:id") @Permissions("subscriptions.subscriptionsEntity43.delete")
  async deleteSubscriptionsEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteSubscriptionsEntity43(req.user.tenantId, id); }

  @ApiOperation({ summary: "List subscriptions-entity-44" }) @Get("subscriptions-entity-44") @Permissions("subscriptions.subscriptionsEntity44.read")
  async listSubscriptionsEntity44(@Req() req: AuthenticatedRequest) { return this.svc.listSubscriptionsEntity44(req.user.tenantId); }

  @ApiOperation({ summary: "Get subscriptions-entity-44" }) @Get("subscriptions-entity-44/:id") @Permissions("subscriptions.subscriptionsEntity44.read")
  async getSubscriptionsEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getSubscriptionsEntity44(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create subscriptions-entity-44" }) @Post("subscriptions-entity-44") @HttpCode(HttpStatus.CREATED) @Permissions("subscriptions.subscriptionsEntity44.create")
  async createSubscriptionsEntity44(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createSubscriptionsEntity44(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update subscriptions-entity-44" }) @Put("subscriptions-entity-44/:id") @Permissions("subscriptions.subscriptionsEntity44.update")
  async updateSubscriptionsEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateSubscriptionsEntity44(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete subscriptions-entity-44" }) @Delete("subscriptions-entity-44/:id") @Permissions("subscriptions.subscriptionsEntity44.delete")
  async deleteSubscriptionsEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteSubscriptionsEntity44(req.user.tenantId, id); }

  @ApiOperation({ summary: "List subscriptions-entity-45" }) @Get("subscriptions-entity-45") @Permissions("subscriptions.subscriptionsEntity45.read")
  async listSubscriptionsEntity45(@Req() req: AuthenticatedRequest) { return this.svc.listSubscriptionsEntity45(req.user.tenantId); }

  @ApiOperation({ summary: "Get subscriptions-entity-45" }) @Get("subscriptions-entity-45/:id") @Permissions("subscriptions.subscriptionsEntity45.read")
  async getSubscriptionsEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getSubscriptionsEntity45(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create subscriptions-entity-45" }) @Post("subscriptions-entity-45") @HttpCode(HttpStatus.CREATED) @Permissions("subscriptions.subscriptionsEntity45.create")
  async createSubscriptionsEntity45(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createSubscriptionsEntity45(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update subscriptions-entity-45" }) @Put("subscriptions-entity-45/:id") @Permissions("subscriptions.subscriptionsEntity45.update")
  async updateSubscriptionsEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateSubscriptionsEntity45(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete subscriptions-entity-45" }) @Delete("subscriptions-entity-45/:id") @Permissions("subscriptions.subscriptionsEntity45.delete")
  async deleteSubscriptionsEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteSubscriptionsEntity45(req.user.tenantId, id); }
