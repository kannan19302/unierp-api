...
} from "../services/inventory-labor.service";
...
export class InventoryLaborController {
  ...
  createStandard(
    @Req() req: AuthReq,
    @ZodBody(createLaborStandardSchema) dto: any,
  ) {
  ...
  updateStandard(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(createLaborStandardSchema.partial()) dto: any,
  ) {
  ...
  completeTask(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(completeTaskSchema) dto: any,
  ) {
  ...
  createShiftTemplate(
    @Req() req: AuthReq,
    @ZodBody(createShiftTemplateSchema) dto: any,
  ) {
  ...
  getWorkerProductivity(
    ...
    return this.service.getWorkerProductivity(
      req.user.tenantId,
      workerId,
