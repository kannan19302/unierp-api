...
} from "../services/crm-lead-scoring.service";
...
export class CrmLeadScoringController {
  ...
  async create(
    ...
    @ZodBody(createLeadScoringRuleSchema) dto: CreateLeadScoringRuleInput,
  ) {
  ...
  async update(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateLeadScoringRuleSchema) dto: UpdateLeadScoringRuleInput,
  ) {
