...
export class ProjectsExpansionController {
  ...
  async addPortfolioMember(
    @Req() req: AuthenticatedRequest,
    @Param("portfolioId") portfolioId: string,
    @ZodBody(PortfolioMemberSchema) dto: unknown,
  ) {
    return this.service.addPortfolioMember(
      req.user.tenantId,
      portfolioId,
      dto as any,
    );
  ...
  async createRiskMitigation(
    @Req() req: AuthenticatedRequest,
    @ZodBody(RiskMitigationSchema) dto: unknown,
  ) {
  ...
  async updateRiskMitigation(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(RiskMitigationSchema.partial()) dto: unknown,
  ) {
  ...
  async createResourceAllocation(
    @Req() req: AuthenticatedRequest,
    @ZodBody(ResourceAllocationSchema) dto: unknown,
  ) {
  ...
  async updateResourceAllocation(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(ResourceAllocationSchema.partial()) dto: unknown,
  ) {
    return this.service.updateResourceAllocation(
      req.user.tenantId,
      id,
      dto as any,
    );
  ...
  async createBudgetLine(
    @Req() req: AuthenticatedRequest,
    @ZodBody(BudgetLineSchema) dto: unknown,
  ) {
  ...
  async updateBudgetLine(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(BudgetLineSchema.partial()) dto: unknown,
  ) {
  ...
  async createDocument(
    @Req() req: AuthenticatedRequest,
    @ZodBody(ProjectDocumentSchema) dto: unknown,
  ) {
