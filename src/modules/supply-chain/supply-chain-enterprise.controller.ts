...
export class SupplyChainEnterpriseController {
  ...
  @ApiOperation({
    summary:
      "End-to-end supply chain visibility - inventory, orders in flight, capacity",
  })
  async getVisibility(
  ...
  @Permissions("supply-chain.enterprise.read")
  @ApiOperation({
    summary: "Demand forecast accuracy - MAPE, MAE, bias analysis",
  })
  async getDemandForecastAccuracy(
    ...
    return this.service.getDemandForecastAccuracy(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  @Permissions("supply-chain.enterprise.read")
  @ApiOperation({
    summary: "Network optimization recommendations - DC location, sourcing",
  })
  async getNetworkOptimization(
    @Req() req: AuthenticatedRequest,
  ...
  @Permissions("supply-chain.enterprise.read")
  @ApiOperation({
    summary: "Logistics cost analysis - freight cost by mode/lane/carrier",
  })
  async getLogisticsCostAnalysis(
    ...
    return this.service.getLogisticsCostAnalysis(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  @Permissions("supply-chain.enterprise.read")
  @ApiOperation({
    summary: "Carrier performance - on-time pickup/delivery, damage rate",
  })
  async getCarrierPerformance(
    ...
    return this.service.getCarrierPerformance(
      req.user.tenantId,
      carrierId,
      period,
    );
  ...
  async getInventoryDaysOfSupply(
    @Req() req: AuthenticatedRequest,
  ...
  @ApiOperation({
    summary:
      "Supply chain risk heatmap - geopolitical, supplier, logistics, inventory",
  })
  ...
  @Permissions("supply-chain.enterprise.read")
  @ApiOperation({
    summary: "Sustainability reporting - carbon footprint by transport mode",
  })
  async getSustainability(
    ...
    return this.service.getSustainabilityReporting(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  @ApiOperation({
    summary:
      "Trade compliance - customs docs, restricted party screening, tariff classification",
  })
  ...
  @Permissions("supply-chain.enterprise.read")
  @ApiOperation({
    summary: "End-to-end order-to-delivery cycle time breakdown",
  })
  async getEndToEndCycleTime(
    ...
    return this.service.getEndToEndCycleTime(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  async exportReport(
    ...
    return this.service.exportSupplyChainReport(
      req.user.tenantId,
      reportType,
      format || "json",
      params,
