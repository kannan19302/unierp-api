...
export class WarehouseOpsController {
  ...
  listTasks(
    ...
    return this.svc.listTasks(req.user.tenantId, {
      status,
      taskType,
      warehouseId,
    });
  ...
  createTask(
    @Req() req: AuthReq,
    @ZodBody(createWarehouseTaskSchema)
    body: z.infer<typeof createWarehouseTaskSchema>,
  ) {
  ...
  assignTask(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(assignTaskSchema) body: z.infer<typeof assignTaskSchema>,
  ) {
  ...
  createBinTransfer(
    @Req() req: AuthReq,
    @ZodBody(createBinTransferSchema)
    body: z.infer<typeof createBinTransferSchema>,
  ) {
  ...
  rejectBinTransfer(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(rejectTransferSchema) body: z.infer<typeof rejectTransferSchema>,
  ) {
  ...
  createGrn(
    @Req() req: AuthReq,
    @ZodBody(createGrnSchema) body: z.infer<typeof createGrnSchema>,
  ) {
  ...
  verifyGrn(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(verifyGrnLinesSchema) body: z.infer<typeof verifyGrnLinesSchema>,
  ) {
  ...
  rejectGrn(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(rejectGrnSchema) body: z.infer<typeof rejectGrnSchema>,
  ) {
  ...
  createPackingSession(
    @Req() req: AuthReq,
    @ZodBody(createPackingSessionSchema)
    body: z.infer<typeof createPackingSessionSchema>,
  ) {
  ...
  addCarton(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(addCartonSchema) body: z.infer<typeof addCartonSchema>,
  ) {
