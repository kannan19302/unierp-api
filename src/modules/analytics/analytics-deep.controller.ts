...
const createKpiSchema = z.object({
  ...
  visualization: z
    .enum(["NUMBER", "GAUGE", "BAR", "LINE", "PIE"])
    .default("NUMBER"),
...
const createBiMetricSchema = z.object({
  ...
  aggregation: z
    ...
    .default("SUM"),
  dataType: z
    .enum(["NUMBER", "CURRENCY", "PERCENTAGE", "STRING", "DATE"])
    .default("NUMBER"),
  unit: z.string().optional(),
  category: z.string().optional(),
...
export class AnalyticsDeepController {
  ...
  async getKpiDefinitions(
    ...
    return this.service.getKpiDefinitions(req.user.tenantId, {
      page,
      limit,
      search: query.search,
  ...
  async createKpiDefinition(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createKpiSchema) dto: unknown,
  ) {
  ...
  async updateKpiDefinition(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateKpiSchema) dto: unknown,
  ) {
  ...
  async computeTrendAnalysis(
    ...
    return this.service.computeTrendAnalysis(
      req.user.tenantId,
      kpiDefinitionId,
      p,
    );
  ...
  async createScheduledExport(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createExportSchema) dto: unknown,
  ) {
  ...
  async updateScheduledExport(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createExportSchema.partial()) dto: unknown,
  ) {
    return this.service.updateScheduledExport(
      req.user.tenantId,
      id,
      dto as any,
    );
  ...
  async createCrossFilterDashboard(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createDashboardSchema) dto: unknown,
  ) {
    return this.service.createCrossFilterDashboard(
      req.user.tenantId,
      dto as any,
      req.user.userId,
    );
  ...
  async updateCrossFilterDashboard(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateDashboardSchema) dto: unknown,
  ) {
    return this.service.updateCrossFilterDashboard(
      req.user.tenantId,
      id,
      dto as any,
    );
  ...
  async deleteCrossFilterDashboard(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
  ...
  async getBiMetricCatalog(
    ...
    const page = parseInt(query.page || "1", 10);
    const limit = parseInt(query.limit || "50", 10);
    return this.service.getBiMetricCatalog(req.user.tenantId, {
      page,
      limit,
      search: query.search,
      category: query.category,
  ...
  async createBiMetricDefinition(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createBiMetricSchema) dto: unknown,
  ) {
  ...
  async updateBiMetricDefinition(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateBiMetricSchema) dto: unknown,
  ) {
    return this.service.updateBiMetricDefinition(
      req.user.tenantId,
      id,
      dto as any,
    );
  ...
  async deleteBiMetricDefinition(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
