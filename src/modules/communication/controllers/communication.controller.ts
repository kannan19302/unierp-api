...
import { CommunicationService, Presence } from "../services/communication.service";
...
export class CommunicationController {
  ...
  async getWorkspace(@Req() req: AuthenticatedRequest) {
    return this.communicationService.getWorkspace(
      req.user.tenantId,
      req.user.userId,
      req.user.orgId,
    );
  ...
  async createSpace(
    ...
    @ZodBody(z.any()) dto: { name: string; emoji?: string },
  ) {
    return this.communicationService.createSpace(
      req.user.tenantId,
  ...
  async createDM(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: { userId: string },
  ) {
    return this.communicationService.getOrCreateDM(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      req.user.userId,
      dto.userId,
  ...
  async createGroup(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) dto: { name: string; memberIds: string[] },
  ) {
    return this.communicationService.createGroup(
      req.user.tenantId,
      req.user.orgId || "org-system-default",
      req.user.userId,
      dto,
  ...
  async markRead(
    ...
    return this.communicationService.markRead(
      req.user.tenantId,
      channelId,
      req.user.userId,
    );
  ...
  async browseChannels(@Req() req: AuthenticatedRequest) {
    return this.communicationService.browseChannels(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async joinChannel(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
    return this.communicationService.joinChannel(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async addChannelMember(
    ...
    return this.communicationService.addChannelMember(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.userId,
  ...
  async removeChannelMember(
    ...
    return this.communicationService.removeChannelMember(
      req.user.tenantId,
      id,
      req.user.userId,
      userId,
  ...
  async getReadReceipts(
    ...
    return this.communicationService.getMessageReadReceipts(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  @ApiOperation({
    summary:
      "Upload a real file attachment for a Connect message (US-A1/US-A2)",
  })
  ...
  async uploadAttachment(
    ...
    return this.communicationService.uploadAttachment(
      req.user.tenantId,
      channelId,
      req.user.userId,
      file,
  ...
  async editMessage(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: { content: string },
  ) {
    return this.communicationService.editMessage(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.content,
  ...
  async toggleReaction(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: { emoji: string },
  ) {
    return this.communicationService.toggleReaction(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.emoji,
  ...
  async getBookmarks(@Req() req: AuthenticatedRequest) {
    return this.communicationService.getBookmarks(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async toggleBookmark(
    ...
    return this.communicationService.toggleBookmark(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async toggleStar(
    ...
    return this.communicationService.toggleStar(
      req.user.tenantId,
      channelId,
      req.user.userId,
    );
  ...
  async toggleMute(
    ...
    return this.communicationService.toggleMute(
      req.user.tenantId,
      channelId,
      req.user.userId,
    );
  ...
  async setNotifyLevel(
    @Req() req: AuthenticatedRequest,
    @Param("channelId") channelId: string,
    @ZodBody(z.object({ notifyLevel: z.enum(["ALL", "MENTIONS", "NONE"]) }))
    dto: { notifyLevel: "ALL" | "MENTIONS" | "NONE" },
  ) {
    return this.communicationService.setNotifyLevel(
      req.user.tenantId,
      channelId,
      req.user.userId,
      dto.notifyLevel,
  ...
  async setPresence(
    ...
    @ZodBody(
      z.object({
        ...
        visibility: z.enum(["EVERYONE", "ORG_ONLY", "NOBODY"]).optional(),
    ...
    dto: {
      presence: Presence;
      visibility?: "EVERYONE" | "ORG_ONLY" | "NOBODY";
      statusText?: string;
      statusEmoji?: string;
      clearAt?: string;
    },
  ) {
    return this.communicationService.setPresence(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  async createMeeting(
    ...
    return this.communicationService.createMeeting(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  async createEvent(
    ...
    return this.communicationService.createEvent(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  async updateNotificationStatus(
    ...
    return this.communicationService.updateNotificationStatus(
      req.user.tenantId,
      id,
      req.user.userId || "system",
      dto.status,
  ...
  async createEmailTemplate(
    ...
    return this.communicationService.createEmailTemplate(
      req.user.tenantId,
      dto,
      req.user.userId || "system",
    );
  ...
  async getThreadMessages(
    ...
    return this.communicationService.getThreadMessages(
      req.user.tenantId,
      parentId,
    );
  }
  ...
  async forwardMessage(
    ...
    return this.communicationService.forwardMessage(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  async getStatusSchedules(@Req() req: AuthenticatedRequest) {
    return this.communicationService.getStatusSchedules(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async createStatusSchedule(
    ...
    return this.communicationService.createStatusSchedule(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  @Permissions("communication.channel.read")
  async deleteStatusSchedule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.communicationService.deleteStatusSchedule(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async searchFiltered(
    ...
    return this.communicationService.searchMessagesFiltered(
      req.user.tenantId,
      req.user.userId,
      q || "",
      { channelId, authorId, dateFrom, dateTo },
    );
  }
  ...
  async createTaskFromMessage(
    ...
    return this.communicationService.createTaskFromMessage(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  async getUnreadSummary(@Req() req: AuthenticatedRequest) {
    return this.communicationService.getUnreadSummary(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async joinMeeting(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
    return this.communicationService.joinMeeting(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async leaveMeeting(
    ...
    return this.communicationService.leaveMeeting(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async toggleHandRaise(
    ...
    return this.communicationService.toggleHandRaise(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  @Permissions("communication.channel.read")
  async toggleMuteMeeting(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.communicationService.toggleMuteSelf(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  @Permissions("communication.channel.read")
  async toggleVideoMeeting(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.communicationService.toggleVideoSelf(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async toggleScreenShare(
    ...
    return this.communicationService.toggleScreenShare(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async getMeetingParticipants(
    ...
    return this.communicationService.getMeetingParticipants(
      req.user.tenantId,
      id,
    );
  }
  ...
  async sendMeetingChat(
    ...
    return this.communicationService.sendMeetingChat(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.content,
  ...
  @Permissions("communication.channel.create")
  async admitToMeeting(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Param("targetUserId") targetUserId: string,
  ) {
    return this.communicationService.admitToMeeting(
      req.user.tenantId,
      id,
      req.user.userId,
      targetUserId,
  ...
  async startRecording(
    ...
    return this.communicationService.startRecording(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async stopRecording(
    ...
    return this.communicationService.stopRecording(
      req.user.tenantId,
      id,
      req.user.userId,
      recordingId,
  ...
  async createTab(
    ...
    return this.adminService.createTab(
      req.user.tenantId,
      channelId,
      req.user.userId,
      dto,
  ...
  async updateTab(
    ...
    return this.adminService.updateTab(
      req.user.tenantId,
      tabId,
      req.user.userId,
      dto,
  ...
  async deleteTab(
    ...
    return this.adminService.deleteTab(
      req.user.tenantId,
      tabId,
      req.user.userId,
    );
  ...
  async setSlowMode(
    @Req() req: AuthenticatedRequest,
    @Param("channelId") channelId: string,
    @ZodBody(z.any()) dto: { slowModeSecs: number },
  ) {
    return this.adminService.setSlowMode(
      req.user.tenantId,
      channelId,
      req.user.userId,
      dto.slowModeSecs,
  ...
  async setWhoCanPost(
    @Req() req: AuthenticatedRequest,
    @Param("channelId") channelId: string,
    @ZodBody(z.any()) dto: { whoCanPost: string },
  ) {
    return this.adminService.setWhoCanPost(
      req.user.tenantId,
      channelId,
      req.user.userId,
      dto.whoCanPost,
  ...
  async getChannelAnalytics(
    ...
    return this.adminService.getChannelAnalytics(
      req.user.tenantId,
      channelId,
  ...
  async createBot(
    @Req() req: AuthenticatedRequest,
    @Param("channelId") channelId: string,
    @ZodBody(z.any()) dto: { name: string; avatar?: string },
  ) {
    return this.botsService.createBot(
      req.user.tenantId,
      channelId,
      req.user.userId,
      dto,
  ...
  async updateBot(
    ...
    return this.botsService.updateBot(
      req.user.tenantId,
      botId,
      req.user.userId,
      dto,
  ...
  async setWebhookUrl(
    @Req() req: AuthenticatedRequest,
    @Param("botId") botId: string,
    @ZodBody(z.any()) dto: { webhookUrl: string },
  ) {
    return this.botsService.setWebhookUrl(
      req.user.tenantId,
      botId,
      req.user.userId,
      dto.webhookUrl,
  ...
  async createPoll(
    ...
    return this.communicationService.createPoll(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  async votePoll(
    ...
    @ZodBody(z.object({ optionId: z.string() })) dto: { optionId: string },
  ) {
    return this.communicationService.votePoll(
      req.user.tenantId,
      pollId,
      req.user.userId,
      dto.optionId,
  ...
  async closePoll(
    ...
    return this.communicationService.closePoll(
      req.user.tenantId,
      pollId,
      req.user.userId,
    );
  ...
  async handleCommand(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.object({ channelId: z.string(), text: z.string() }))
    dto: { channelId: string; text: string },
  ) {
    return this.communicationService.handleSlashCommand(
      req.user.tenantId,
      req.user.userId,
      dto.channelId,
      dto.text,
  ...
  async createReminder(
    ...
    return this.communicationService.createReminder(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  async getReminders(@Req() req: AuthenticatedRequest) {
    return this.communicationService.getReminders(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async deleteReminder(
    ...
    return this.communicationService.deleteReminder(
      req.user.tenantId,
      reminderId,
      req.user.userId,
    );
  ...
  async snoozeReminder(
    @Req() req: AuthenticatedRequest,
    @Param("reminderId") reminderId: string,
    @ZodBody(z.object({ minutes: z.number().optional() }))
    dto: { minutes?: number },
  ) {
    return this.communicationService.snoozeReminder(
      req.user.tenantId,
      reminderId,
      req.user.userId,
      dto.minutes,
  ...
  async scheduleMessage(
    @Req() req: AuthenticatedRequest,
    @Param("channelId") channelId: string,
    @ZodBody(z.object({ content: z.string(), scheduledAt: z.coerce.date() }))
    dto: any,
  ) {
    return this.communicationService.scheduleMessage(
      req.user.tenantId,
      channelId,
      req.user.userId,
      dto,
  ...
  async getScheduledMessages(@Req() req: AuthenticatedRequest) {
    return this.communicationService.getScheduledMessages(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async deleteScheduledMessage(
    ...
    return this.communicationService.deleteScheduledMessage(
      req.user.tenantId,
      messageId,
      req.user.userId,
    );
  ...
  async uploadEmoji(
    ...
    @ZodBody(z.string()) name: any,
  ) {
    return this.communicationService.uploadCustomEmoji(
      req.user.tenantId,
      req.user.userId,
      file,
      name?.name || "emoji",
  ...
  async deleteEmoji(
    ...
    return this.communicationService.deleteCustomEmoji(
      req.user.tenantId,
      emojiId,
    );
  }
  ...
  async translateMessage(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ targetLang: z.string() })) dto: { targetLang: string },
  ) {
    return this.communicationService.translateMessage(
      req.user.tenantId,
      id,
      dto.targetLang,
    );
  ...
  async generateMeetingSummary(
    ...
    return this.communicationService.generateMeetingSummary(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createFromTemplate(
    ...
    return this.communicationService.createChannelFromTemplate(
      req.user.tenantId,
  ...
  async createTemplate(
    ...
    return this.communicationService.createChannelTemplate(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async sendEphemeral(
    ...
    @Param("channelId") channelId: string,
    @ZodBody(
      z.object({ content: z.string(), expiresInSecs: z.number().optional() }),
    )
    dto: any,
  ) {
    return this.communicationService.sendEphemeralMessage(
      req.user.tenantId,
      channelId,
      req.user.userId,
      dto,
  ...
  async markViewed(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
    return this.communicationService.markMessageViewed(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async uploadVoice(
    ...
    return this.communicationService.uploadVoiceMessage(
      req.user.tenantId,
      channelId,
      req.user.userId,
      file,
