...
export class OutboxGeneratedController {
  ...
  @ApiOperation({ summary: "List outbox-entity-22" })
  @Get("outbox-entity-22")
  @Permissions("outbox.outboxEntity22.read")
  async listOutboxEntity22(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity22(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-22" })
  @Get("outbox-entity-22/:id")
  @Permissions("outbox.outboxEntity22.read")
  async getOutboxEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-22" })
  @Post("outbox-entity-22")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-22" })
  @Put("outbox-entity-22/:id")
  @Permissions("outbox.outboxEntity22.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-22" })
  @Delete("outbox-entity-22/:id")
  @Permissions("outbox.outboxEntity22.delete")
  async deleteOutboxEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-23" })
  @Get("outbox-entity-23")
  @Permissions("outbox.outboxEntity23.read")
  async listOutboxEntity23(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity23(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-23" })
  @Get("outbox-entity-23/:id")
  @Permissions("outbox.outboxEntity23.read")
  async getOutboxEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-23" })
  @Post("outbox-entity-23")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-23" })
  @Put("outbox-entity-23/:id")
  @Permissions("outbox.outboxEntity23.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-23" })
  @Delete("outbox-entity-23/:id")
  @Permissions("outbox.outboxEntity23.delete")
  async deleteOutboxEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-24" })
  @Get("outbox-entity-24")
  @Permissions("outbox.outboxEntity24.read")
  async listOutboxEntity24(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity24(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-24" })
  @Get("outbox-entity-24/:id")
  @Permissions("outbox.outboxEntity24.read")
  async getOutboxEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-24" })
  @Post("outbox-entity-24")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-24" })
  @Put("outbox-entity-24/:id")
  @Permissions("outbox.outboxEntity24.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-24" })
  @Delete("outbox-entity-24/:id")
  @Permissions("outbox.outboxEntity24.delete")
  async deleteOutboxEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-25" })
  @Get("outbox-entity-25")
  @Permissions("outbox.outboxEntity25.read")
  async listOutboxEntity25(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity25(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-25" })
  @Get("outbox-entity-25/:id")
  @Permissions("outbox.outboxEntity25.read")
  async getOutboxEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-25" })
  @Post("outbox-entity-25")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-25" })
  @Put("outbox-entity-25/:id")
  @Permissions("outbox.outboxEntity25.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-25" })
  @Delete("outbox-entity-25/:id")
  @Permissions("outbox.outboxEntity25.delete")
  async deleteOutboxEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-26" })
  @Get("outbox-entity-26")
  @Permissions("outbox.outboxEntity26.read")
  async listOutboxEntity26(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity26(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-26" })
  @Get("outbox-entity-26/:id")
  @Permissions("outbox.outboxEntity26.read")
  async getOutboxEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-26" })
  @Post("outbox-entity-26")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-26" })
  @Put("outbox-entity-26/:id")
  @Permissions("outbox.outboxEntity26.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-26" })
  @Delete("outbox-entity-26/:id")
  @Permissions("outbox.outboxEntity26.delete")
  async deleteOutboxEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-27" })
  @Get("outbox-entity-27")
  @Permissions("outbox.outboxEntity27.read")
  async listOutboxEntity27(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity27(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-27" })
  @Get("outbox-entity-27/:id")
  @Permissions("outbox.outboxEntity27.read")
  async getOutboxEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-27" })
  @Post("outbox-entity-27")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-27" })
  @Put("outbox-entity-27/:id")
  @Permissions("outbox.outboxEntity27.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-27" })
  @Delete("outbox-entity-27/:id")
  @Permissions("outbox.outboxEntity27.delete")
  async deleteOutboxEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-28" })
  @Get("outbox-entity-28")
  @Permissions("outbox.outboxEntity28.read")
  async listOutboxEntity28(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity28(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-28" })
  @Get("outbox-entity-28/:id")
  @Permissions("outbox.outboxEntity28.read")
  async getOutboxEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-28" })
  @Post("outbox-entity-28")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-28" })
  @Put("outbox-entity-28/:id")
  @Permissions("outbox.outboxEntity28.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-28" })
  @Delete("outbox-entity-28/:id")
  @Permissions("outbox.outboxEntity28.delete")
  async deleteOutboxEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-29" })
  @Get("outbox-entity-29")
  @Permissions("outbox.outboxEntity29.read")
  async listOutboxEntity29(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity29(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-29" })
  @Get("outbox-entity-29/:id")
  @Permissions("outbox.outboxEntity29.read")
  async getOutboxEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-29" })
  @Post("outbox-entity-29")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-29" })
  @Put("outbox-entity-29/:id")
  @Permissions("outbox.outboxEntity29.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-29" })
  @Delete("outbox-entity-29/:id")
  @Permissions("outbox.outboxEntity29.delete")
  async deleteOutboxEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-30" })
  @Get("outbox-entity-30")
  @Permissions("outbox.outboxEntity30.read")
  async listOutboxEntity30(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity30(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-30" })
  @Get("outbox-entity-30/:id")
  @Permissions("outbox.outboxEntity30.read")
  async getOutboxEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-30" })
  @Post("outbox-entity-30")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-30" })
  @Put("outbox-entity-30/:id")
  @Permissions("outbox.outboxEntity30.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-30" })
  @Delete("outbox-entity-30/:id")
  @Permissions("outbox.outboxEntity30.delete")
  async deleteOutboxEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-31" })
  @Get("outbox-entity-31")
  @Permissions("outbox.outboxEntity31.read")
  async listOutboxEntity31(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity31(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-31" })
  @Get("outbox-entity-31/:id")
  @Permissions("outbox.outboxEntity31.read")
  async getOutboxEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-31" })
  @Post("outbox-entity-31")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-31" })
  @Put("outbox-entity-31/:id")
  @Permissions("outbox.outboxEntity31.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-31" })
  @Delete("outbox-entity-31/:id")
  @Permissions("outbox.outboxEntity31.delete")
  async deleteOutboxEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-32" })
  @Get("outbox-entity-32")
  @Permissions("outbox.outboxEntity32.read")
  async listOutboxEntity32(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity32(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-32" })
  @Get("outbox-entity-32/:id")
  @Permissions("outbox.outboxEntity32.read")
  async getOutboxEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-32" })
  @Post("outbox-entity-32")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-32" })
  @Put("outbox-entity-32/:id")
  @Permissions("outbox.outboxEntity32.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-32" })
  @Delete("outbox-entity-32/:id")
  @Permissions("outbox.outboxEntity32.delete")
  async deleteOutboxEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-33" })
  @Get("outbox-entity-33")
  @Permissions("outbox.outboxEntity33.read")
  async listOutboxEntity33(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity33(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-33" })
  @Get("outbox-entity-33/:id")
  @Permissions("outbox.outboxEntity33.read")
  async getOutboxEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-33" })
  @Post("outbox-entity-33")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-33" })
  @Put("outbox-entity-33/:id")
  @Permissions("outbox.outboxEntity33.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-33" })
  @Delete("outbox-entity-33/:id")
  @Permissions("outbox.outboxEntity33.delete")
  async deleteOutboxEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-34" })
  @Get("outbox-entity-34")
  @Permissions("outbox.outboxEntity34.read")
  async listOutboxEntity34(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity34(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-34" })
  @Get("outbox-entity-34/:id")
  @Permissions("outbox.outboxEntity34.read")
  async getOutboxEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-34" })
  @Post("outbox-entity-34")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-34" })
  @Put("outbox-entity-34/:id")
  @Permissions("outbox.outboxEntity34.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-34" })
  @Delete("outbox-entity-34/:id")
  @Permissions("outbox.outboxEntity34.delete")
  async deleteOutboxEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-35" })
  @Get("outbox-entity-35")
  @Permissions("outbox.outboxEntity35.read")
  async listOutboxEntity35(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity35(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-35" })
  @Get("outbox-entity-35/:id")
  @Permissions("outbox.outboxEntity35.read")
  async getOutboxEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-35" })
  @Post("outbox-entity-35")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-35" })
  @Put("outbox-entity-35/:id")
  @Permissions("outbox.outboxEntity35.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-35" })
  @Delete("outbox-entity-35/:id")
  @Permissions("outbox.outboxEntity35.delete")
  async deleteOutboxEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-36" })
  @Get("outbox-entity-36")
  @Permissions("outbox.outboxEntity36.read")
  async listOutboxEntity36(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity36(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-36" })
  @Get("outbox-entity-36/:id")
  @Permissions("outbox.outboxEntity36.read")
  async getOutboxEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-36" })
  @Post("outbox-entity-36")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-36" })
  @Put("outbox-entity-36/:id")
  @Permissions("outbox.outboxEntity36.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-36" })
  @Delete("outbox-entity-36/:id")
  @Permissions("outbox.outboxEntity36.delete")
  async deleteOutboxEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-37" })
  @Get("outbox-entity-37")
  @Permissions("outbox.outboxEntity37.read")
  async listOutboxEntity37(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity37(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-37" })
  @Get("outbox-entity-37/:id")
  @Permissions("outbox.outboxEntity37.read")
  async getOutboxEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-37" })
  @Post("outbox-entity-37")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-37" })
  @Put("outbox-entity-37/:id")
  @Permissions("outbox.outboxEntity37.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-37" })
  @Delete("outbox-entity-37/:id")
  @Permissions("outbox.outboxEntity37.delete")
  async deleteOutboxEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-38" })
  @Get("outbox-entity-38")
  @Permissions("outbox.outboxEntity38.read")
  async listOutboxEntity38(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity38(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-38" })
  @Get("outbox-entity-38/:id")
  @Permissions("outbox.outboxEntity38.read")
  async getOutboxEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-38" })
  @Post("outbox-entity-38")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-38" })
  @Put("outbox-entity-38/:id")
  @Permissions("outbox.outboxEntity38.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-38" })
  @Delete("outbox-entity-38/:id")
  @Permissions("outbox.outboxEntity38.delete")
  async deleteOutboxEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-39" })
  @Get("outbox-entity-39")
  @Permissions("outbox.outboxEntity39.read")
  async listOutboxEntity39(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity39(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-39" })
  @Get("outbox-entity-39/:id")
  @Permissions("outbox.outboxEntity39.read")
  async getOutboxEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-39" })
  @Post("outbox-entity-39")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-39" })
  @Put("outbox-entity-39/:id")
  @Permissions("outbox.outboxEntity39.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-39" })
  @Delete("outbox-entity-39/:id")
  @Permissions("outbox.outboxEntity39.delete")
  async deleteOutboxEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List outbox-entity-40" })
  @Get("outbox-entity-40")
  @Permissions("outbox.outboxEntity40.read")
  async listOutboxEntity40(@Req() req: AuthenticatedRequest) {
    return this.svc.listOutboxEntity40(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get outbox-entity-40" })
  @Get("outbox-entity-40/:id")
  @Permissions("outbox.outboxEntity40.read")
  async getOutboxEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getOutboxEntity40(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create outbox-entity-40" })
  @Post("outbox-entity-40")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update outbox-entity-40" })
  @Put("outbox-entity-40/:id")
  @Permissions("outbox.outboxEntity40.update")
  ...
  @ApiOperation({ summary: "Delete outbox-entity-40" })
  @Delete("outbox-entity-40/:id")
  @Permissions("outbox.outboxEntity40.delete")
  async deleteOutboxEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteOutboxEntity40(req.user.tenantId, id);
  }
}
