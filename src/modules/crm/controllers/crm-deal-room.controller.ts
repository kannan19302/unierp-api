...
import {
  ...
  CreateDocumentInput,
} from "../services/crm-deal-room.service";
...
export class CrmDealRoomController {
  ...
  async create(
    ...
    @ZodBody(createDealRoomSchema) dto: CreateDealRoomInput,
  ) {
  ...
  @ApiOperation({
    summary: "Get one deal room with milestones/stakeholders/documents",
  })
  @Get(":id")
  @Permissions("crm.dealroom.read")
  ...
  @ApiOperation({
    summary: "Get the deal room for a given opportunity (null if none exists)",
  })
  ...
  async addMilestone(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createMilestoneSchema) dto: CreateMilestoneInput,
  ) {
  ...
  async updateMilestone(
    ...
    @ZodBody(updateMilestoneSchema) dto: UpdateMilestoneInput,
  ) {
  ...
  @ApiOperation({
    summary: "Add a stakeholder to the deal room stakeholder map",
  })
  ...
  async addStakeholder(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createStakeholderSchema) dto: CreateStakeholderInput,
  ) {
  ...
  async addDocument(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createDocumentSchema) dto: CreateDocumentInput,
  ) {
