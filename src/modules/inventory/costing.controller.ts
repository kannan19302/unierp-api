...
export class CostingController {
  ...
  async getProductValuation(
    ...
    return this.costingService.calculateInventoryValue(
      req.user.tenantId,
      productId,
  ...
  async getValuationReport(
    ...
    return this.costingService.getValuationReport(
      req.user.tenantId,
      (method as any) || "WEIGHTED_AVERAGE",
    );
  }
  ...
  async calculateLandedCost(
    ...
    body: {
      ...
      additionalCosts: Array<{
        description: string;
        amount: number;
        allocateBy: "QUANTITY" | "VALUE" | "WEIGHT";
      }>;
    },
  ) {
    return this.costingService.calculateLandedCost(
      req.user.tenantId,
      body.receiptId,
