...
export class PosController {
  ...
  async openRegister(
    ...
    return this.posService.openRegister(
      req.user.tenantId,
      dto,
  ...
  async addCashEntry(
    ...
    return this.posService.addCashEntry(
      req.user.tenantId,
      registerId,
      dto,
      req.user.userId || "system",
  ...
  async getOrders(@Req() req: AuthenticatedRequest, @Query() query: any) {
  ...
  async voidOrder(
    ...
    return this.posService.voidOrder(
      req.user.tenantId,
      id,
      dto.reason,
      req.user.userId,
  ...
  async validateCoupon(
    ...
    return this.posService.validateCoupon(
      req.user.tenantId,
      dto.code,
      dto.orderAmount,
    );
  ...
  async createLoyaltyProgram(
    ...
    const orgId = req.user.orgId || "org-system-default";
    return this.posService.createLoyaltyProgram(
      req.user.tenantId,
      orgId,
      parsed,
    );
  ...
  async redeemLoyaltyPoints(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any())
    dto: { customerId: string; points: number; orderId: string },
  ) {
    return this.posService.redeemLoyaltyPoints(
      req.user.tenantId,
      dto.customerId,
      dto.points,
      dto.orderId,
  ...
  @Permissions("pos.terminal.read")
  async getCustomerDisplayConfig(
    @Req() req: AuthenticatedRequest,
    @Param("terminalId") terminalId: string,
  ) {
    return this.posService.getCustomerDisplayConfig(
      req.user.tenantId,
      terminalId,
    );
  }
  ...
  async updateCustomerDisplayConfig(
    ...
    return this.posService.updateCustomerDisplayConfig(
      req.user.tenantId,
      terminalId,
      dto,
    );
  ...
  async getSalesByProduct(
    ...
    return this.posService.getSalesByProduct(
      req.user.tenantId,
      dateFrom,
      dateTo,
    );
  ...
  async getSalesByCashier(
    ...
    return this.posService.getSalesByCashier(
      req.user.tenantId,
      dateFrom,
      dateTo,
    );
  ...
  async getSalesByPaymentMethod(
    ...
    return this.posService.getSalesByPaymentMethod(
      req.user.tenantId,
      dateFrom,
      dateTo,
    );
  ...
  async getDiscountUsage(
    ...
    return this.posService.getDiscountUsage(
      req.user.tenantId,
      dateFrom,
      dateTo,
    );
  ...
  async getRegisterSummary(
    ...
    return this.posService.getRegisterSummary(
      req.user.tenantId,
      dateFrom,
      dateTo,
    );
  ...
  async updateTerminalReceiptTemplate(
    ...
    return this.posService.updateTerminalReceiptTemplate(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async updateTerminalDiagnostics(
    ...
    return this.posService.updateTerminalDiagnostics(
      req.user.tenantId,
      id,
      dto,
    );
