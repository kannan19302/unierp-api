...
import {
  WorkCenterCapacitySchema,
  ManufacturingRouteSchema,
  QualityCheckTemplateSchema,
  QualityCheckSchema,
  ScrapRecordSchema,
  TimeEntrySchema,
} from "./dto/manufacturing-expansion.dto";
...
export class ManufacturingExpansionController {
  ...
  async getWorkCenterCapacities(
    @Req() req: AuthenticatedRequest,
    @Param("workstationId") workstationId: string,
  ) {
    return this.service.getWorkCenterCapacities(
      req.user.tenantId,
      workstationId,
    );
  }
  ...
  async setWorkCenterCapacity(
    @Req() req: AuthenticatedRequest,
    @ZodBody(WorkCenterCapacitySchema) dto: unknown,
  ) {
  ...
  async updateWorkCenterCapacity(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(WorkCenterCapacitySchema.partial()) dto: unknown,
  ) {
    return this.service.updateWorkCenterCapacity(
      req.user.tenantId,
      id,
      dto as any,
    );
  ...
  async createRoute(
    @Req() req: AuthenticatedRequest,
    @ZodBody(ManufacturingRouteSchema) dto: unknown,
  ) {
  ...
  async updateRoute(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(ManufacturingRouteSchema.partial()) dto: unknown,
  ) {
  ...
  async createQualityCheckTemplate(
    @Req() req: AuthenticatedRequest,
    @ZodBody(QualityCheckTemplateSchema) dto: unknown,
  ) {
    return this.service.createQualityCheckTemplate(
      req.user.tenantId,
      dto as any,
    );
  }
  ...
  async performQualityCheck(
    @Req() req: AuthenticatedRequest,
    @ZodBody(QualityCheckSchema) dto: unknown,
  ) {
  ...
  async createScrapRecord(
    @Req() req: AuthenticatedRequest,
    @ZodBody(ScrapRecordSchema) dto: unknown,
  ) {
  ...
  async getTimeEntries(
    ...
    return this.service.getTimeEntries(
      req.user.tenantId,
      workOrderId,
      employeeId,
    );
  ...
  async createTimeEntry(
    @Req() req: AuthenticatedRequest,
    @ZodBody(TimeEntrySchema) dto: unknown,
  ) {
