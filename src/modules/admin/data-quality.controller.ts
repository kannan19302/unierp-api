...
export class DataQualityController {
  ...
  async scanForDuplicates(
    ...
    return this.dataQualityService.scanForDuplicates(
      req.user.tenantId,
      entityType,
    );
  }
  ...
  async mergeRecords(
    ...
    return this.dataQualityService.mergeRecords(
      req.user.tenantId,
      body.setId,
      body.masterId,
    );
  ...
  @Post(":id/dismiss")
  @Permissions("admin.data-quality.update")
  async dismissSet(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
    return this.dataQualityService.dismissSet(
      req.user.tenantId,
      id,
      req.user.userId,
    );
