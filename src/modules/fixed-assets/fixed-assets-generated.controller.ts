...
export class FixedAssetsGeneratedController {
  ...
  @ApiOperation({ summary: "List fixed-assets-entity-18" })
  @Get("fixed-assets-entity-18")
  @Permissions("fixed-assets.fixedAssetsEntity18.read")
  async listFixedAssetsEntity18(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity18(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-18" })
  @Get("fixed-assets-entity-18/:id")
  @Permissions("fixed-assets.fixedAssetsEntity18.read")
  async getFixedAssetsEntity18(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity18(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-18" })
  @Post("fixed-assets-entity-18")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-18" })
  @Put("fixed-assets-entity-18/:id")
  @Permissions("fixed-assets.fixedAssetsEntity18.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-18" })
  @Delete("fixed-assets-entity-18/:id")
  @Permissions("fixed-assets.fixedAssetsEntity18.delete")
  async deleteFixedAssetsEntity18(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity18(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-19" })
  @Get("fixed-assets-entity-19")
  @Permissions("fixed-assets.fixedAssetsEntity19.read")
  async listFixedAssetsEntity19(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity19(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-19" })
  @Get("fixed-assets-entity-19/:id")
  @Permissions("fixed-assets.fixedAssetsEntity19.read")
  async getFixedAssetsEntity19(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity19(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-19" })
  @Post("fixed-assets-entity-19")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-19" })
  @Put("fixed-assets-entity-19/:id")
  @Permissions("fixed-assets.fixedAssetsEntity19.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-19" })
  @Delete("fixed-assets-entity-19/:id")
  @Permissions("fixed-assets.fixedAssetsEntity19.delete")
  async deleteFixedAssetsEntity19(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity19(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-20" })
  @Get("fixed-assets-entity-20")
  @Permissions("fixed-assets.fixedAssetsEntity20.read")
  async listFixedAssetsEntity20(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity20(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-20" })
  @Get("fixed-assets-entity-20/:id")
  @Permissions("fixed-assets.fixedAssetsEntity20.read")
  async getFixedAssetsEntity20(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity20(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-20" })
  @Post("fixed-assets-entity-20")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-20" })
  @Put("fixed-assets-entity-20/:id")
  @Permissions("fixed-assets.fixedAssetsEntity20.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-20" })
  @Delete("fixed-assets-entity-20/:id")
  @Permissions("fixed-assets.fixedAssetsEntity20.delete")
  async deleteFixedAssetsEntity20(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity20(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-21" })
  @Get("fixed-assets-entity-21")
  @Permissions("fixed-assets.fixedAssetsEntity21.read")
  async listFixedAssetsEntity21(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity21(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-21" })
  @Get("fixed-assets-entity-21/:id")
  @Permissions("fixed-assets.fixedAssetsEntity21.read")
  async getFixedAssetsEntity21(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity21(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-21" })
  @Post("fixed-assets-entity-21")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-21" })
  @Put("fixed-assets-entity-21/:id")
  @Permissions("fixed-assets.fixedAssetsEntity21.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-21" })
  @Delete("fixed-assets-entity-21/:id")
  @Permissions("fixed-assets.fixedAssetsEntity21.delete")
  async deleteFixedAssetsEntity21(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity21(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-22" })
  @Get("fixed-assets-entity-22")
  @Permissions("fixed-assets.fixedAssetsEntity22.read")
  async listFixedAssetsEntity22(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity22(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-22" })
  @Get("fixed-assets-entity-22/:id")
  @Permissions("fixed-assets.fixedAssetsEntity22.read")
  async getFixedAssetsEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-22" })
  @Post("fixed-assets-entity-22")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-22" })
  @Put("fixed-assets-entity-22/:id")
  @Permissions("fixed-assets.fixedAssetsEntity22.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-22" })
  @Delete("fixed-assets-entity-22/:id")
  @Permissions("fixed-assets.fixedAssetsEntity22.delete")
  async deleteFixedAssetsEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-23" })
  @Get("fixed-assets-entity-23")
  @Permissions("fixed-assets.fixedAssetsEntity23.read")
  async listFixedAssetsEntity23(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity23(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-23" })
  @Get("fixed-assets-entity-23/:id")
  @Permissions("fixed-assets.fixedAssetsEntity23.read")
  async getFixedAssetsEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-23" })
  @Post("fixed-assets-entity-23")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-23" })
  @Put("fixed-assets-entity-23/:id")
  @Permissions("fixed-assets.fixedAssetsEntity23.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-23" })
  @Delete("fixed-assets-entity-23/:id")
  @Permissions("fixed-assets.fixedAssetsEntity23.delete")
  async deleteFixedAssetsEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-24" })
  @Get("fixed-assets-entity-24")
  @Permissions("fixed-assets.fixedAssetsEntity24.read")
  async listFixedAssetsEntity24(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity24(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-24" })
  @Get("fixed-assets-entity-24/:id")
  @Permissions("fixed-assets.fixedAssetsEntity24.read")
  async getFixedAssetsEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-24" })
  @Post("fixed-assets-entity-24")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-24" })
  @Put("fixed-assets-entity-24/:id")
  @Permissions("fixed-assets.fixedAssetsEntity24.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-24" })
  @Delete("fixed-assets-entity-24/:id")
  @Permissions("fixed-assets.fixedAssetsEntity24.delete")
  async deleteFixedAssetsEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-25" })
  @Get("fixed-assets-entity-25")
  @Permissions("fixed-assets.fixedAssetsEntity25.read")
  async listFixedAssetsEntity25(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity25(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-25" })
  @Get("fixed-assets-entity-25/:id")
  @Permissions("fixed-assets.fixedAssetsEntity25.read")
  async getFixedAssetsEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-25" })
  @Post("fixed-assets-entity-25")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-25" })
  @Put("fixed-assets-entity-25/:id")
  @Permissions("fixed-assets.fixedAssetsEntity25.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-25" })
  @Delete("fixed-assets-entity-25/:id")
  @Permissions("fixed-assets.fixedAssetsEntity25.delete")
  async deleteFixedAssetsEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-26" })
  @Get("fixed-assets-entity-26")
  @Permissions("fixed-assets.fixedAssetsEntity26.read")
  async listFixedAssetsEntity26(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity26(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-26" })
  @Get("fixed-assets-entity-26/:id")
  @Permissions("fixed-assets.fixedAssetsEntity26.read")
  async getFixedAssetsEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-26" })
  @Post("fixed-assets-entity-26")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-26" })
  @Put("fixed-assets-entity-26/:id")
  @Permissions("fixed-assets.fixedAssetsEntity26.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-26" })
  @Delete("fixed-assets-entity-26/:id")
  @Permissions("fixed-assets.fixedAssetsEntity26.delete")
  async deleteFixedAssetsEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-27" })
  @Get("fixed-assets-entity-27")
  @Permissions("fixed-assets.fixedAssetsEntity27.read")
  async listFixedAssetsEntity27(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity27(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-27" })
  @Get("fixed-assets-entity-27/:id")
  @Permissions("fixed-assets.fixedAssetsEntity27.read")
  async getFixedAssetsEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-27" })
  @Post("fixed-assets-entity-27")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-27" })
  @Put("fixed-assets-entity-27/:id")
  @Permissions("fixed-assets.fixedAssetsEntity27.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-27" })
  @Delete("fixed-assets-entity-27/:id")
  @Permissions("fixed-assets.fixedAssetsEntity27.delete")
  async deleteFixedAssetsEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-28" })
  @Get("fixed-assets-entity-28")
  @Permissions("fixed-assets.fixedAssetsEntity28.read")
  async listFixedAssetsEntity28(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity28(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-28" })
  @Get("fixed-assets-entity-28/:id")
  @Permissions("fixed-assets.fixedAssetsEntity28.read")
  async getFixedAssetsEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-28" })
  @Post("fixed-assets-entity-28")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-28" })
  @Put("fixed-assets-entity-28/:id")
  @Permissions("fixed-assets.fixedAssetsEntity28.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-28" })
  @Delete("fixed-assets-entity-28/:id")
  @Permissions("fixed-assets.fixedAssetsEntity28.delete")
  async deleteFixedAssetsEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-29" })
  @Get("fixed-assets-entity-29")
  @Permissions("fixed-assets.fixedAssetsEntity29.read")
  async listFixedAssetsEntity29(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity29(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-29" })
  @Get("fixed-assets-entity-29/:id")
  @Permissions("fixed-assets.fixedAssetsEntity29.read")
  async getFixedAssetsEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-29" })
  @Post("fixed-assets-entity-29")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-29" })
  @Put("fixed-assets-entity-29/:id")
  @Permissions("fixed-assets.fixedAssetsEntity29.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-29" })
  @Delete("fixed-assets-entity-29/:id")
  @Permissions("fixed-assets.fixedAssetsEntity29.delete")
  async deleteFixedAssetsEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-30" })
  @Get("fixed-assets-entity-30")
  @Permissions("fixed-assets.fixedAssetsEntity30.read")
  async listFixedAssetsEntity30(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity30(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-30" })
  @Get("fixed-assets-entity-30/:id")
  @Permissions("fixed-assets.fixedAssetsEntity30.read")
  async getFixedAssetsEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-30" })
  @Post("fixed-assets-entity-30")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-30" })
  @Put("fixed-assets-entity-30/:id")
  @Permissions("fixed-assets.fixedAssetsEntity30.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-30" })
  @Delete("fixed-assets-entity-30/:id")
  @Permissions("fixed-assets.fixedAssetsEntity30.delete")
  async deleteFixedAssetsEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-31" })
  @Get("fixed-assets-entity-31")
  @Permissions("fixed-assets.fixedAssetsEntity31.read")
  async listFixedAssetsEntity31(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity31(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-31" })
  @Get("fixed-assets-entity-31/:id")
  @Permissions("fixed-assets.fixedAssetsEntity31.read")
  async getFixedAssetsEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-31" })
  @Post("fixed-assets-entity-31")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-31" })
  @Put("fixed-assets-entity-31/:id")
  @Permissions("fixed-assets.fixedAssetsEntity31.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-31" })
  @Delete("fixed-assets-entity-31/:id")
  @Permissions("fixed-assets.fixedAssetsEntity31.delete")
  async deleteFixedAssetsEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-32" })
  @Get("fixed-assets-entity-32")
  @Permissions("fixed-assets.fixedAssetsEntity32.read")
  async listFixedAssetsEntity32(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity32(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-32" })
  @Get("fixed-assets-entity-32/:id")
  @Permissions("fixed-assets.fixedAssetsEntity32.read")
  async getFixedAssetsEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-32" })
  @Post("fixed-assets-entity-32")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-32" })
  @Put("fixed-assets-entity-32/:id")
  @Permissions("fixed-assets.fixedAssetsEntity32.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-32" })
  @Delete("fixed-assets-entity-32/:id")
  @Permissions("fixed-assets.fixedAssetsEntity32.delete")
  async deleteFixedAssetsEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-33" })
  @Get("fixed-assets-entity-33")
  @Permissions("fixed-assets.fixedAssetsEntity33.read")
  async listFixedAssetsEntity33(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity33(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-33" })
  @Get("fixed-assets-entity-33/:id")
  @Permissions("fixed-assets.fixedAssetsEntity33.read")
  async getFixedAssetsEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-33" })
  @Post("fixed-assets-entity-33")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-33" })
  @Put("fixed-assets-entity-33/:id")
  @Permissions("fixed-assets.fixedAssetsEntity33.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-33" })
  @Delete("fixed-assets-entity-33/:id")
  @Permissions("fixed-assets.fixedAssetsEntity33.delete")
  async deleteFixedAssetsEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-34" })
  @Get("fixed-assets-entity-34")
  @Permissions("fixed-assets.fixedAssetsEntity34.read")
  async listFixedAssetsEntity34(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity34(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-34" })
  @Get("fixed-assets-entity-34/:id")
  @Permissions("fixed-assets.fixedAssetsEntity34.read")
  async getFixedAssetsEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-34" })
  @Post("fixed-assets-entity-34")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-34" })
  @Put("fixed-assets-entity-34/:id")
  @Permissions("fixed-assets.fixedAssetsEntity34.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-34" })
  @Delete("fixed-assets-entity-34/:id")
  @Permissions("fixed-assets.fixedAssetsEntity34.delete")
  async deleteFixedAssetsEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-35" })
  @Get("fixed-assets-entity-35")
  @Permissions("fixed-assets.fixedAssetsEntity35.read")
  async listFixedAssetsEntity35(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity35(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-35" })
  @Get("fixed-assets-entity-35/:id")
  @Permissions("fixed-assets.fixedAssetsEntity35.read")
  async getFixedAssetsEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-35" })
  @Post("fixed-assets-entity-35")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-35" })
  @Put("fixed-assets-entity-35/:id")
  @Permissions("fixed-assets.fixedAssetsEntity35.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-35" })
  @Delete("fixed-assets-entity-35/:id")
  @Permissions("fixed-assets.fixedAssetsEntity35.delete")
  async deleteFixedAssetsEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-36" })
  @Get("fixed-assets-entity-36")
  @Permissions("fixed-assets.fixedAssetsEntity36.read")
  async listFixedAssetsEntity36(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity36(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-36" })
  @Get("fixed-assets-entity-36/:id")
  @Permissions("fixed-assets.fixedAssetsEntity36.read")
  async getFixedAssetsEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-36" })
  @Post("fixed-assets-entity-36")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-36" })
  @Put("fixed-assets-entity-36/:id")
  @Permissions("fixed-assets.fixedAssetsEntity36.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-36" })
  @Delete("fixed-assets-entity-36/:id")
  @Permissions("fixed-assets.fixedAssetsEntity36.delete")
  async deleteFixedAssetsEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-37" })
  @Get("fixed-assets-entity-37")
  @Permissions("fixed-assets.fixedAssetsEntity37.read")
  async listFixedAssetsEntity37(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity37(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-37" })
  @Get("fixed-assets-entity-37/:id")
  @Permissions("fixed-assets.fixedAssetsEntity37.read")
  async getFixedAssetsEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-37" })
  @Post("fixed-assets-entity-37")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-37" })
  @Put("fixed-assets-entity-37/:id")
  @Permissions("fixed-assets.fixedAssetsEntity37.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-37" })
  @Delete("fixed-assets-entity-37/:id")
  @Permissions("fixed-assets.fixedAssetsEntity37.delete")
  async deleteFixedAssetsEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-38" })
  @Get("fixed-assets-entity-38")
  @Permissions("fixed-assets.fixedAssetsEntity38.read")
  async listFixedAssetsEntity38(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity38(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-38" })
  @Get("fixed-assets-entity-38/:id")
  @Permissions("fixed-assets.fixedAssetsEntity38.read")
  async getFixedAssetsEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-38" })
  @Post("fixed-assets-entity-38")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-38" })
  @Put("fixed-assets-entity-38/:id")
  @Permissions("fixed-assets.fixedAssetsEntity38.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-38" })
  @Delete("fixed-assets-entity-38/:id")
  @Permissions("fixed-assets.fixedAssetsEntity38.delete")
  async deleteFixedAssetsEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-39" })
  @Get("fixed-assets-entity-39")
  @Permissions("fixed-assets.fixedAssetsEntity39.read")
  async listFixedAssetsEntity39(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity39(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-39" })
  @Get("fixed-assets-entity-39/:id")
  @Permissions("fixed-assets.fixedAssetsEntity39.read")
  async getFixedAssetsEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-39" })
  @Post("fixed-assets-entity-39")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-39" })
  @Put("fixed-assets-entity-39/:id")
  @Permissions("fixed-assets.fixedAssetsEntity39.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-39" })
  @Delete("fixed-assets-entity-39/:id")
  @Permissions("fixed-assets.fixedAssetsEntity39.delete")
  async deleteFixedAssetsEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List fixed-assets-entity-40" })
  @Get("fixed-assets-entity-40")
  @Permissions("fixed-assets.fixedAssetsEntity40.read")
  async listFixedAssetsEntity40(@Req() req: AuthenticatedRequest) {
    return this.svc.listFixedAssetsEntity40(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get fixed-assets-entity-40" })
  @Get("fixed-assets-entity-40/:id")
  @Permissions("fixed-assets.fixedAssetsEntity40.read")
  async getFixedAssetsEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getFixedAssetsEntity40(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create fixed-assets-entity-40" })
  @Post("fixed-assets-entity-40")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update fixed-assets-entity-40" })
  @Put("fixed-assets-entity-40/:id")
  @Permissions("fixed-assets.fixedAssetsEntity40.update")
  ...
  @ApiOperation({ summary: "Delete fixed-assets-entity-40" })
  @Delete("fixed-assets-entity-40/:id")
  @Permissions("fixed-assets.fixedAssetsEntity40.delete")
  async deleteFixedAssetsEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteFixedAssetsEntity40(req.user.tenantId, id);
  }
}
