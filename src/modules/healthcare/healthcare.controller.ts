...
export class HealthcareController {
  ...
  async getPatients(@Req() req: AuthRequest) {
    return this.svc.getPatients(req.user.tenantId);
  }

  @Get("patients/:id")
  @Permissions("healthcare.patient.read")
  async getPatient(@Req() req: AuthRequest, @Param("id") id: string) {
    return this.svc.getPatientById(req.user.tenantId, id);
  }

  @Post("patients")
  @Permissions("healthcare.patient.create")
  async createPatient(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createPatient(req.user.tenantId, body);
  }
  ...
  async getPractitioners(@Req() req: AuthRequest) {
    return this.svc.getPractitioners(req.user.tenantId);
  }

  @Post("practitioners")
  @Permissions("healthcare.practitioner.create")
  async createPractitioner(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createPractitioner(req.user.tenantId, body);
  }

  // ── Appointments ──
  @Get("appointments")
  @Permissions("healthcare.appointments.read")
  async getAppointments(@Req() req: AuthRequest) {
    return this.svc.getAppointments(req.user.tenantId);
  }
  ...
  async getPrescriptions(@Req() req: AuthRequest) {
    return this.svc.getPrescriptions(req.user.tenantId);
  }

  @Post("prescriptions")
  @Permissions("healthcare.prescription.create")
  async createPrescription(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createPrescription(req.user.tenantId, body);
  }

  // ── Encounters ──
  @Get("encounters")
  @Permissions("healthcare.encounter.read")
  async getEncounters(@Req() req: AuthRequest) {
    return this.svc.getEncounters(req.user.tenantId);
  }

  @Post("encounters")
  @Permissions("healthcare.encounter.create")
  async createEncounter(@Req() req: AuthRequest, @Body() body: any) {
    return this.svc.createEncounter(req.user.tenantId, body);
  }
  ...
  async getDrugs(@Req() req: AuthRequest) {
    return this.svc.getDrugs(req.user.tenantId);
  }
