...
export class BuilderController {
  ...
  async getForms(
    ...
    return this.builderFormsService.getForms(req.user.tenantId, {
      search,
      module,
    });
  }
  ...
  async createForm(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createBuilderFormSchema))
  ...
  async updateForm(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(updateBuilderFormSchema))
    dto: UpdateBuilderFormInput,
  ) {
  ...
  async updateWorkflow(
    ...
    return this.builderWorkflowsService.updateWorkflow(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async getGlobalPerformanceStats(@Req() req: AuthenticatedRequest) {
    return this.builderStatsService.getGlobalPerformanceStats(
      req.user.tenantId,
    );
  }
  ...
  async getDashboardById(
    ...
    return this.builderDashboardsService.getDashboardById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createDashboard(
    ...
    return this.builderDashboardsService.createDashboard(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async updateDashboard(
    ...
    return this.builderDashboardsService.updateDashboard(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async generateModule(
    ...
    const layout = await this.builderAiService.generateAppModule(
      req.user.tenantId,
      body.prompt,
    );
    ...
    if (layout.dataModels) {
      for (const dm of layout.dataModels) {
        await this.builderService.addDataModelToModule(
          req.user.tenantId,
          mod.id,
          {
            name: dm.name,
  ...
  async suggestFields(
    ...
    return this.builderAiService.suggestCopilotFields(
      req.user.tenantId,
      body.prompt,
    );
  }
  ...
  async addComponentToModule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(addAppComponentSchema))
    dto: AddAppComponentInput,
  ) {
  ...
  async removeComponentFromModule(
    ...
    return this.builderService.removeComponentFromModule(
      req.user.tenantId,
      id,
      componentId,
    );
  ...
  async removePageFromModule(
    ...
    return this.builderService.removePageFromModule(
      req.user.tenantId,
      id,
      pageId,
    );
  ...
  async updatePageInModule(
    ...
    return this.builderService.updatePageInModule(
      req.user.tenantId,
      id,
      pageId,
      dto,
  ...
  async addDataModelToModule(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(addAppDataModelSchema))
    dto: AddAppDataModelInput,
  ) {
  ...
  async removeDataModelFromModule(
    ...
    return this.builderService.removeDataModelFromModule(
      req.user.tenantId,
      id,
      dataModelId,
    );
  ...
  async publishModule(
    ...
    return this.builderService.publishModule(
      req.user.tenantId,
      id,
      dto,
      req.user.userId,
  ...
  async compareReleaseSnapshot(
    ...
    return this.builderService.compareReleaseSnapshot(
      req.user.tenantId,
      id,
      releaseId,
    );
  ...
  async rollbackModule(
    ...
    return this.builderService.rollbackModule(
      req.user.tenantId,
      id,
      dto.releaseId,
    );
  ...
  async installBuilderApp(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(installBuilderAppSchema))
    dto: InstallBuilderAppInput,
  ) {
    return this.builderService.installBuilderApp(
      req.user.tenantId,
      dto.moduleId,
      dto.releaseId,
    );
  ...
  async uninstallBuilderApp(
    ...
    return this.builderService.uninstallBuilderApp(
      req.user.tenantId,
      dto.moduleId,
    );
  }
  ...
  async createDataImport(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createDataImportSchema))
  ...
  async executeDataImport(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(executeDataImportSchema))
    dto: ExecuteDataImportInput,
  ) {
    return this.builderService.executeDataImport(
      req.user.tenantId,
      id,
      dto.rows,
    );
  ...
  async updateWebPage(
    ...
    return this.builderWebContentService.updateWebPage(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async updateBlogPost(
    ...
    return this.builderWebContentService.updateBlogPost(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async createWebAsset(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createWebAssetSchema)) dto: any,
  ) {
  ...
  async updateWebAsset(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(updateWebAssetSchema)) dto: any,
  ) {
    return this.builderWebContentService.updateWebAsset(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async createWebTemplate(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createWebTemplateSchema)) dto: any,
  ) {
    return this.builderWebContentService.createWebTemplate(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async updateWebTemplate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(updateWebTemplateSchema)) dto: any,
  ) {
    return this.builderWebContentService.updateWebTemplate(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  @Permissions("builder.web.delete")
  async deleteWebTemplate(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.builderWebContentService.deleteWebTemplate(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createWebMenu(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createWebMenuSchema)) dto: any,
  ) {
  ...
  async updateWebMenu(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(updateWebMenuSchema)) dto: any,
  ) {
    return this.builderWebContentService.updateWebMenu(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async createWebSeo(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createWebSeoSchema)) dto: any,
  ) {
  ...
  async updateWebSeo(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(updateWebSeoSchema)) dto: any,
  ) {
    return this.builderWebContentService.updateWebSeo(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async logAnalytics(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(builderAnalyticsEventSchema))
    data: BuilderAnalyticsEventInput,
  ) {
  ...
  async generateSchema(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(builderAiGenerateSchema))
    data: BuilderAiGenerateInput,
  ) {
    return this.builderService.generateSchemaFromPrompt(
      req.user.tenantId,
      data.prompt,
    );
  }
  ...
  async createSchemaRegistry(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createSchemaRegistrySchema))
    dto: CreateSchemaRegistryInput,
  ) {
  ...
  async updateSchemaRegistry(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(updateSchemaRegistrySchema))
    dto: UpdateSchemaRegistryInput,
  ) {
  ...
  async getPageRegistryBySlug(
    ...
    return this.builderService.getPageRegistryBySlug(
      req.user.tenantId,
      module,
      slug,
    );
  ...
  async createPageRegistry(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createPageRegistrySchema))
    dto: CreatePageRegistryInput,
  ) {
  ...
  async updatePageRegistry(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(updatePageRegistrySchema))
    dto: UpdatePageRegistryInput,
  ) {
  ...
  async restorePageRegistryHistory(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(restorePageRegistryHistorySchema))
    dto: RestorePageRegistryHistoryInput,
  ) {
    return this.builderService.restorePageRegistryHistory(
      req.user.tenantId,
      id,
      dto.historyIndex,
    );
  ...
  async getCustomRecords(
    ...
    return this.builderService.getCustomRecords(
      req.user.tenantId,
      schemaId,
      req.user.roles,
      {
  ...
  async getCustomRecordById(
    ...
    return this.builderService.getCustomRecordById(
      req.user.tenantId,
      schemaId,
      id,
      req.user.roles,
  ...
  async createCustomRecord(
    @Req() req: AuthenticatedRequest,
    @Param("schemaId") schemaId: string,
    @Body(new ZodValidationPipe(customRecordDataSchema))
    data: CustomRecordDataInput,
  ) {
    return this.builderService.createCustomRecord(
      req.user.tenantId,
      schemaId,
      data,
      req.user.userId,
  ...
  async updateCustomRecord(
    ...
    return this.builderService.updateCustomRecord(
      req.user.tenantId,
      schemaId,
      id,
      data,
  ...
  async deleteCustomRecord(
    ...
    return this.builderService.deleteCustomRecord(
      req.user.tenantId,
      schemaId,
      id,
    );
  ...
  async updateWebSettings(
    @Req() req: AuthenticatedRequest,
    @ZodBody(z.any()) data: any,
  ) {
    return this.builderWebContentService.updateWebSettings(
      req.user.tenantId,
      data,
    );
  }
  ...
  async createCollection(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(createWebCollectionSchema))
    dto: CreateWebCollectionInput,
  ) {
    return this.webCollections.createCollection(
      req.user.tenantId,
      dto,
      req.user.userId,
    );
  ...
  async seedCollection(
    @Req() req: AuthenticatedRequest,
    @Body(new ZodValidationPipe(seedWebCollectionSchema))
    dto: SeedWebCollectionInput,
  ) {
    return this.webCollections.seedCollection(
      req.user.tenantId,
      dto.preset,
      req.user.userId,
    );
  ...
  async updateCollection(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(updateWebCollectionSchema))
  ...
  async createCollectionItem(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @Body(new ZodValidationPipe(createWebCollectionItemSchema))
    dto: CreateWebCollectionItemInput,
  ) {
    return this.webCollections.createItem(
      req.user.tenantId,
      id,
      dto,
      req.user.userId,
  ...
  async updateCollectionItem(
    ...
    @Param("id") id: string,
    @Param("itemId") itemId: string,
    @Body(new ZodValidationPipe(updateWebCollectionItemSchema))
  ...
  async getFormSubmissions(
    ...
    return this.webCollections.getSubmissions(req.user.tenantId, {
      formName,
      status,
    });
  }
  ...
  async updateFormSubmission(
    ...
    return this.webCollections.updateSubmissionStatus(
      req.user.tenantId,
      id,
      body.status,
    );
  ...
  async updateOrder(
    ...
    return this.webCollections.updateOrderStatus(
      req.user.tenantId,
      id,
      body.status,
    );
  ...
  async saveNavOverlay(
    ...
    return this.builderService.saveNavOverlay(
      req.user.tenantId,
      moduleId,
      body.config,
      req.user.userId,
  ...
  async createSubmodule(
    ...
    return this.builderService.createSubmodule(
      req.user.tenantId,
      moduleId,
      body as any,
      req.user.userId,
  ...
  async deleteSubmodule(
    ...
    return this.builderService.deleteSubmodule(
      req.user.tenantId,
      moduleId,
      slug,
    );
  ...
  async createWidget(
    ...
    return this.builderDevOpsService.createWidget(
      req.user.tenantId,
      body.name,
      body.tag,
      body.source,
  ...
  async saveGitConfig(
    ...
    return this.builderDevOpsService.saveGitConfig(
      req.user.tenantId,
      body.repoUrl,
      body.branch,
      body.accessToken,
  ...
  async executeGitCommit(
    ...
    return this.builderDevOpsService.executeGitCommit(
      req.user.tenantId,
      body.message,
    );
  }
  ...
  async triggerNativeBuild(
    ...
    return this.builderDevOpsService.triggerNativeBuild(
      req.user.tenantId,
      body.version,
      body.platform,
    );
