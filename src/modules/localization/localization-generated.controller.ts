...
export class LocalizationGeneratedController {
  ...
  @ApiOperation({ summary: "List localization-entity-18" })
  @Get("localization-entity-18")
  @Permissions("localization.localizationEntity18.read")
  async listLocalizationEntity18(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity18(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-18" })
  @Get("localization-entity-18/:id")
  @Permissions("localization.localizationEntity18.read")
  async getLocalizationEntity18(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity18(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-18" })
  @Post("localization-entity-18")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-18" })
  @Put("localization-entity-18/:id")
  @Permissions("localization.localizationEntity18.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-18" })
  @Delete("localization-entity-18/:id")
  @Permissions("localization.localizationEntity18.delete")
  async deleteLocalizationEntity18(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity18(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-19" })
  @Get("localization-entity-19")
  @Permissions("localization.localizationEntity19.read")
  async listLocalizationEntity19(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity19(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-19" })
  @Get("localization-entity-19/:id")
  @Permissions("localization.localizationEntity19.read")
  async getLocalizationEntity19(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity19(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-19" })
  @Post("localization-entity-19")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-19" })
  @Put("localization-entity-19/:id")
  @Permissions("localization.localizationEntity19.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-19" })
  @Delete("localization-entity-19/:id")
  @Permissions("localization.localizationEntity19.delete")
  async deleteLocalizationEntity19(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity19(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-20" })
  @Get("localization-entity-20")
  @Permissions("localization.localizationEntity20.read")
  async listLocalizationEntity20(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity20(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-20" })
  @Get("localization-entity-20/:id")
  @Permissions("localization.localizationEntity20.read")
  async getLocalizationEntity20(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity20(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-20" })
  @Post("localization-entity-20")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-20" })
  @Put("localization-entity-20/:id")
  @Permissions("localization.localizationEntity20.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-20" })
  @Delete("localization-entity-20/:id")
  @Permissions("localization.localizationEntity20.delete")
  async deleteLocalizationEntity20(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity20(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-21" })
  @Get("localization-entity-21")
  @Permissions("localization.localizationEntity21.read")
  async listLocalizationEntity21(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity21(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-21" })
  @Get("localization-entity-21/:id")
  @Permissions("localization.localizationEntity21.read")
  async getLocalizationEntity21(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity21(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-21" })
  @Post("localization-entity-21")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-21" })
  @Put("localization-entity-21/:id")
  @Permissions("localization.localizationEntity21.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-21" })
  @Delete("localization-entity-21/:id")
  @Permissions("localization.localizationEntity21.delete")
  async deleteLocalizationEntity21(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity21(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-22" })
  @Get("localization-entity-22")
  @Permissions("localization.localizationEntity22.read")
  async listLocalizationEntity22(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity22(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-22" })
  @Get("localization-entity-22/:id")
  @Permissions("localization.localizationEntity22.read")
  async getLocalizationEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-22" })
  @Post("localization-entity-22")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-22" })
  @Put("localization-entity-22/:id")
  @Permissions("localization.localizationEntity22.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-22" })
  @Delete("localization-entity-22/:id")
  @Permissions("localization.localizationEntity22.delete")
  async deleteLocalizationEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-23" })
  @Get("localization-entity-23")
  @Permissions("localization.localizationEntity23.read")
  async listLocalizationEntity23(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity23(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-23" })
  @Get("localization-entity-23/:id")
  @Permissions("localization.localizationEntity23.read")
  async getLocalizationEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-23" })
  @Post("localization-entity-23")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-23" })
  @Put("localization-entity-23/:id")
  @Permissions("localization.localizationEntity23.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-23" })
  @Delete("localization-entity-23/:id")
  @Permissions("localization.localizationEntity23.delete")
  async deleteLocalizationEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-24" })
  @Get("localization-entity-24")
  @Permissions("localization.localizationEntity24.read")
  async listLocalizationEntity24(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity24(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-24" })
  @Get("localization-entity-24/:id")
  @Permissions("localization.localizationEntity24.read")
  async getLocalizationEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-24" })
  @Post("localization-entity-24")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-24" })
  @Put("localization-entity-24/:id")
  @Permissions("localization.localizationEntity24.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-24" })
  @Delete("localization-entity-24/:id")
  @Permissions("localization.localizationEntity24.delete")
  async deleteLocalizationEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-25" })
  @Get("localization-entity-25")
  @Permissions("localization.localizationEntity25.read")
  async listLocalizationEntity25(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity25(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-25" })
  @Get("localization-entity-25/:id")
  @Permissions("localization.localizationEntity25.read")
  async getLocalizationEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-25" })
  @Post("localization-entity-25")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-25" })
  @Put("localization-entity-25/:id")
  @Permissions("localization.localizationEntity25.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-25" })
  @Delete("localization-entity-25/:id")
  @Permissions("localization.localizationEntity25.delete")
  async deleteLocalizationEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-26" })
  @Get("localization-entity-26")
  @Permissions("localization.localizationEntity26.read")
  async listLocalizationEntity26(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity26(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-26" })
  @Get("localization-entity-26/:id")
  @Permissions("localization.localizationEntity26.read")
  async getLocalizationEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-26" })
  @Post("localization-entity-26")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-26" })
  @Put("localization-entity-26/:id")
  @Permissions("localization.localizationEntity26.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-26" })
  @Delete("localization-entity-26/:id")
  @Permissions("localization.localizationEntity26.delete")
  async deleteLocalizationEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-27" })
  @Get("localization-entity-27")
  @Permissions("localization.localizationEntity27.read")
  async listLocalizationEntity27(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity27(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-27" })
  @Get("localization-entity-27/:id")
  @Permissions("localization.localizationEntity27.read")
  async getLocalizationEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-27" })
  @Post("localization-entity-27")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-27" })
  @Put("localization-entity-27/:id")
  @Permissions("localization.localizationEntity27.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-27" })
  @Delete("localization-entity-27/:id")
  @Permissions("localization.localizationEntity27.delete")
  async deleteLocalizationEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-28" })
  @Get("localization-entity-28")
  @Permissions("localization.localizationEntity28.read")
  async listLocalizationEntity28(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity28(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-28" })
  @Get("localization-entity-28/:id")
  @Permissions("localization.localizationEntity28.read")
  async getLocalizationEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-28" })
  @Post("localization-entity-28")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-28" })
  @Put("localization-entity-28/:id")
  @Permissions("localization.localizationEntity28.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-28" })
  @Delete("localization-entity-28/:id")
  @Permissions("localization.localizationEntity28.delete")
  async deleteLocalizationEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-29" })
  @Get("localization-entity-29")
  @Permissions("localization.localizationEntity29.read")
  async listLocalizationEntity29(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity29(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-29" })
  @Get("localization-entity-29/:id")
  @Permissions("localization.localizationEntity29.read")
  async getLocalizationEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-29" })
  @Post("localization-entity-29")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-29" })
  @Put("localization-entity-29/:id")
  @Permissions("localization.localizationEntity29.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-29" })
  @Delete("localization-entity-29/:id")
  @Permissions("localization.localizationEntity29.delete")
  async deleteLocalizationEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-30" })
  @Get("localization-entity-30")
  @Permissions("localization.localizationEntity30.read")
  async listLocalizationEntity30(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity30(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-30" })
  @Get("localization-entity-30/:id")
  @Permissions("localization.localizationEntity30.read")
  async getLocalizationEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-30" })
  @Post("localization-entity-30")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-30" })
  @Put("localization-entity-30/:id")
  @Permissions("localization.localizationEntity30.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-30" })
  @Delete("localization-entity-30/:id")
  @Permissions("localization.localizationEntity30.delete")
  async deleteLocalizationEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-31" })
  @Get("localization-entity-31")
  @Permissions("localization.localizationEntity31.read")
  async listLocalizationEntity31(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity31(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-31" })
  @Get("localization-entity-31/:id")
  @Permissions("localization.localizationEntity31.read")
  async getLocalizationEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-31" })
  @Post("localization-entity-31")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-31" })
  @Put("localization-entity-31/:id")
  @Permissions("localization.localizationEntity31.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-31" })
  @Delete("localization-entity-31/:id")
  @Permissions("localization.localizationEntity31.delete")
  async deleteLocalizationEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-32" })
  @Get("localization-entity-32")
  @Permissions("localization.localizationEntity32.read")
  async listLocalizationEntity32(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity32(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-32" })
  @Get("localization-entity-32/:id")
  @Permissions("localization.localizationEntity32.read")
  async getLocalizationEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-32" })
  @Post("localization-entity-32")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-32" })
  @Put("localization-entity-32/:id")
  @Permissions("localization.localizationEntity32.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-32" })
  @Delete("localization-entity-32/:id")
  @Permissions("localization.localizationEntity32.delete")
  async deleteLocalizationEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-33" })
  @Get("localization-entity-33")
  @Permissions("localization.localizationEntity33.read")
  async listLocalizationEntity33(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity33(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-33" })
  @Get("localization-entity-33/:id")
  @Permissions("localization.localizationEntity33.read")
  async getLocalizationEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-33" })
  @Post("localization-entity-33")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-33" })
  @Put("localization-entity-33/:id")
  @Permissions("localization.localizationEntity33.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-33" })
  @Delete("localization-entity-33/:id")
  @Permissions("localization.localizationEntity33.delete")
  async deleteLocalizationEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-34" })
  @Get("localization-entity-34")
  @Permissions("localization.localizationEntity34.read")
  async listLocalizationEntity34(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity34(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-34" })
  @Get("localization-entity-34/:id")
  @Permissions("localization.localizationEntity34.read")
  async getLocalizationEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-34" })
  @Post("localization-entity-34")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-34" })
  @Put("localization-entity-34/:id")
  @Permissions("localization.localizationEntity34.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-34" })
  @Delete("localization-entity-34/:id")
  @Permissions("localization.localizationEntity34.delete")
  async deleteLocalizationEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-35" })
  @Get("localization-entity-35")
  @Permissions("localization.localizationEntity35.read")
  async listLocalizationEntity35(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity35(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-35" })
  @Get("localization-entity-35/:id")
  @Permissions("localization.localizationEntity35.read")
  async getLocalizationEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-35" })
  @Post("localization-entity-35")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-35" })
  @Put("localization-entity-35/:id")
  @Permissions("localization.localizationEntity35.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-35" })
  @Delete("localization-entity-35/:id")
  @Permissions("localization.localizationEntity35.delete")
  async deleteLocalizationEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-36" })
  @Get("localization-entity-36")
  @Permissions("localization.localizationEntity36.read")
  async listLocalizationEntity36(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity36(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-36" })
  @Get("localization-entity-36/:id")
  @Permissions("localization.localizationEntity36.read")
  async getLocalizationEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-36" })
  @Post("localization-entity-36")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-36" })
  @Put("localization-entity-36/:id")
  @Permissions("localization.localizationEntity36.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-36" })
  @Delete("localization-entity-36/:id")
  @Permissions("localization.localizationEntity36.delete")
  async deleteLocalizationEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-37" })
  @Get("localization-entity-37")
  @Permissions("localization.localizationEntity37.read")
  async listLocalizationEntity37(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity37(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-37" })
  @Get("localization-entity-37/:id")
  @Permissions("localization.localizationEntity37.read")
  async getLocalizationEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-37" })
  @Post("localization-entity-37")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-37" })
  @Put("localization-entity-37/:id")
  @Permissions("localization.localizationEntity37.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-37" })
  @Delete("localization-entity-37/:id")
  @Permissions("localization.localizationEntity37.delete")
  async deleteLocalizationEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-38" })
  @Get("localization-entity-38")
  @Permissions("localization.localizationEntity38.read")
  async listLocalizationEntity38(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity38(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-38" })
  @Get("localization-entity-38/:id")
  @Permissions("localization.localizationEntity38.read")
  async getLocalizationEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-38" })
  @Post("localization-entity-38")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-38" })
  @Put("localization-entity-38/:id")
  @Permissions("localization.localizationEntity38.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-38" })
  @Delete("localization-entity-38/:id")
  @Permissions("localization.localizationEntity38.delete")
  async deleteLocalizationEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-39" })
  @Get("localization-entity-39")
  @Permissions("localization.localizationEntity39.read")
  async listLocalizationEntity39(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity39(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-39" })
  @Get("localization-entity-39/:id")
  @Permissions("localization.localizationEntity39.read")
  async getLocalizationEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-39" })
  @Post("localization-entity-39")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-39" })
  @Put("localization-entity-39/:id")
  @Permissions("localization.localizationEntity39.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-39" })
  @Delete("localization-entity-39/:id")
  @Permissions("localization.localizationEntity39.delete")
  async deleteLocalizationEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List localization-entity-40" })
  @Get("localization-entity-40")
  @Permissions("localization.localizationEntity40.read")
  async listLocalizationEntity40(@Req() req: AuthenticatedRequest) {
    return this.svc.listLocalizationEntity40(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get localization-entity-40" })
  @Get("localization-entity-40/:id")
  @Permissions("localization.localizationEntity40.read")
  async getLocalizationEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getLocalizationEntity40(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create localization-entity-40" })
  @Post("localization-entity-40")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update localization-entity-40" })
  @Put("localization-entity-40/:id")
  @Permissions("localization.localizationEntity40.update")
  ...
  @ApiOperation({ summary: "Delete localization-entity-40" })
  @Delete("localization-entity-40/:id")
  @Permissions("localization.localizationEntity40.delete")
  async deleteLocalizationEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deleteLocalizationEntity40(req.user.tenantId, id);
  }
}
