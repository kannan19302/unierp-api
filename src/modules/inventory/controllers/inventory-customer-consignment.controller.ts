...
} from "../services/inventory-customer-consignment.service";
...
export class InventoryCustomerConsignmentController {
  ...
  create(
    @Req() req: AuthReq,
    @ZodBody(createCustomerConsignmentSchema) dto: any,
  ) {
  ...
  update(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateCustomerConsignmentSchema) dto: any,
  ) {
  ...
  recordConsumption(
    @Req() req: AuthReq,
    @ZodBody(recordConsumptionSchema) dto: any,
  ) {
