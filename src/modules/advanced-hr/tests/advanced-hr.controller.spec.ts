...
describe("AdvancedHrController", () => {
  ...
  const req = {
    user: { tenantId: "tenant-1", userId: "user-1", orgId: "org-1" },
  };
  ...
  it("should call getAttendanceRecords with tenantId and employeeId", async () => {
    ...
    expect(service.getAttendanceRecords).toHaveBeenCalledWith(
      "tenant-1",
      "emp-1",
    );
  });
  ...
  it("should call getEmployeeDocuments and createEmployeeDocument", async () => {
    ...
    expect(service.getEmployeeDocuments).toHaveBeenCalledWith(
      "tenant-1",
      "emp-1",
    );
    ...
    expect(service.createEmployeeDocument).toHaveBeenCalledWith(
      "tenant-1",
      "emp-1",
      dto,
    );
  ...
  it("should call getLeaveRequests, createLeaveRequest and approveLeaveRequest", async () => {
    ...
    await controller.approveLeaveRequest(req as never, "req-1", {
      status: "APPROVED",
    });
    expect(service.approveLeaveRequest).toHaveBeenCalledWith(
      "tenant-1",
      "req-1",
      "APPROVED",
      "user-1",
  ...
  it("should call onboarding methods", async () => {
    ...
    expect(service.createOnboardingChecklist).toHaveBeenCalledWith(
      "tenant-1",
      dto,
    );

    await controller.completeOnboardingItem(req as never, "item-1");
    expect(service.completeOnboardingItem).toHaveBeenCalledWith(
      "tenant-1",
      "item-1",
    );

    await controller.updateOnboardingItem(req as never, "item-1", {
      comments: "done",
    });
    expect(service.updateOnboardingItem).toHaveBeenCalledWith(
      "tenant-1",
      "item-1",
      { comments: "done" },
    );
    ...
    expect(service.addOnboardingItem).toHaveBeenCalledWith(
      "tenant-1",
      "chk-1",
      { task: "new" },
    );
    ...
    expect(service.deleteOnboardingItem).toHaveBeenCalledWith(
      "tenant-1",
      "item-1",
    );
  });
  ...
  it("should call offboarding methods", async () => {
    ...
    expect(service.createOffboardingChecklist).toHaveBeenCalledWith(
      "tenant-1",
      dto,
    );

    await controller.updateOffboardingItem(req as never, "item-1", {
      comments: "done",
    });
    expect(service.updateOffboardingItem).toHaveBeenCalledWith(
      "tenant-1",
      "item-1",
      { comments: "done" },
    );
    ...
    expect(service.addOffboardingItem).toHaveBeenCalledWith(
      "tenant-1",
      "chk-1",
      { task: "new" },
    );
    ...
    expect(service.deleteOffboardingItem).toHaveBeenCalledWith(
      "tenant-1",
      "item-1",
    );
  });
  ...
  it("should call recruitment methods", async () => {
    ...
    expect(service.createJobPosting).toHaveBeenCalledWith(
      "tenant-1",
      "org-1",
      jobDto,
    );
    ...
    await controller.advanceApplicant(req as never, "app-1", {
      stage: "INTERVIEW",
    });
    expect(service.advanceApplicant).toHaveBeenCalledWith(
      "tenant-1",
      "app-1",
      "INTERVIEW",
    );
  ...
  it("should call goals methods", async () => {
    ...
    await controller.updateKeyResultProgress(req as never, "kr-1", {
      current: 50,
    });
    expect(service.updateKeyResultProgress).toHaveBeenCalledWith(
      "tenant-1",
      "kr-1",
      50,
    );
    ...
    await controller.createGoalComment(req as never, "goal-1", {
      comment: "efforts",
    });
    expect(service.createGoalComment).toHaveBeenCalledWith(
      "tenant-1",
      "goal-1",
      {
        comment: "efforts",
  ...
  it("should call succession methods", async () => {
    ...
    expect(service.createSuccessionPlan).toHaveBeenCalledWith(
      "tenant-1",
      succDto,
    );
  });
  ...
  it("should call skills methods", async () => {
    ...
    expect(service.createEmployeeSkill).toHaveBeenCalledWith(
      "tenant-1",
      skillDto,
    );
  });
  ...
  it("should call tickets methods", async () => {
    ...
    await controller.resolveHRTicket(req as never, "ticket-1", {
      resolution: "Fixed component",
    });
    expect(service.resolveHRTicket).toHaveBeenCalledWith(
      "tenant-1",
      "ticket-1",
      "Fixed component",
    );
  ...
  it("should call survey methods", async () => {
    ...
    expect(service.createEngagementSurvey).toHaveBeenCalledWith(
      "tenant-1",
      surveyDto,
    );
