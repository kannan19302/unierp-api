...
export class BuilderExpansionController {
  ...
  @Get('form-templates')
  async getFormTemplates(@Req() req: AuthReq, @Query() query: Record<string, string>) {
    const page = parseInt(query.page || '1', 10);
    const limit = parseInt(query.limit || '50', 10);
    return this.svc.getFormTemplates(req.user.tenantId, { page, limit, search: query.search });
  }
  ...
  @Post('form-templates')
  async createFormTemplate(@Req() req: AuthReq, @ZodBody(createFormTemplateSchema) body: CreateFormTemplateInput) {
  ...
  async updateFormTemplate(@Req() req: AuthReq, @Param('id') id: string, @ZodBody(updateFormTemplateSchema) body: UpdateFormTemplateInput) {
  ...
  @Permissions('builder.form-template.update')
  @Post('form-fields')
  async createFormField(@Req() req: AuthReq, @ZodBody(createFormFieldSchema) body: CreateFormFieldInput) {
  ...
  async getFormSubmissions(@Req() req: AuthReq, @Param('templateId') templateId: string, @Query() query: Record<string, string>) {
    const page = parseInt(query.page || '1', 10);
    const limit = parseInt(query.limit || '50', 10);
    return this.svc.getFormSubmissions(req.user.tenantId, templateId, { page, limit });
  }

  @ApiOperation({ summary: 'Submit form' })
  @Permissions('builder.form-submission.create')
  @Post('form-templates/:templateId/submit')
  async submitForm(@Req() req: AuthReq, @Param('templateId') templateId: string, @ZodBody(createFormSubmissionSchema) body: CreateFormSubmissionInput) {
    return this.svc.submitForm(req.user.tenantId, templateId, req.user.userId, body);
  }
  ...
  async getFormAnalytics(@Req() req: AuthReq, @Param('templateId') templateId: string) {
  ...
  @Get('page-templates')
  async getPageTemplates(@Req() req: AuthReq, @Query() query: Record<string, string>) {
    const page = parseInt(query.page || '1', 10);
    const limit = parseInt(query.limit || '50', 10);
    return this.svc.getPageTemplates(req.user.tenantId, { page, limit, search: query.search });
  }
  ...
  @Post('page-templates')
  async createPageTemplate(@Req() req: AuthReq, @ZodBody(createPageTemplateSchema) body: CreatePageTemplateInput) {
  ...
  async updatePageTemplate(@Req() req: AuthReq, @Param('id') id: string, @ZodBody(updatePageTemplateSchema) body: UpdatePageTemplateInput) {
  ...
  async getWorkflowDefinitions(@Req() req: AuthReq, @Query() query: Record<string, string>) {
    const page = parseInt(query.page || '1', 10);
    const limit = parseInt(query.limit || '50', 10);
    return this.svc.getWorkflowDefinitions(req.user.tenantId, { page, limit, search: query.search });
  }
  ...
  async createWorkflowDefinition(@Req() req: AuthReq, @ZodBody(createWorkflowDefinitionSchema) body: CreateWorkflowDefinitionInput) {
  ...
  async updateWorkflowDefinition(@Req() req: AuthReq, @Param('id') id: string, @ZodBody(updateWorkflowDefinitionSchema) body: UpdateWorkflowDefinitionInput) {
  ...
  @Permissions('builder.workflow-definition.update')
  @Post('workflow-steps')
  async createWorkflowStep(@Req() req: AuthReq, @ZodBody(createWorkflowStepSchema) body: CreateWorkflowStepInput) {
