...
export class CrmExpansionController {
  ...
  async getRottingDeals(
    ...
    return this.forecastingService.getRottingDeals(
      req.user.tenantId,
      days ? Number(days) : 14,
    );
  }
  ...
  async getHealthScore(
    ...
    return this.accountService.getCustomerHealthScore(
      req.user.tenantId,
      customerId,
    );
  }
  ...
  async createForecastSnapshot(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createForecastSnapshotSchema) body: CreateForecastSnapshotInput,
  ) {
    const orgId = req.user.orgId || "default-org";
    return this.forecastingService.createForecastSnapshot(
      req.user.tenantId,
      orgId,
      body,
    );
  ...
  async getForecastSnapshots(@Req() req: AuthenticatedRequest) {
    const orgId = req.user.orgId || "default-org";
    return this.forecastingService.getForecastSnapshotsList(
      req.user.tenantId,
      orgId,
    );
  }
  ...
  @Permissions("crm.opportunity.update")
  async freezeForecastSnapshot(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.forecastingService.freezeForecastSnapshot(
      req.user.tenantId,
      id,
    );
  }
  ...
  async adjustForecast(
    ...
    return this.forecastingService.adjustForecast(
      req.user.tenantId,
      id,
      amount,
    );
  ...
  async createQuota(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createQuotaSchema) body: CreateQuotaInput,
  ) {
    const orgId = req.user.orgId || "default-org";
  ...
  async addDealTeamMember(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(addDealTeamMemberSchema) body: AddDealTeamMemberInput,
  ) {
    return this.forecastingService.addDealTeamMember(
      req.user.tenantId,
      id,
      body.userId,
      body.role,
  ...
  async removeDealTeamMember(
    ...
    return this.forecastingService.removeDealTeamMember(
      req.user.tenantId,
      id,
      userId,
    );
  ...
  async createAccountPlan(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createAccountPlanSchema) body: CreateAccountPlanInput,
  ) {
    const orgId = req.user.orgId || "default-org";
    return this.accountService.createAccountPlan(
      req.user.tenantId,
      orgId,
      body,
    );
  ...
  async assignContactRole(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(assignContactRoleSchema) body: AssignContactRoleInput,
  ) {
    return this.accountService.assignContactRole(
      req.user.tenantId,
      id,
      body.contactId,
      body.role,
  ...
  async removeContactRole(
    ...
    return this.accountService.removeContactRole(
      req.user.tenantId,
      id,
      contactId,
    );
  ...
  async logCustomerHealth(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(logCustomerHealthSchema) body: LogCustomerHealthInput,
  ) {
    return this.accountService.logCustomerHealth(
      req.user.tenantId,
      id,
      body.score,
      body.status,
  ...
  async mergeAccounts(
    @Req() req: AuthenticatedRequest,
    @ZodBody(mergeAccountsSchema) body: MergeAccountsInput,
  ) {
    return this.accountService.mergeAccounts(
      req.user.tenantId,
  ...
  async setParentAccount(
    @Req() req: AuthenticatedRequest,
    @Param("customerId") customerId: string,
    @Body("parentCustomerId") parentCustomerId: string | null,
  ) {
    return this.accountService.setParentAccount(
      req.user.tenantId,
      customerId,
  ...
  async getHierarchyRollup(
    ...
    return this.accountService.getHierarchyRollup(
      req.user.tenantId,
      customerId,
    );
  }
