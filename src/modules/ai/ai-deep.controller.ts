...
export class AiDeepController {
  ...
  async classifyIntent(
    @Req() req: AuthReq,
    @ZodBody(classifyIntentSchema) body: ClassifyIntentInput,
  ) {
  ...
  async getIntentTrainingData(
    ...
    return this.svc.getIntentTrainingData(req.user.tenantId, {
      page,
      limit,
      intent: query.intent,
    });
  ...
  async createIntentTrainingData(
    @Req() req: AuthReq,
    @ZodBody(createIntentTrainingDataSchema)
    body: CreateIntentTrainingDataInput,
  ) {
  ...
  async updateIntentTrainingData(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateIntentTrainingDataSchema)
    body: UpdateIntentTrainingDataInput,
  ) {
  ...
  async getNluTrainingData(
    ...
    const page = parseInt(query.page || "1", 10);
    const limit = parseInt(query.limit || "50", 10);
    return this.svc.getNluTrainingData(req.user.tenantId, {
      page,
      limit,
      intent: query.intent,
    });
  ...
  async createNluTrainingData(
    @Req() req: AuthReq,
    @ZodBody(createNluTrainingDataSchema) body: CreateNluTrainingDataInput,
  ) {
  ...
  async updateNluTrainingData(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateNluTrainingDataSchema) body: UpdateNluTrainingDataInput,
  ) {
  ...
  async getModelsWithMetrics(
    ...
    const page = parseInt(query.page || "1", 10);
    const limit = parseInt(query.limit || "50", 10);
    return this.svc.getModelsWithMetrics(req.user.tenantId, {
      page,
      limit,
      search: query.search,
    });
  ...
  @Post("model-accuracy")
  async recordModelAccuracy(
    @Req() req: AuthReq,
    @ZodBody(recordAiModelAccuracySchema) body: RecordAiModelAccuracyInput,
  ) {
  ...
  async getPromptsWithVariables(
    ...
    const page = parseInt(query.page || "1", 10);
    const limit = parseInt(query.limit || "50", 10);
    return this.svc.getPromptsWithVariables(req.user.tenantId, {
      page,
      limit,
      search: query.search,
  ...
  async createPrompt(
    @Req() req: AuthReq,
    @ZodBody(createAiPromptSchema) body: CreateAiPromptInput,
  ) {
  ...
  async updatePrompt(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateAiPromptSchema) body: UpdateAiPromptInput,
  ) {
