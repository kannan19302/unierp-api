...
const createFvSchema = z.object({
  ...
  valuationTechnique: z.string().optional(),
  significantInputs: z.any().optional(),
  performedBy: z.string().optional(),
  notes: z.string().optional(),
});
const createEclSchema = z.object({
  provisionDate: z.string().min(1),
  period: z.string().min(1),
  portfolio: z.string().optional(),
  stage: z.string().min(1),
  grossCarryingAmount: z.number(),
  lossRate: z.number(),
  previousAllowance: z.number().optional(),
  methodology: z.string().min(1),
  probabilityDefault: z.number().optional(),
  lossGivenDefault: z.number().optional(),
  exposureAtDefault: z.number().optional(),
...
export class FinancialInstrumentsController {
  ...
  async getMeasurements(
    ...
    return this.fiService.getFairValueMeasurements(
      req.user.tenantId,
      instrumentType,
    );
  }
  ...
  async createMeasurement(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createFvSchema) dto: any,
  ) {
    return this.fiService.createFairValueMeasurement(
      req.user.tenantId,
  ...
  async updateMeasurement(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createFvSchema.partial()) dto: any,
  ) {
    return this.fiService.updateFairValueMeasurement(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async getMeasurementsByInstrument(
    @Req() req: AuthenticatedRequest,
    @Param("instrumentType") instrumentType: string,
    @Param("instrumentId") instrumentId: string,
  ) {
    return this.fiService.getMeasurementsByInstrument(
      req.user.tenantId,
      instrumentType,
      instrumentId,
    );
  ...
  async getLatestMeasurement(
    ...
    return this.fiService.getLatestMeasurement(
      req.user.tenantId,
      instrumentType,
      instrumentId,
    );
  ...
  async getByLevel(
    ...
    return this.fiService.getFairValueByLevel(
      req.user.tenantId,
      hierarchyLevel,
    );
  }
  ...
  async getHierarchySummary(
    ...
    return this.fiService.getFairValueHierarchySummary(
      req.user.tenantId,
      orgId,
    );
  }
  ...
  async approveMeasurement(
    ...
    return this.fiService.approveMeasurement(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async getECLProvisions(
    @Req() req: AuthenticatedRequest,
    @Query("period") period?: string,
    @Query("stage") stage?: string,
  ) {
    return this.fiService.getExpectedCreditLossProvisions(
      req.user.tenantId,
      period,
      stage,
    );
  ...
  async getECLProvisionById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.fiService.getExpectedCreditLossProvisionById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createECLProvision(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createEclSchema) dto: any,
  ) {
    return this.fiService.createExpectedCreditLossProvision(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto,
    );
  ...
  async updateECLProvision(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createEclSchema.partial()) dto: any,
  ) {
    return this.fiService.updateExpectedCreditLossProvision(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deleteECLProvision(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.fiService.deleteExpectedCreditLossProvision(
      req.user.tenantId,
      id,
    );
  }
  ...
  async reviewECLProvision(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.fiService.reviewExpectedCreditLossProvision(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async approveECLProvision(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.fiService.approveExpectedCreditLossProvision(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async postECLProvision(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.fiService.postExpectedCreditLossProvision(
      req.user.tenantId,
      id,
    );
  }
  ...
  async getDashboard(
    ...
    return this.fiService.getFinancialInstrumentsDashboard(
      req.user.tenantId,
      orgId,
    );
  }
