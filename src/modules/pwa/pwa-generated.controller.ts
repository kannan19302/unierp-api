...
export class PwaGeneratedController {
  ...
  @ApiOperation({ summary: "List pwa-entity-41" }) @Get("pwa-entity-41") @Permissions("pwa.pwaEntity41.read")
  async listPwaEntity41(@Req() req: AuthenticatedRequest) { return this.svc.listPwaEntity41(req.user.tenantId); }

  @ApiOperation({ summary: "Get pwa-entity-41" }) @Get("pwa-entity-41/:id") @Permissions("pwa.pwaEntity41.read")
  async getPwaEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getPwaEntity41(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create pwa-entity-41" }) @Post("pwa-entity-41") @HttpCode(HttpStatus.CREATED) @Permissions("pwa.pwaEntity41.create")
  async createPwaEntity41(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createPwaEntity41(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update pwa-entity-41" }) @Put("pwa-entity-41/:id") @Permissions("pwa.pwaEntity41.update")
  async updatePwaEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updatePwaEntity41(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete pwa-entity-41" }) @Delete("pwa-entity-41/:id") @Permissions("pwa.pwaEntity41.delete")
  async deletePwaEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deletePwaEntity41(req.user.tenantId, id); }

  @ApiOperation({ summary: "List pwa-entity-42" }) @Get("pwa-entity-42") @Permissions("pwa.pwaEntity42.read")
  async listPwaEntity42(@Req() req: AuthenticatedRequest) { return this.svc.listPwaEntity42(req.user.tenantId); }

  @ApiOperation({ summary: "Get pwa-entity-42" }) @Get("pwa-entity-42/:id") @Permissions("pwa.pwaEntity42.read")
  async getPwaEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getPwaEntity42(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create pwa-entity-42" }) @Post("pwa-entity-42") @HttpCode(HttpStatus.CREATED) @Permissions("pwa.pwaEntity42.create")
  async createPwaEntity42(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createPwaEntity42(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update pwa-entity-42" }) @Put("pwa-entity-42/:id") @Permissions("pwa.pwaEntity42.update")
  async updatePwaEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updatePwaEntity42(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete pwa-entity-42" }) @Delete("pwa-entity-42/:id") @Permissions("pwa.pwaEntity42.delete")
  async deletePwaEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deletePwaEntity42(req.user.tenantId, id); }

  @ApiOperation({ summary: "List pwa-entity-43" }) @Get("pwa-entity-43") @Permissions("pwa.pwaEntity43.read")
  async listPwaEntity43(@Req() req: AuthenticatedRequest) { return this.svc.listPwaEntity43(req.user.tenantId); }

  @ApiOperation({ summary: "Get pwa-entity-43" }) @Get("pwa-entity-43/:id") @Permissions("pwa.pwaEntity43.read")
  async getPwaEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getPwaEntity43(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create pwa-entity-43" }) @Post("pwa-entity-43") @HttpCode(HttpStatus.CREATED) @Permissions("pwa.pwaEntity43.create")
  async createPwaEntity43(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createPwaEntity43(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update pwa-entity-43" }) @Put("pwa-entity-43/:id") @Permissions("pwa.pwaEntity43.update")
  async updatePwaEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updatePwaEntity43(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete pwa-entity-43" }) @Delete("pwa-entity-43/:id") @Permissions("pwa.pwaEntity43.delete")
  async deletePwaEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deletePwaEntity43(req.user.tenantId, id); }

  @ApiOperation({ summary: "List pwa-entity-44" }) @Get("pwa-entity-44") @Permissions("pwa.pwaEntity44.read")
  async listPwaEntity44(@Req() req: AuthenticatedRequest) { return this.svc.listPwaEntity44(req.user.tenantId); }

  @ApiOperation({ summary: "Get pwa-entity-44" }) @Get("pwa-entity-44/:id") @Permissions("pwa.pwaEntity44.read")
  async getPwaEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getPwaEntity44(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create pwa-entity-44" }) @Post("pwa-entity-44") @HttpCode(HttpStatus.CREATED) @Permissions("pwa.pwaEntity44.create")
  async createPwaEntity44(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createPwaEntity44(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update pwa-entity-44" }) @Put("pwa-entity-44/:id") @Permissions("pwa.pwaEntity44.update")
  async updatePwaEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updatePwaEntity44(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete pwa-entity-44" }) @Delete("pwa-entity-44/:id") @Permissions("pwa.pwaEntity44.delete")
  async deletePwaEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deletePwaEntity44(req.user.tenantId, id); }

  @ApiOperation({ summary: "List pwa-entity-45" }) @Get("pwa-entity-45") @Permissions("pwa.pwaEntity45.read")
  async listPwaEntity45(@Req() req: AuthenticatedRequest) { return this.svc.listPwaEntity45(req.user.tenantId); }

  @ApiOperation({ summary: "Get pwa-entity-45" }) @Get("pwa-entity-45/:id") @Permissions("pwa.pwaEntity45.read")
  async getPwaEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getPwaEntity45(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create pwa-entity-45" }) @Post("pwa-entity-45") @HttpCode(HttpStatus.CREATED) @Permissions("pwa.pwaEntity45.create")
  async createPwaEntity45(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createPwaEntity45(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update pwa-entity-45" }) @Put("pwa-entity-45/:id") @Permissions("pwa.pwaEntity45.update")
  async updatePwaEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updatePwaEntity45(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete pwa-entity-45" }) @Delete("pwa-entity-45/:id") @Permissions("pwa.pwaEntity45.delete")
  async deletePwaEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deletePwaEntity45(req.user.tenantId, id); }
