...
export class DriveController {
  ...
  @Delete("folders/:id")
  @Permissions("documents.folder.create")
  async trashFolder(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
  ...
  async createDocument(
    ...
    return this.documentsService.createDocument(
      ...
      orgId,
      {
        name: name || (file ? file.originalname : "Unnamed Document"),
        folderId,
        templateId,
      },
      req.user.userId || "system",
  ...
  async downloadVersion(
    ...
    const fileData = await this.documentsService.downloadVersion(
      req.user.tenantId,
      versionId,
    );
  ...
  async permanentlyDeleteDocument(
    ...
    return this.documentsService.permanentlyDeleteDocument(
      req.user.tenantId,
      id,
    );
  }
