...
export const CreateSaasAppSchema = z.object({
  ...
  billingMode: z
    .enum(["ONE_TIME", "MONTHLY", "YEARLY", "FREE"])
    .default("ONE_TIME"),
...
export type CreateSaasAppVersionDto = z.infer<
  typeof CreateSaasAppVersionSchema
>;
...
export type CreateSaasSubscriptionPlanDto = z.infer<
  typeof CreateSaasSubscriptionPlanSchema
>;
...
export type CreateSaasSubscriptionDto = z.infer<
  typeof CreateSaasSubscriptionSchema
>;
...
export type CreateSaasUsageMeterDto = z.infer<
  typeof CreateSaasUsageMeterSchema
>;
...
export const CreateSaasInvoiceSchema = z.object({
  ...
  lineItems: z.array(
    z.object({
      ...
      type: z
        .enum(["SUBSCRIPTION", "ADD_ON", "USAGE", "CREDIT", "TAX", "SHIPPING"])
...
export type CreateSaasFeatureFlagDto = z.infer<
  typeof CreateSaasFeatureFlagSchema
>;
...
export type CreateSaasTenantSettingDto = z.infer<
  typeof CreateSaasTenantSettingSchema
>;
...
export type CreateSaasWebhookEndpointDto = z.infer<
  typeof CreateSaasWebhookEndpointSchema
>;
...
export type CreateSaasSupportTicketDto = z.infer<
  typeof CreateSaasSupportTicketSchema
>;
...
export type CreateSaasSupportTicketMessageDto = z.infer<
  typeof CreateSaasSupportTicketMessageSchema
>;
...
export type CreateSaasAnnouncementDto = z.infer<
  typeof CreateSaasAnnouncementSchema
>;
...
export type CreateSaasMaintenanceWindowDto = z.infer<
  typeof CreateSaasMaintenanceWindowSchema
>;
