...
export const COLLECTION_PRESETS: Record<string, CollectionPreset> = {
  products: {
    ...
    singular: "Product",
    description:
      "E-commerce product catalog with pricing, images and inventory.",
    icon: "🛍️",
    color: "#10b981",
    kind: "PRODUCT",
    ...
    sampleItems: [
      {
        ...
        data: {
          ...
          shortDescription: "Studio-grade sound, 40h battery.",
          inStock: true,
          tags: ["audio", "wireless"],
        },
      },
      {
        ...
        data: {
          ...
          sku: "LWS-220",
          category: "Apparel",
          shortDescription: "Breathable 100% linen.",
          inStock: true,
        },
      },
      {
        ...
        data: {
          ...
          sku: "CPO-330",
          category: "Home",
          shortDescription: "Hand-glazed, single-origin ready.",
          inStock: false,
        },
      },
    ],
  ...
  projects: {
    ...
    singular: "Project",
    description:
      "Portfolio case studies with cover image, gallery and client info.",
    icon: "🎨",
    color: "#8b5cf6",
    kind: "PORTFOLIO",
    settings: {
    ...
    sampleItems: [
      {
        ...
        data: {
          ...
          client: "Nebula Inc.",
          category: "Branding",
          summary: "A bold identity refresh for a fintech leader.",
        },
      },
      {
        slug: "orbit-mobile-app",
        status: "PUBLISHED",
        data: {
          title: "Orbit Mobile App",
          client: "Orbit",
          category: "Mobile",
          summary: "End-to-end product design for a travel app.",
        },
      },
    ],
  },
  team: {
    ...
    sampleItems: [
      ...
      },
      {
        slug: "marcus-lee",
        status: "PUBLISHED",
        data: { name: "Marcus Lee", role: "Head of Design" },
      },
    ],
  },
  testimonials: {
    ...
    sampleItems: [
      {
        ...
        data: {
          ...
          company: "CTO, Vertex",
          quote:
            "This platform transformed how we ship websites. Effortless and powerful.",
          rating: 5,
        },
      },
      {
        ...
        data: {
          author: "David Kim",
          company: "Founder, Loop",
          quote: "The best CMS experience we have used — period.",
          rating: 5,
        },
      },
    ],
    ...
    sampleItems: [
      {
        ...
        data: {
          ...
          excerpt: "The first post on our brand-new site.",
          author: "Editorial",
          category: "News",
        },
      },
    ...
    sampleItems: [
      {
        ...
        data: {
          ...
          summary: "Positioning, messaging and identity systems.",
          startingPrice: 5000,
        },
      },
      {
        ...
        data: {
          ...
          summary: "High-performance sites and web apps.",
          startingPrice: 8000,
        },
      },
    ],
    ...
    sampleItems: [
      {
        slug: "launch-meetup",
        status: "PUBLISHED",
        data: { title: "Product Launch Meetup", location: "San Francisco, CA" },
      },
    ],
  },
};
