...
import {
  ...
  recordSubscriptionUsageSchema,
  sendDunningSchema,
  CreateSubscriptionDto,
  UpdateSubscriptionDto,
  RecordSubscriptionUsageDto,
  SendDunningDto,
...
export class SalesSubscriptionController {
  ...
  async create(
    @Req() req: AuthReq,
    @ZodBody(createSubscriptionSchema) dto: CreateSubscriptionDto,
  ) {
  ...
  async update(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateSubscriptionSchema) dto: UpdateSubscriptionDto,
  ) {
  ...
  async recordUsage(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(recordSubscriptionUsageSchema) dto: RecordSubscriptionUsageDto,
  ) {
  ...
  async dunning(
    @Req() req: AuthReq,
    @ZodBody(sendDunningSchema) dto: SendDunningDto,
  ) {
