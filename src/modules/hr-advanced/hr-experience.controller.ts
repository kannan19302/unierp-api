...
import { createEmployeeRecognitionSchema, createWellnessChallengeSchema, createENPSurveySchema, createPulseSurveySchema, submitSurveyResponseSchema, createAlumniRecordSchema, createAlumniEventSchema } from '../../common/contracts/hr';
