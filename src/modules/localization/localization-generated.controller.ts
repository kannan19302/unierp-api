...
export class LocalizationGeneratedController {
  ...
  @ApiOperation({ summary: "List localization-entity-41" }) @Get("localization-entity-41") @Permissions("localization.localizationEntity41.read")
  async listLocalizationEntity41(@Req() req: AuthenticatedRequest) { return this.svc.listLocalizationEntity41(req.user.tenantId); }

  @ApiOperation({ summary: "Get localization-entity-41" }) @Get("localization-entity-41/:id") @Permissions("localization.localizationEntity41.read")
  async getLocalizationEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getLocalizationEntity41(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create localization-entity-41" }) @Post("localization-entity-41") @HttpCode(HttpStatus.CREATED) @Permissions("localization.localizationEntity41.create")
  async createLocalizationEntity41(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createLocalizationEntity41(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update localization-entity-41" }) @Put("localization-entity-41/:id") @Permissions("localization.localizationEntity41.update")
  async updateLocalizationEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateLocalizationEntity41(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete localization-entity-41" }) @Delete("localization-entity-41/:id") @Permissions("localization.localizationEntity41.delete")
  async deleteLocalizationEntity41(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteLocalizationEntity41(req.user.tenantId, id); }

  @ApiOperation({ summary: "List localization-entity-42" }) @Get("localization-entity-42") @Permissions("localization.localizationEntity42.read")
  async listLocalizationEntity42(@Req() req: AuthenticatedRequest) { return this.svc.listLocalizationEntity42(req.user.tenantId); }

  @ApiOperation({ summary: "Get localization-entity-42" }) @Get("localization-entity-42/:id") @Permissions("localization.localizationEntity42.read")
  async getLocalizationEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getLocalizationEntity42(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create localization-entity-42" }) @Post("localization-entity-42") @HttpCode(HttpStatus.CREATED) @Permissions("localization.localizationEntity42.create")
  async createLocalizationEntity42(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createLocalizationEntity42(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update localization-entity-42" }) @Put("localization-entity-42/:id") @Permissions("localization.localizationEntity42.update")
  async updateLocalizationEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateLocalizationEntity42(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete localization-entity-42" }) @Delete("localization-entity-42/:id") @Permissions("localization.localizationEntity42.delete")
  async deleteLocalizationEntity42(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteLocalizationEntity42(req.user.tenantId, id); }

  @ApiOperation({ summary: "List localization-entity-43" }) @Get("localization-entity-43") @Permissions("localization.localizationEntity43.read")
  async listLocalizationEntity43(@Req() req: AuthenticatedRequest) { return this.svc.listLocalizationEntity43(req.user.tenantId); }

  @ApiOperation({ summary: "Get localization-entity-43" }) @Get("localization-entity-43/:id") @Permissions("localization.localizationEntity43.read")
  async getLocalizationEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getLocalizationEntity43(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create localization-entity-43" }) @Post("localization-entity-43") @HttpCode(HttpStatus.CREATED) @Permissions("localization.localizationEntity43.create")
  async createLocalizationEntity43(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createLocalizationEntity43(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update localization-entity-43" }) @Put("localization-entity-43/:id") @Permissions("localization.localizationEntity43.update")
  async updateLocalizationEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateLocalizationEntity43(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete localization-entity-43" }) @Delete("localization-entity-43/:id") @Permissions("localization.localizationEntity43.delete")
  async deleteLocalizationEntity43(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteLocalizationEntity43(req.user.tenantId, id); }

  @ApiOperation({ summary: "List localization-entity-44" }) @Get("localization-entity-44") @Permissions("localization.localizationEntity44.read")
  async listLocalizationEntity44(@Req() req: AuthenticatedRequest) { return this.svc.listLocalizationEntity44(req.user.tenantId); }

  @ApiOperation({ summary: "Get localization-entity-44" }) @Get("localization-entity-44/:id") @Permissions("localization.localizationEntity44.read")
  async getLocalizationEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getLocalizationEntity44(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create localization-entity-44" }) @Post("localization-entity-44") @HttpCode(HttpStatus.CREATED) @Permissions("localization.localizationEntity44.create")
  async createLocalizationEntity44(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createLocalizationEntity44(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update localization-entity-44" }) @Put("localization-entity-44/:id") @Permissions("localization.localizationEntity44.update")
  async updateLocalizationEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateLocalizationEntity44(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete localization-entity-44" }) @Delete("localization-entity-44/:id") @Permissions("localization.localizationEntity44.delete")
  async deleteLocalizationEntity44(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteLocalizationEntity44(req.user.tenantId, id); }

  @ApiOperation({ summary: "List localization-entity-45" }) @Get("localization-entity-45") @Permissions("localization.localizationEntity45.read")
  async listLocalizationEntity45(@Req() req: AuthenticatedRequest) { return this.svc.listLocalizationEntity45(req.user.tenantId); }

  @ApiOperation({ summary: "Get localization-entity-45" }) @Get("localization-entity-45/:id") @Permissions("localization.localizationEntity45.read")
  async getLocalizationEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.getLocalizationEntity45(req.user.tenantId, id); }

  @ApiOperation({ summary: "Create localization-entity-45" }) @Post("localization-entity-45") @HttpCode(HttpStatus.CREATED) @Permissions("localization.localizationEntity45.create")
  async createLocalizationEntity45(@Req() req: AuthenticatedRequest, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.createLocalizationEntity45(req.user.tenantId, body); }

  @ApiOperation({ summary: "Update localization-entity-45" }) @Put("localization-entity-45/:id") @Permissions("localization.localizationEntity45.update")
  async updateLocalizationEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string, @ZodBody(z.object({ name: z.string() })) body: any) { return this.svc.updateLocalizationEntity45(req.user.tenantId, id, body); }

  @ApiOperation({ summary: "Delete localization-entity-45" }) @Delete("localization-entity-45/:id") @Permissions("localization.localizationEntity45.delete")
  async deleteLocalizationEntity45(@Req() req: AuthenticatedRequest, @Param("id") id: string) { return this.svc.deleteLocalizationEntity45(req.user.tenantId, id); }
