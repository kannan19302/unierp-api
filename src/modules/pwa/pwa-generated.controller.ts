...
export class PwaGeneratedController {
  ...
  @ApiOperation({ summary: "List pwa-entity-22" })
  @Get("pwa-entity-22")
  @Permissions("pwa.pwaEntity22.read")
  async listPwaEntity22(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity22(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-22" })
  @Get("pwa-entity-22/:id")
  @Permissions("pwa.pwaEntity22.read")
  async getPwaEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-22" })
  @Post("pwa-entity-22")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-22" })
  @Put("pwa-entity-22/:id")
  @Permissions("pwa.pwaEntity22.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-22" })
  @Delete("pwa-entity-22/:id")
  @Permissions("pwa.pwaEntity22.delete")
  async deletePwaEntity22(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity22(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-23" })
  @Get("pwa-entity-23")
  @Permissions("pwa.pwaEntity23.read")
  async listPwaEntity23(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity23(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-23" })
  @Get("pwa-entity-23/:id")
  @Permissions("pwa.pwaEntity23.read")
  async getPwaEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-23" })
  @Post("pwa-entity-23")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-23" })
  @Put("pwa-entity-23/:id")
  @Permissions("pwa.pwaEntity23.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-23" })
  @Delete("pwa-entity-23/:id")
  @Permissions("pwa.pwaEntity23.delete")
  async deletePwaEntity23(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity23(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-24" })
  @Get("pwa-entity-24")
  @Permissions("pwa.pwaEntity24.read")
  async listPwaEntity24(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity24(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-24" })
  @Get("pwa-entity-24/:id")
  @Permissions("pwa.pwaEntity24.read")
  async getPwaEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-24" })
  @Post("pwa-entity-24")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-24" })
  @Put("pwa-entity-24/:id")
  @Permissions("pwa.pwaEntity24.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-24" })
  @Delete("pwa-entity-24/:id")
  @Permissions("pwa.pwaEntity24.delete")
  async deletePwaEntity24(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity24(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-25" })
  @Get("pwa-entity-25")
  @Permissions("pwa.pwaEntity25.read")
  async listPwaEntity25(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity25(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-25" })
  @Get("pwa-entity-25/:id")
  @Permissions("pwa.pwaEntity25.read")
  async getPwaEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-25" })
  @Post("pwa-entity-25")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-25" })
  @Put("pwa-entity-25/:id")
  @Permissions("pwa.pwaEntity25.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-25" })
  @Delete("pwa-entity-25/:id")
  @Permissions("pwa.pwaEntity25.delete")
  async deletePwaEntity25(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity25(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-26" })
  @Get("pwa-entity-26")
  @Permissions("pwa.pwaEntity26.read")
  async listPwaEntity26(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity26(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-26" })
  @Get("pwa-entity-26/:id")
  @Permissions("pwa.pwaEntity26.read")
  async getPwaEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-26" })
  @Post("pwa-entity-26")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-26" })
  @Put("pwa-entity-26/:id")
  @Permissions("pwa.pwaEntity26.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-26" })
  @Delete("pwa-entity-26/:id")
  @Permissions("pwa.pwaEntity26.delete")
  async deletePwaEntity26(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity26(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-27" })
  @Get("pwa-entity-27")
  @Permissions("pwa.pwaEntity27.read")
  async listPwaEntity27(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity27(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-27" })
  @Get("pwa-entity-27/:id")
  @Permissions("pwa.pwaEntity27.read")
  async getPwaEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-27" })
  @Post("pwa-entity-27")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-27" })
  @Put("pwa-entity-27/:id")
  @Permissions("pwa.pwaEntity27.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-27" })
  @Delete("pwa-entity-27/:id")
  @Permissions("pwa.pwaEntity27.delete")
  async deletePwaEntity27(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity27(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-28" })
  @Get("pwa-entity-28")
  @Permissions("pwa.pwaEntity28.read")
  async listPwaEntity28(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity28(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-28" })
  @Get("pwa-entity-28/:id")
  @Permissions("pwa.pwaEntity28.read")
  async getPwaEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-28" })
  @Post("pwa-entity-28")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-28" })
  @Put("pwa-entity-28/:id")
  @Permissions("pwa.pwaEntity28.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-28" })
  @Delete("pwa-entity-28/:id")
  @Permissions("pwa.pwaEntity28.delete")
  async deletePwaEntity28(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity28(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-29" })
  @Get("pwa-entity-29")
  @Permissions("pwa.pwaEntity29.read")
  async listPwaEntity29(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity29(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-29" })
  @Get("pwa-entity-29/:id")
  @Permissions("pwa.pwaEntity29.read")
  async getPwaEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-29" })
  @Post("pwa-entity-29")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-29" })
  @Put("pwa-entity-29/:id")
  @Permissions("pwa.pwaEntity29.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-29" })
  @Delete("pwa-entity-29/:id")
  @Permissions("pwa.pwaEntity29.delete")
  async deletePwaEntity29(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity29(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-30" })
  @Get("pwa-entity-30")
  @Permissions("pwa.pwaEntity30.read")
  async listPwaEntity30(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity30(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-30" })
  @Get("pwa-entity-30/:id")
  @Permissions("pwa.pwaEntity30.read")
  async getPwaEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-30" })
  @Post("pwa-entity-30")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-30" })
  @Put("pwa-entity-30/:id")
  @Permissions("pwa.pwaEntity30.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-30" })
  @Delete("pwa-entity-30/:id")
  @Permissions("pwa.pwaEntity30.delete")
  async deletePwaEntity30(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity30(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-31" })
  @Get("pwa-entity-31")
  @Permissions("pwa.pwaEntity31.read")
  async listPwaEntity31(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity31(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-31" })
  @Get("pwa-entity-31/:id")
  @Permissions("pwa.pwaEntity31.read")
  async getPwaEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-31" })
  @Post("pwa-entity-31")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-31" })
  @Put("pwa-entity-31/:id")
  @Permissions("pwa.pwaEntity31.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-31" })
  @Delete("pwa-entity-31/:id")
  @Permissions("pwa.pwaEntity31.delete")
  async deletePwaEntity31(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity31(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-32" })
  @Get("pwa-entity-32")
  @Permissions("pwa.pwaEntity32.read")
  async listPwaEntity32(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity32(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-32" })
  @Get("pwa-entity-32/:id")
  @Permissions("pwa.pwaEntity32.read")
  async getPwaEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-32" })
  @Post("pwa-entity-32")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-32" })
  @Put("pwa-entity-32/:id")
  @Permissions("pwa.pwaEntity32.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-32" })
  @Delete("pwa-entity-32/:id")
  @Permissions("pwa.pwaEntity32.delete")
  async deletePwaEntity32(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity32(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-33" })
  @Get("pwa-entity-33")
  @Permissions("pwa.pwaEntity33.read")
  async listPwaEntity33(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity33(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-33" })
  @Get("pwa-entity-33/:id")
  @Permissions("pwa.pwaEntity33.read")
  async getPwaEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-33" })
  @Post("pwa-entity-33")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-33" })
  @Put("pwa-entity-33/:id")
  @Permissions("pwa.pwaEntity33.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-33" })
  @Delete("pwa-entity-33/:id")
  @Permissions("pwa.pwaEntity33.delete")
  async deletePwaEntity33(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity33(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-34" })
  @Get("pwa-entity-34")
  @Permissions("pwa.pwaEntity34.read")
  async listPwaEntity34(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity34(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-34" })
  @Get("pwa-entity-34/:id")
  @Permissions("pwa.pwaEntity34.read")
  async getPwaEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-34" })
  @Post("pwa-entity-34")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-34" })
  @Put("pwa-entity-34/:id")
  @Permissions("pwa.pwaEntity34.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-34" })
  @Delete("pwa-entity-34/:id")
  @Permissions("pwa.pwaEntity34.delete")
  async deletePwaEntity34(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity34(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-35" })
  @Get("pwa-entity-35")
  @Permissions("pwa.pwaEntity35.read")
  async listPwaEntity35(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity35(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-35" })
  @Get("pwa-entity-35/:id")
  @Permissions("pwa.pwaEntity35.read")
  async getPwaEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-35" })
  @Post("pwa-entity-35")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-35" })
  @Put("pwa-entity-35/:id")
  @Permissions("pwa.pwaEntity35.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-35" })
  @Delete("pwa-entity-35/:id")
  @Permissions("pwa.pwaEntity35.delete")
  async deletePwaEntity35(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity35(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-36" })
  @Get("pwa-entity-36")
  @Permissions("pwa.pwaEntity36.read")
  async listPwaEntity36(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity36(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-36" })
  @Get("pwa-entity-36/:id")
  @Permissions("pwa.pwaEntity36.read")
  async getPwaEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-36" })
  @Post("pwa-entity-36")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-36" })
  @Put("pwa-entity-36/:id")
  @Permissions("pwa.pwaEntity36.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-36" })
  @Delete("pwa-entity-36/:id")
  @Permissions("pwa.pwaEntity36.delete")
  async deletePwaEntity36(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity36(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-37" })
  @Get("pwa-entity-37")
  @Permissions("pwa.pwaEntity37.read")
  async listPwaEntity37(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity37(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-37" })
  @Get("pwa-entity-37/:id")
  @Permissions("pwa.pwaEntity37.read")
  async getPwaEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-37" })
  @Post("pwa-entity-37")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-37" })
  @Put("pwa-entity-37/:id")
  @Permissions("pwa.pwaEntity37.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-37" })
  @Delete("pwa-entity-37/:id")
  @Permissions("pwa.pwaEntity37.delete")
  async deletePwaEntity37(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity37(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-38" })
  @Get("pwa-entity-38")
  @Permissions("pwa.pwaEntity38.read")
  async listPwaEntity38(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity38(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-38" })
  @Get("pwa-entity-38/:id")
  @Permissions("pwa.pwaEntity38.read")
  async getPwaEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-38" })
  @Post("pwa-entity-38")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-38" })
  @Put("pwa-entity-38/:id")
  @Permissions("pwa.pwaEntity38.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-38" })
  @Delete("pwa-entity-38/:id")
  @Permissions("pwa.pwaEntity38.delete")
  async deletePwaEntity38(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity38(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-39" })
  @Get("pwa-entity-39")
  @Permissions("pwa.pwaEntity39.read")
  async listPwaEntity39(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity39(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-39" })
  @Get("pwa-entity-39/:id")
  @Permissions("pwa.pwaEntity39.read")
  async getPwaEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-39" })
  @Post("pwa-entity-39")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-39" })
  @Put("pwa-entity-39/:id")
  @Permissions("pwa.pwaEntity39.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-39" })
  @Delete("pwa-entity-39/:id")
  @Permissions("pwa.pwaEntity39.delete")
  async deletePwaEntity39(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity39(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "List pwa-entity-40" })
  @Get("pwa-entity-40")
  @Permissions("pwa.pwaEntity40.read")
  async listPwaEntity40(@Req() req: AuthenticatedRequest) {
    return this.svc.listPwaEntity40(req.user.tenantId);
  }

  @ApiOperation({ summary: "Get pwa-entity-40" })
  @Get("pwa-entity-40/:id")
  @Permissions("pwa.pwaEntity40.read")
  async getPwaEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.getPwaEntity40(req.user.tenantId, id);
  }

  @ApiOperation({ summary: "Create pwa-entity-40" })
  @Post("pwa-entity-40")
  @HttpCode(HttpStatus.CREATED)
  ...
  @ApiOperation({ summary: "Update pwa-entity-40" })
  @Put("pwa-entity-40/:id")
  @Permissions("pwa.pwaEntity40.update")
  ...
  @ApiOperation({ summary: "Delete pwa-entity-40" })
  @Delete("pwa-entity-40/:id")
  @Permissions("pwa.pwaEntity40.delete")
  async deletePwaEntity40(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.svc.deletePwaEntity40(req.user.tenantId, id);
  }
}
