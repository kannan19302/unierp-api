...
export type UpsertStorefrontConfigDto = z.infer<
  typeof upsertStorefrontConfigSchema
>;
...
export type CreateStorefrontCategoryDto = z.infer<
  typeof createStorefrontCategorySchema
>;

export const updateStorefrontCategorySchema =
  createStorefrontCategorySchema.partial();
export type UpdateStorefrontCategoryDto = z.infer<
  typeof updateStorefrontCategorySchema
>;
...
export type CreateProductListingDto = z.infer<
  typeof createProductListingSchema
>;
...
export type UpdateProductListingDto = z.infer<
  typeof updateProductListingSchema
>;
...
export const updateCartItemSchema = z.object({
  quantity: z
    .number()
    .int()
    .positive("Quantity must be at least 1 — use DELETE to remove the item"),
});
...
export const checkoutAddressSchema = z.object({
  ...
  country: z
    .string()
    .min(2, "Country must be an ISO 3166-1 alpha-2 code")
    .max(2),
});
