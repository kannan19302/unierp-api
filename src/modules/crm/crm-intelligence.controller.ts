...
export class CrmIntelligenceController {
  ...
  async getMlModels(@Req() req: AuthenticatedRequest) {
    return {
      data: await this.intelligenceService.getMlModels(req.user.tenantId),
    };
  }
  ...
  async trainLeadScoringModel(@Req() req: AuthenticatedRequest) {
    return {
      data: await this.intelligenceService.trainLeadScoringModel(
        req.user.tenantId,
        req.user.userId,
      ),
    };
  ...
  async getLeadScoringFactors(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return {
      data: await this.intelligenceService.getLeadScoringFactors(
        req.user.tenantId,
        id,
      ),
    };
  ...
  async getJourneyTimeline(
    ...
    return {
      data: await this.intelligenceService.getJourneyTimeline(
        req.user.tenantId,
        entityType,
        entityId,
      ),
  ...
  async calculateAttribution(
    ...
    return {
      data: await this.intelligenceService.calculateAttribution(
        req.user.tenantId,
        id,
        model,
      ),
  ...
  async analyzeSentiment(
    ...
    return {
      data: await this.intelligenceService.analyzeSentiment(
        req.user.tenantId,
        entityType,
        entityId,
      ),
  ...
  async getDealHealth(
    ...
    return {
      data: await this.intelligenceService.getDealHealth(req.user.tenantId, id),
    };
  }
  ...
  async getCustomerHealth(
    ...
    return {
      data: await this.intelligenceService.getCustomerHealth(
        req.user.tenantId,
        id,
      ),
    };
  ...
  async getAtRiskCustomers(
    ...
    return {
      data: await this.intelligenceService.getAtRiskCustomers(
        req.user.tenantId,
  ...
  async getDealVelocityAnalysis(@Req() req: AuthenticatedRequest) {
    return {
      data: await this.intelligenceService.getDealVelocityAnalysis(
        req.user.tenantId,
      ),
    };
  }
  ...
  async getCustomerLifetimeValue(
    ...
    return {
      data: await this.intelligenceService.getCustomerLifetimeValue(
        req.user.tenantId,
        id,
      ),
    };
  ...
  async enrichSocialProfile(
    ...
    return {
      data: await this.intelligenceService.enrichSocialProfile(
        req.user.tenantId,
        entityType,
        entityId,
      ),
  ...
  async getIntentSignals(
    ...
    return {
      data: await this.intelligenceService.getIntentSignals(
        req.user.tenantId,
        id,
      ),
    };
  ...
  async getPartnerPerformance(
    ...
    return {
      data: await this.intelligenceService.getPartnerPerformance(
        req.user.tenantId,
        partnerId,
      ),
    };
  ...
  async registerPartnerLead(
    ...
    return {
      data: await this.intelligenceService.registerPartnerLead(
        req.user.tenantId,
  ...
  @Get("partners/:id/mdf")
  @Permissions("crm.contact.read")
  async getPartnerMdfSummary(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return {
      data: await this.intelligenceService.getPartnerMdfSummary(
        req.user.tenantId,
        id,
      ),
    };
  ...
  @Permissions("crm.report.read")
  async getEmailCampaignAnalytics(
    @Req() req: AuthenticatedRequest,
    @Query("campaignId") campaignId?: string,
  ) {
    return {
      data: await this.intelligenceService.getEmailCampaignAnalytics(
        req.user.tenantId,
        campaignId,
      ),
    };
  ...
  @Permissions("crm.report.read")
  async getEmailAbTestResults(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return {
      data: await this.intelligenceService.getEmailAbTestResults(
        req.user.tenantId,
        id,
      ),
    };
