...
describe("AdvancedFinanceController", () => {
  ...
  it("should call getProfitAndLoss", async () => {
    ...
    expect(reportingService.getProfitAndLoss).toHaveBeenCalledWith(
      "tenant-1",
      "org-1",
      "start",
      "end",
  ...
  it("should call getBalanceSheet", async () => {
    ...
    expect(reportingService.getBalanceSheet).toHaveBeenCalledWith(
      "tenant-1",
      "org-1",
      "date",
      undefined,
  ...
  it("should call getCashFlow", async () => {
    ...
    expect(reportingService.getCashFlowStatement).toHaveBeenCalledWith(
      "tenant-1",
      "org-1",
      "start",
      "end",
  ...
  it("should call getCashFlowProjections via cashFlowForecastService.get13WeekForecast", async () => {
    ...
    expect(cashFlowForecastService.get13WeekForecast).toHaveBeenCalledWith(
      "tenant-1",
      "scen-1",
    );
  });
  ...
  it("should call getCashFlowScenarios via cashFlowForecastService.getScenarios", async () => {
    ...
    expect(cashFlowForecastService.getScenarios).toHaveBeenCalledWith(
      "tenant-1",
    );
  });
  ...
  it("should call getIntercompanyStats via interCompanyService.getConsolidatedStats", async () => {
    ...
    expect(interCompanyService.getConsolidatedStats).toHaveBeenCalledWith(
      "tenant-1",
    );
  });
  ...
  it("should call createFxRevaluationRun via fxRevaluationService.createRevaluationRun", async () => {
    ...
    expect(fxRevaluationService.createRevaluationRun).toHaveBeenCalledWith(
      "tenant-1",
      "org-1",
      dto,
    );
  ...
  it("should call postFxRevaluationRun via fxRevaluationService.postRevaluationRun", async () => {
    ...
    expect(fxRevaluationService.postRevaluationRun).toHaveBeenCalledWith(
      "tenant-1",
      "run-1",
    );
  });
  ...
  it("should call getFxRevaluationRunDetails via fxRevaluationService.getRevaluationRunDetails", async () => {
    ...
    expect(fxRevaluationService.getRevaluationRunDetails).toHaveBeenCalledWith(
      "tenant-1",
      "run-1",
    );
  });
  ...
  it("should call getFxRevaluationRuns via fxRevaluationService.getRevaluationRuns", async () => {
    ...
    expect(fxRevaluationService.getRevaluationRuns).toHaveBeenCalledWith(
      "tenant-1",
    );
  });

  it("should call getIntercompanyTransactions via interCompanyService.getTransactions", async () => {
    await controller.getIntercompanyTransactions(
      mockReq,
      "PENDING",
      "org-1",
      "org-2",
    ...
    expect(interCompanyService.getTransactions).toHaveBeenCalledWith(
      "tenant-1",
      {
        status: "PENDING",
        fromOrgId: "org-1",
  ...
  it("should call autoMatchIntercompanyTransactions via interCompanyService.autoMatchTransactions", async () => {
    ...
    expect(interCompanyService.autoMatchTransactions).toHaveBeenCalledWith(
      "tenant-1",
    );
  });
  ...
  it("should call manualMatchIntercompanyTransactions via interCompanyService.manualMatchTransactions", async () => {
    ...
    expect(interCompanyService.manualMatchTransactions).toHaveBeenCalledWith(
      "tenant-1",
      dto,
    );
  });
  ...
  it("should call eliminateIntercompanyTransaction via interCompanyService.eliminateTransaction", async () => {
    ...
    expect(interCompanyService.eliminateTransaction).toHaveBeenCalledWith(
      "tenant-1",
      "tx-1",
    );
  });
  ...
  it("should call createBankConnection via bankFeedsService.createConnection", async () => {
    ...
    expect(bankFeedsService.createConnection).toHaveBeenCalledWith(
      "tenant-1",
      "org-1",
      dto,
    );
  ...
  it("should call saveForecastWeekOverride via cashFlowForecastService.saveForecastWeekOverride", async () => {
    const dto = {
      weekStart: "2026-07-08T00:00:00Z",
      adjustments: 1000,
      comments: "test",
    };
    await controller.saveForecastWeekOverride(mockReq, dto);
    expect(
      cashFlowForecastService.saveForecastWeekOverride,
    ).toHaveBeenCalledWith("tenant-1", expect.any(Date), dto);
  });
  ...
  it("should call createCashFlowScenario via cashFlowForecastService.createScenario", async () => {
    ...
    expect(cashFlowForecastService.createScenario).toHaveBeenCalledWith(
      "tenant-1",
      "org-1",
      dto,
    );
  ...
  it("should call updateCashFlowScenario via cashFlowForecastService.updateScenario", async () => {
    ...
    expect(cashFlowForecastService.updateScenario).toHaveBeenCalledWith(
      "tenant-1",
      "scen-1",
      dto,
    );
  ...
  it("should call deleteCashFlowScenario via cashFlowForecastService.deleteScenario", async () => {
    ...
    expect(cashFlowForecastService.deleteScenario).toHaveBeenCalledWith(
      "tenant-1",
      "scen-1",
    );
  });
  ...
  it("should call compareForecastScenarios via cashFlowForecastService.compareForecastScenarios", async () => {
    ...
    expect(
      cashFlowForecastService.compareForecastScenarios,
    ).toHaveBeenCalledWith("tenant-1", "scen-1");
  });
  ...
  const postEndpoints = [
    {
      ...
      args: [mockReq, {}],
      expectedArgs: ["tenant-1", "org-1", {}],
      serviceName: "glService",
    },
    {
    ...
    },
    {
      ...
      args: [mockReq, {}],
      expectedArgs: ["tenant-1", {}],
      serviceName: "paymentTermsService",
    },
  ];
