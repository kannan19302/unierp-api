...
export class CrmConversionAnalyticsController {
  ...
  @ApiOperation({
    summary:
      "Overall lead-to-opportunity-to-won funnel summary, with average cycle time",
  })
  ...
  @ApiOperation({
    summary: "Funnel conversion rates broken down by lead source",
  })
  @ApiQuery({ name: "dateFrom", required: false })
  @ApiQuery({ name: "dateTo", required: false })
  @Get("by-source")
  ...
  @ApiOperation({
    summary: "Funnel conversion-rate leaderboard broken down by assigned rep",
  })
  @ApiQuery({ name: "dateFrom", required: false })
  @ApiQuery({ name: "dateTo", required: false })
  @Get("by-rep")
  ...
  @ApiOperation({
    summary:
      "Trailing weekly time-series of leads created vs. converted vs. opportunities won",
  })
  @ApiQuery({
    name: "weeks",
    required: false,
    description: "Number of trailing weeks (default 12)",
  })
  @Get("trend")
  @Permissions("crm.lead.read")
  async getTrend(
    ...
    return this.svc.getConversionTrend(
      req.user.tenantId,
