...
} from "../services/inventory-logistics.service";
...
export class InventoryLogisticsController {
  ...
  createCarrier(
    @Req() req: AuthReq,
    @ZodBody(createCarrierSchema) dto: typeof createCarrierSchema._type,
  ) {
  ...
  updateCarrier(
    ...
    return this.svc.updateCarrier(
      req.user.tenantId,
      id,
      body as Parameters<InventoryLogisticsService["updateCarrier"]>[2],
    );
  }
  ...
  addServiceLevel(
    @Req() req: AuthReq,
    @ZodBody(createServiceLevelSchema)
    dto: typeof createServiceLevelSchema._type,
  ) {
  ...
  listAsns(
    ...
    return this.svc.listAsns(req.user.tenantId, {
      vendorId,
      warehouseId,
      status,
    });
  ...
  createAsn(
    @Req() req: AuthReq,
    @ZodBody(createAsnSchema) dto: typeof createAsnSchema._type,
  ) {
  ...
  receiveAsn(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(receiveAsnSchema) dto: typeof receiveAsnSchema._type,
  ) {
  ...
  createInbound(
    @Req() req: AuthReq,
    @ZodBody(createInboundShipmentSchema)
    dto: typeof createInboundShipmentSchema._type,
  ) {
  ...
  updateInboundStatus(
    ...
    return this.svc.updateInboundShipmentStatus(req.user.tenantId, id, status, {
      arrivedAt,
      completedAt,
    });
  }
  ...
  addInboundTracking(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(addTrackingEventSchema) dto: typeof addTrackingEventSchema._type,
  ) {
  ...
  listOutbound(
    ...
    return this.svc.listOutboundShipments(req.user.tenantId, {
      salesOrderId,
      warehouseId,
      status,
    });
  ...
  createOutbound(
    @Req() req: AuthReq,
    @ZodBody(createOutboundShipmentSchema)
    dto: typeof createOutboundShipmentSchema._type,
  ) {
  ...
  recordDelivery(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @Body("proofOfDelivery") pod?: string,
