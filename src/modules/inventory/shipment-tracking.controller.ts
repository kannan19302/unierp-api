...
export class ShipmentTrackingController {
  ...
  listInbound(
    ...
    return this.svc.listInboundShipments(
      req.user.tenantId,
      status,
      warehouseId,
    );
  ...
  updateOutboundStatus(
    ...
    return this.svc.updateOutboundStatus(
      req.user.tenantId,
      id,
      status,
      proofOfDelivery,
  ...
  listOutbound(
    ...
    return this.svc.listOutboundShipments(
      req.user.tenantId,
      status,
      warehouseId,
    );
  ...
  getTrackingHistory(
    ...
    return this.svc.getTrackingHistory(
      req.user.tenantId,
      direction,
      shipmentId,
    );
  ...
  updateExceptionStatus(
    ...
    return this.svc.updateExceptionStatus(
      req.user.tenantId,
      id,
      req.user.userId,
      status,
