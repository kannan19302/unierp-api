...
export class EcommerceAdminController {
  ...
  @ApiOperation({
    summary: "Create or update this tenant's storefront configuration (upsert)",
  })
  async upsertConfig(
    @Req() req: AuthenticatedRequest,
    @ZodBody(upsertStorefrontConfigSchema) dto: UpsertStorefrontConfigDto,
  ) {
  ...
  async createCategory(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createStorefrontCategorySchema) dto: CreateStorefrontCategoryDto,
  ) {
  ...
  @ApiOperation({
    summary:
      "List storefront product listings (joined with Product + Category)",
  })
  ...
  @ApiOperation({
    summary: "Publish an existing Inventory Product to the storefront",
  })
  async createListing(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createProductListingSchema) dto: CreateProductListingDto,
  ) {
  ...
  @ApiOperation({
    summary:
      "Update a storefront listing (publish toggle, price override, category, sort)",
  })
  async updateListing(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
