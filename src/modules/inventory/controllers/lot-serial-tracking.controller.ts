...
} from "../services/lot-serial-tracking.service";
...
export class LotSerialTrackingController {
  ...
  listBatches(
    ...
    return this.svc.listBatches(req.user.tenantId, {
      productId,
      status,
      warehouseId,
      expiringBefore,
  ...
  createBatch(
    @Req() req: AuthReq,
    @ZodBody(createBatchSchema) body: z.infer<typeof createBatchSchema>,
  ) {
  ...
  recordLotMovement(
    @Req() req: AuthReq,
    @ZodBody(recordLotMovementSchema)
    body: z.infer<typeof recordLotMovementSchema>,
  ) {
  ...
  createSerial(
    @Req() req: AuthReq,
    @ZodBody(createSerialSchema) body: z.infer<typeof createSerialSchema>,
  ) {
  ...
  markSerialSold(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(soldSchema) body: z.infer<typeof soldSchema>,
  ) {
  ...
  markSerialReturned(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(scrapNotesSchema) body: z.infer<typeof scrapNotesSchema>,
  ) {
  ...
  generatePickSuggestions(
    @Req() req: AuthReq,
    @ZodBody(generatePickSuggestionsSchema)
    body: z.infer<typeof generatePickSuggestionsSchema>,
  ) {
  ...
  listPickSuggestions(
    ...
    return this.svc.listPickSuggestions(req.user.tenantId, {
      referenceId,
      status,
    });
  }
  ...
  confirmPickSuggestion(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(confirmPickSchema) body: z.infer<typeof confirmPickSchema>,
  ) {
  ...
  generateExpiryAlerts(
    @Req() req: AuthReq,
    @ZodBody(generateExpiryAlertsSchema)
    body: z.infer<typeof generateExpiryAlertsSchema>,
  ) {
    ...
    const ack =
      acknowledged === "true"
        ...
        : acknowledged === "false"
          ? false
          : undefined;
    return this.svc.listExpiryAlerts(req.user.tenantId, {
      severity,
      acknowledged: ack,
    });
  }
  ...
  acknowledgeExpiryAlert(@Req() req: AuthReq, @Param("id") id: string) {
    return this.svc.acknowledgeExpiryAlert(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  createQuarantineOrder(
    @Req() req: AuthReq,
    @ZodBody(quarantineOrderSchema) body: z.infer<typeof quarantineOrderSchema>,
  ) {
    return this.svc.createQuarantineOrder(
      req.user.tenantId,
      req.user.userId,
      body,
    );
  ...
  releaseQuarantineOrder(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(releaseQuarantineSchema)
    body: z.infer<typeof releaseQuarantineSchema>,
  ) {
    return this.svc.releaseQuarantineOrder(
      req.user.tenantId,
      id,
      req.user.userId,
      body,
