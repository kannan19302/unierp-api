...
export class SaasPortalSecurityController {
  ...
  async savePasswordPolicy(
    @Req() req: AuthenticatedRequest,
    @ZodBody(passwordPolicySchema) body: z.infer<typeof passwordPolicySchema>,
  ) {
    const result = await this.securityService.savePasswordPolicy(
      req.user.tenantId,
      body,
    );
    await this.auditLogService.logAction(
      ...
      "PasswordPolicy",
      req.user.tenantId,
      { updatedBy: req.user.userId, ...body },
      req.ip,
    );
    return result;
  }
  ...
  async saveSsoConfig(
    @Req() req: AuthenticatedRequest,
    @ZodBody(ssoConfigSchema) body: z.infer<typeof ssoConfigSchema>,
  ) {
    const result = await this.securityService.saveSsoConfig(
      req.user.tenantId,
      body,
    );
    await this.auditLogService.logAction(
  ...
  async saveMfaSettings(
    @Req() req: AuthenticatedRequest,
    @ZodBody(mfaSettingsSchema) body: z.infer<typeof mfaSettingsSchema>,
  ) {
    const result = await this.securityService.saveMfaSettings(
      req.user.tenantId,
      body,
    );
    await this.auditLogService.logAction(
  ...
  async createIpRestriction(
    @Req() req: AuthenticatedRequest,
    @ZodBody(ipRestrictionSchema) body: z.infer<typeof ipRestrictionSchema>,
  ) {
    const result = await this.securityService.createIpRestriction(
      req.user.tenantId,
      body,
    );
    await this.auditLogService.logAction(
      ...
      "IpRestriction",
      result.id,
      { createdBy: req.user.userId, ...body },
      req.ip,
    );
    return result;
  }
  ...
  async deleteIpRestriction(
    ...
    const result = await this.securityService.deleteIpRestriction(
      req.user.tenantId,
      id,
    );
    await this.auditLogService.logAction(
  ...
  async impersonateUser(
    ...
    const result = await this.securityService.impersonateUser(
      req.user.tenantId,
      targetUserId,
    );
    await this.auditLogService.logAction(
  ...
  async saveDataRetentionPolicy(
    @Req() req: AuthenticatedRequest,
    @ZodBody(dataRetentionPolicySchema)
    body: z.infer<typeof dataRetentionPolicySchema>,
  ) {
    const result = await this.securityService.saveDataRetentionPolicy(
      req.user.tenantId,
      body,
    );
    await this.auditLogService.logAction(
  ...
  async deleteDataRetentionPolicy(
    ...
    const result = await this.securityService.deleteDataRetentionPolicy(
      req.user.tenantId,
      id,
    );
    await this.auditLogService.logAction(
  ...
  async generateComplianceReport(@Req() req: AuthenticatedRequest) {
    return this.securityService.generateComplianceReport(
      req.user.tenantId,
      req.user.userId,
    );
  }
  ...
  async revokeApiKey(
    ...
    const result = await this.securityService.revokeApiKey(
      req.user.tenantId,
      id,
    );
    await this.auditLogService.logAction(
