...
export class PosEnterpriseController {
  ...
  async getEmployeePerformance(
    ...
    return this.service.getEmployeePerformance(
      req.user.tenantId,
      employeeId,
      period,
    );
  ...
  async getMenuPerformance(
    ...
    return this.service.getMenuPerformance(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  async getPeakHourAnalysis(
    ...
    return this.service.getPeakHourAnalysis(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  async getPaymentAnalytics(
    ...
    return this.service.getPaymentAnalytics(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
