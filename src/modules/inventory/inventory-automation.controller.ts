...
export class InventoryAutomationController {
  ...
  createRule(
    @Req() req: AuthReq,
    @ZodBody(createReplenishmentRuleSchema) dto: any,
  ) {
  ...
  updateRule(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(createReplenishmentRuleSchema.partial()) dto: any,
  ) {
  ...
  evaluateRules(
    ...
    return this.service.evaluateReplenishmentRules(
      req.user.tenantId,
      warehouseId,
    );
  }
  ...
  listHolds(
    ...
    return this.service.listHolds(req.user.tenantId, {
      productId,
      warehouseId,
      status,
    });
  ...
  releaseHold(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(releaseHoldSchema) dto: any,
  ) {
