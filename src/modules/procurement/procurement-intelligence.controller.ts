...
export class ProcurementIntelligenceController {
  ...
  async computeScorecard(
    ...
    return this.supplierScorecardService.computeAndSave(
      req.user.tenantId,
      dto.vendorId,
      dto.periodStart,
      dto.periodEnd,
  ...
  async getScorecardTrend(
    ...
    return this.supplierScorecardService.getVendorTrend(
      req.user.tenantId,
      vendorId,
      lastN ? parseInt(lastN, 10) : 6,
    );
  }

  @Get("scorecards/by-vendor/:vendorId")
  @Permissions("procurement.purchase-order.read")
  async listScorecardsByVendor(
    @Req() req: AuthRequest,
    @Param("vendorId") vendorId: string,
    @Query() q: any,
  ) {
    return this.supplierScorecardService.getScorecardsByVendor(
      req.user.tenantId,
      vendorId,
      q,
    );
  ...
  async listScorecardsByDateRange(@Req() req: AuthRequest, @Query() q: any) {
    return this.supplierScorecardService.getScorecardsByDateRange(
      req.user.tenantId,
      q.startDate,
      q.endDate,
      q,
  ...
  async compareVendors(
    @Req() req: AuthRequest,
    @Body() dto: { vendorIds: string[] },
  ) {
    return this.supplierScorecardService.compareVendors(
      req.user.tenantId,
      dto.vendorIds,
    );
  }
  ...
  async placeBid(
    @Req() req: AuthRequest,
    @Param("id") id: string,
    @Body() dto: { vendorId: string; bidAmount: number; notes?: string },
  ) {
    return this.rfqAuctionsService.placeBid(
      req.user.tenantId,
      id,
      dto.vendorId,
      dto.bidAmount,
  ...
  async selectWinningBid(
    ...
    return this.rfqAuctionsService.selectWinningBid(
      req.user.tenantId,
      id,
      bidId,
    );
  ...
  async updateAuctionStatus(
    ...
    return this.rfqAuctionsService.updateAuctionStatus(
      req.user.tenantId,
      id,
      dto.status,
    );
  ...
  async extendAuction(
    @Req() req: AuthRequest,
    @Param("id") id: string,
    @Body() dto: { newEndDate: string },
  ) {
    return this.rfqAuctionsService.extendAuction(
      req.user.tenantId,
      id,
      dto.newEndDate,
    );
  ...
  async cancelAuction(
    ...
    return this.rfqAuctionsService.cancelAuction(
      req.user.tenantId,
      id,
      dto.reason,
    );
  ...
  @Permissions("procurement.purchase-order.read")
  async listAuctionsByVendor(
    @Req() req: AuthRequest,
    @Param("vendorId") vendorId: string,
    @Query() q: any,
  ) {
    return this.rfqAuctionsService.getAuctionsByVendor(
      req.user.tenantId,
      vendorId,
      q,
    );
  ...
  async spendByVendor(
    ...
    return this.procurementAnalyticsService.getSpendByVendor(
      req.user.tenantId,
      q.startDate,
      q.endDate,
    );
  ...
  async monthlyTrend(
    ...
    return this.procurementAnalyticsService.getMonthlySpendTrend(
      req.user.tenantId,
  ...
  async spendByCategory(@Req() req: AuthRequest) {
    return this.procurementAnalyticsService.getSpendByCategory(
      req.user.tenantId,
    );
  }
  ...
  async budgetOverview(@Req() req: AuthRequest) {
    return this.procurementAnalyticsService.getBudgetOverview(
      req.user.tenantId,
    );
  }
  ...
  async vendorPerformance(@Req() req: AuthRequest) {
    return this.procurementAnalyticsService.getVendorPerformanceSummary(
      req.user.tenantId,
    );
  }
  ...
  async spendForecast(
    ...
    return this.procurementAnalyticsService.getSpendForecast(
      req.user.tenantId,
  ...
  @Permissions("procurement.purchase-order.read")
  async vendorComparison(
    @Req() req: AuthRequest,
    @Query("vendorIds") vendorIds?: string,
  ) {
    const ids = vendorIds ? vendorIds.split(",") : undefined;
    return this.procurementAnalyticsService.getVendorComparison(
      req.user.tenantId,
      ids,
    );
  }
  ...
  async categoryBreakdown(
    ...
    return this.procurementAnalyticsService.getCategoryBreakdown(
      req.user.tenantId,
      q.startDate,
      q.endDate,
    );
  ...
  async poCycleTime(
    ...
    return this.procurementAnalyticsService.getPurchaseOrderCycleTime(
      req.user.tenantId,
      vendorId,
    );
  }
  ...
  async savingsOpportunities(@Req() req: AuthRequest) {
    return this.procurementAnalyticsService.getSavingsOpportunities(
      req.user.tenantId,
    );
  }
