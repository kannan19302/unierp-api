...
import {
  ...
  createSopSchema,
} from "../services/quality-compliance.service";
...
export class QualityComplianceController {
  ...
  updateCapa(
    ...
    return this.svc.updateCapa(
      req.user.tenantId,
      id,
      body as Parameters<QualityComplianceService["updateCapa"]>[2],
    );
  }
  ...
  addCapaAction(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(addCapaActionSchema) dto: typeof addCapaActionSchema._type,
  ) {
  ...
  listCalibrations(
    ...
    return this.svc.listCalibrations(req.user.tenantId, {
      status,
      instrumentId,
    });
  }
  ...
  scheduleCalibration(
    @Req() req: AuthReq,
    @ZodBody(createCalibrationSchema) dto: typeof createCalibrationSchema._type,
  ) {
  ...
  recordCalibrationResult(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(recordCalibrationResultSchema)
    dto: typeof recordCalibrationResultSchema._type,
  ) {
  ...
  listDeviations(
    ...
    return this.svc.listDeviations(req.user.tenantId, {
      status,
      severity,
      type,
    });
  ...
  createDeviation(
    @Req() req: AuthReq,
    @ZodBody(createDeviationSchema) dto: typeof createDeviationSchema._type,
  ) {
  ...
  listSops(
    ...
    return this.svc.listSops(req.user.tenantId, {
      status,
      category,
      department,
    });
  ...
  getSopsDueSoon(@Req() req: AuthReq, @Query("days") days?: string) {
    return this.svc.getSopsDueSoon(
      req.user.tenantId,
  ...
  createSop(
    @Req() req: AuthReq,
    @ZodBody(createSopSchema) dto: typeof createSopSchema._type,
  ) {
