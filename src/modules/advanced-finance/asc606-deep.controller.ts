...
const createPerformanceObligationSchema = z.object({
  ...
  ssp: z.number().positive().optional(),
  obligationType: z.string().min(1),
  satisfactionTiming: z.string().min(1),
  satisfactionMethod: z.string().optional(),
...
const updateObligationSchema = z.object({
  ...
  ssp: z.number().positive().optional(),
  satisfactionTiming: z.string().optional(),
  satisfactionMethod: z.string().optional(),
  endDate: z.string().optional(),
});
const createContractModSchema = z.object({
  contractRef: z.string().min(1),
  modNumber: z.string().min(1),
  modificationDate: z.string().min(1),
  modType: z.string().min(1),
  originalConsideration: z.number(),
  modifiedConsideration: z.number(),
  accountingMethod: z.string().min(1),
...
export class Asc606DeepController {
  ...
  async getPerformanceObligations(
    @Req() req: AuthenticatedRequest,
    @Query("status") status?: string,
  ) {
    return this.asc606Service.getPerformanceObligations(
      req.user.tenantId,
      status,
    );
  }
  ...
  async getPerformanceObligationById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.asc606Service.getPerformanceObligationById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createPerformanceObligation(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createPerformanceObligationSchema) dto: any,
  ) {
    return this.asc606Service.createPerformanceObligation(
      req.user.tenantId,
  ...
  async updatePerformanceObligation(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateObligationSchema) dto: any,
  ) {
    return this.asc606Service.updatePerformanceObligation(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deletePerformanceObligation(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.asc606Service.deletePerformanceObligation(
      req.user.tenantId,
      id,
    );
  }
  ...
  async satisfyObligation(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ satisfiedDate: z.string().optional() })) dto: any,
  ) {
    return this.asc606Service.satisfyPerformanceObligation(
      req.user.tenantId,
      id,
      dto.satisfiedDate,
    );
  ...
  async partialSatisfy(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ recognizedAmount: z.number().positive() })) dto: any,
  ) {
    return this.asc606Service.partiallySatisfyPerformanceObligation(
      req.user.tenantId,
      id,
      dto.recognizedAmount,
    );
  }
  ...
  async allocatePrice(
    @Req() req: AuthenticatedRequest,
    @ZodBody(allocatePriceSchema) dto: any,
  ) {
    return this.asc606Service.allocateTransactionPrice(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto.contractRef,
    );
  ...
  async getObligationsByContract(
    @Req() req: AuthenticatedRequest,
    @Param("contractRef") contractRef: string,
  ) {
    return this.asc606Service.getObligationsByContract(
      req.user.tenantId,
      contractRef,
    );
  }
  ...
  async getObligationHierarchy(
    @Req() req: AuthenticatedRequest,
    @Param("parentId") parentId: string,
  ) {
    return this.asc606Service.getObligationHierarchy(
      req.user.tenantId,
      parentId,
    );
  }
  ...
  async getContractModifications(
    @Req() req: AuthenticatedRequest,
    @Query("contractRef") contractRef?: string,
  ) {
    return this.asc606Service.getContractModifications(
      req.user.tenantId,
      contractRef,
    );
  }
  ...
  async getContractModificationById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.asc606Service.getContractModificationById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createContractModification(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createContractModSchema) dto: any,
  ) {
    return this.asc606Service.createContractModification(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto,
    );
  ...
  async updateContractModification(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createContractModSchema.partial()) dto: any,
  ) {
    return this.asc606Service.updateContractModification(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async approveContractModification(
    ...
    return this.asc606Service.approveContractModification(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async applyContractModification(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
  ...
  async deleteContractModification(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
  ...
  async getModsByContract(
    @Req() req: AuthenticatedRequest,
    @Param("contractRef") contractRef: string,
  ) {
    return this.asc606Service.getModificationsByContract(
      req.user.tenantId,
      contractRef,
    );
  }
  ...
  async getRollForwards(
    @Req() req: AuthenticatedRequest,
    @Query("period") period?: string,
  ) {
    return this.asc606Service.getDeferredRevenueRollForwards(
      req.user.tenantId,
      period,
    );
  }
  ...
  async getRollForwardById(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.asc606Service.getDeferredRevenueRollForwardById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createRollForward(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createRollForwardSchema) dto: any,
  ) {
    return this.asc606Service.createDeferredRevenueRollForward(
      req.user.tenantId,
      await resolveOrgId(req.user.tenantId, req.user.orgId),
      dto,
    );
  ...
  async updateRollForward(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createRollForwardSchema.partial()) dto: any,
  ) {
    return this.asc606Service.updateDeferredRevenueRollForward(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deleteRollForward(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
  ) {
    return this.asc606Service.deleteDeferredRevenueRollForward(
      req.user.tenantId,
      id,
    );
  }
  ...
  async getRollForwardByPeriod(
    ...
    return this.asc606Service.getRollForwardByPeriod(
      req.user.tenantId,
      orgId,
      period,
    );
  ...
  async computeRollForward(
    @Req() req: AuthenticatedRequest,
    @Param("orgId") orgId: string,
    @Param("period") period: string,
  ) {
    return this.asc606Service.computeRollForwardFromSchedules(
      req.user.tenantId,
      orgId,
      period,
    );
  ...
  async getMultiElementSummary(
    @Req() req: AuthenticatedRequest,
    @Query("contractRef") contractRef?: string,
  ) {
    return this.asc606Service.getMultiElementSummary(
      req.user.tenantId,
      contractRef,
    );
  }
  ...
  async getVariableConsideration(
    @Req() req: AuthenticatedRequest,
    @Param("contractRef") contractRef: string,
  ) {
    return this.asc606Service.getVariableConsiderationEstimate(
      req.user.tenantId,
      contractRef,
    );
  }
  ...
  async getRevenueForecast(
    ...
    return this.asc606Service.getRevenueForecast(
      req.user.tenantId,
      orgId,
  ...
  async getContractSummary(
    ...
    return this.asc606Service.getContractRevenueSummary(
      req.user.tenantId,
      contractRef,
    );
  }
