...
export class AslController {
  ...
  getExpiringSuppliers(
    ...
    return this.svc.getExpiringSuppliers(
      req.user.tenantId,
  ...
  listApprovedSuppliers(
    ...
    return this.svc.listApprovedSuppliers(
      req.user.tenantId,
      productId,
      vendorId,
      status,
  ...
  createApprovedSupplier(
    ...
    return this.svc.createApprovedSupplier(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  updateApprovedSupplier(
    ...
    return this.svc.updateApprovedSupplier(
      req.user.tenantId,
      id,
      req.user.userId,
      dto,
  ...
  approveSupplier(
    @Request() req: AuthRequest,
    @Param("id") id: string,
    @Body() dto: { qualificationDate?: string },
  ) {
    return this.svc.approveSupplier(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.qualificationDate,
    );
  }
  ...
  disqualifySupplier(
    ...
    return this.svc.disqualifySupplier(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.reason,
  ...
  setConditional(
    ...
    return this.svc.setConditional(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.note,
  ...
  setPreferred(
    @Request() req: AuthRequest,
    @Param("id") id: string,
    @Body() dto: { rank?: number },
  ) {
    return this.svc.setPreferred(
      req.user.tenantId,
      id,
      req.user.userId,
      dto.rank,
  ...
  checkProductCompliance(
    ...
    return this.svc.checkProductCompliance(
      req.user.tenantId,
      productId,
      category,
    );
