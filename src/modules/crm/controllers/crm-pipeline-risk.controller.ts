...
import {
  ...
  snoozeAlertSchema,
  SnoozeAlertInput,
} from "../services/crm-pipeline-risk.service";
...
export class CrmPipelineRiskController {
  ...
  @ApiOperation({
    summary: "Recompute stage-change risk alerts across the whole pipeline",
  })
  @Post("recompute")
  ...
  async snooze(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(snoozeAlertSchema) dto: SnoozeAlertInput,
  ) {
