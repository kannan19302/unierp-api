...
export class CustomerReturnsController {
  ...
  createRma(@Request() req: AuthRequest, @Body() body: any) {
    return this.svc.createRma(req.user.tenantId, {
      ...body,
  ...
  inspectLine(
    ...
    return this.svc.inspectLine(req.user.tenantId, rmaId, lineId, {
      ...body,
  ...
  issueCredit(
    ...
    return this.svc.issueCredit(req.user.tenantId, rmaId, {
      ...body,
  ...
  voidCredit(
    ...
    return this.svc.voidCredit(req.user.tenantId, id, {
      ...body,
      voidedById: req.user.userId,
    });
  }
  ...
  restockLine(@Request() req: AuthRequest, @Body() body: any) {
    return this.svc.restockLine(req.user.tenantId, {
      ...body,
      restockedById: req.user.userId,
    });
  }
  ...
  listRestocks(@Request() req: AuthRequest, @Query() q: any) {
    return this.svc.listRestocks(req.user.tenantId, {
      rmaLineId: q.rmaLineId,
