...
export class SalesEnterpriseController {
  ...
  @ApiOperation({
    summary: "Revenue analytics by product/region/channel with growth rates",
  })
  ...
  @Permissions("sales.enterprise.read")
  @ApiOperation({
    summary: "Order fulfillment analysis - on-time, perfect order, fill rate",
  })
  async getOrderFulfillment(
    ...
    return this.service.getOrderFulfillment(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  @Permissions("sales.enterprise.read")
  @ApiOperation({
    summary: "Customer profitability analysis - revenue vs cost-to-serve",
  })
  async getCustomerProfitability(
    ...
    return this.service.getCustomerProfitability(
      req.user.tenantId,
      customerId,
      period,
    );
  ...
  @ApiOperation({
    summary:
      "Pricing analysis - price realization, discount depth, discount impact",
  })
  async getPricingAnalysis(
    ...
    return this.service.getPricingAnalysis(
      req.user.tenantId,
      productId,
      period,
    );
  ...
  async getChannelPerformance(
    ...
    return this.service.getSalesChannelPerformance(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  @Permissions("sales.enterprise.read")
  @ApiOperation({
    summary: "Product mix analysis with cross-sell and bundle performance",
  })
  async getProductMix(
    @Req() req: AuthenticatedRequest,
    @Query("periodStart") periodStart?: string,
    ...
    return this.service.getProductMixAnalysis(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  async getGeographicAnalysis(
    ...
    return this.service.getGeographicSalesAnalysis(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  @Permissions("sales.enterprise.read")
  @ApiOperation({
    summary: "Sales trend forecast with time-series predictions",
  })
  async getSalesForecast(
    ...
    return this.service.getSalesTrendForecast(
      req.user.tenantId,
      productId,
      horizon,
    );
  ...
  @Permissions("sales.enterprise.read")
  @ApiOperation({
    summary: "Customer segmentation - RFM analysis and segment profiling",
  })
  ...
  @Permissions("sales.enterprise.read")
  @ApiOperation({
    summary: "Sales rep performance - quota, win rate, pipeline coverage",
  })
  async getRepPerformance(
    ...
    return this.service.getSalesRepPerformance(
      req.user.tenantId,
      repId,
      period,
    );
  ...
  async getChurnAnalysis(
    ...
    return this.service.getChurnAnalysis(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  async exportReport(
    ...
    return this.service.exportSalesReport(
      req.user.tenantId,
      reportType,
      format || "json",
      params,
