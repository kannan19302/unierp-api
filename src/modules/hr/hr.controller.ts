...
export class HrController {
  ...
  async bulkAction(
    ...
    return this.hrService.bulkAction(
      req.user.tenantId,
      dto.action,
      dto.ids,
      dto.data,
  ...
  async uploadDocument(
    ...
    return this.hrService.createEmployeeDocument(req.user.tenantId, {
      ...dto,
      employeeId: id,
    });
  }
  ...
  async assignAsset(
    ...
    return this.hrService.assignAsset(req.user.tenantId, {
      ...dto,
      employeeId: id,
    });
  }
  ...
  async createPosition(
    ...
    return this.hrService.createPosition(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async createAttendance(
    ...
    return this.hrService.createAttendance(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async getAttendanceOverview(
    ...
    return this.hrService.getAttendanceOverview(
      req.user.tenantId,
      parseInt(year),
      parseInt(month),
    );
  ...
  async assignShift(
    ...
    return this.hrService.assignShiftToEmployees(
      req.user.tenantId,
      id,
      dto.employeeIds,
    );
  ...
  async createLeaveType(
    ...
    return this.hrService.createLeaveType(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async getEmployeeLeaveBalances(
    ...
    return this.hrService.getEmployeeLeaveBalances(
      req.user.tenantId,
      employeeId,
    );
  }
  ...
  async allocateLeaveBalance(
    ...
    return this.hrService.allocateLeaveBalance(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async getSalaryStructureByEmployee(
    ...
    return this.hrService.getSalaryStructureByEmployee(
      req.user.tenantId,
      employeeId,
    );
  }
  ...
  async createPayRun(
    ...
    return this.hrService.createPayRun(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async createTrainingCourse(
    ...
    return this.hrService.createTrainingCourse(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async enrollTraining(
    ...
    return this.hrService.enrollInTraining(
      req.user.tenantId,
      id,
      dto.employeeId,
    );
  ...
  async completeTraining(
    ...
    return this.hrService.completeTrainingEnrollment(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async createGoal(
    ...
    return this.hrService.createGoal(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async updateGoalProgress(
    ...
    return this.hrService.updateGoalProgress(
      req.user.tenantId,
      id,
      dto.progress,
    );
  ...
  async createJobPosting(
    ...
    return this.hrService.createJobPosting(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async createApplicant(
    ...
    return this.hrService.createApplicant(
      req.user.tenantId,
      req.user.orgId || "default",
      dto,
    );
  ...
  async advanceApplicantStage(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: any,
  ) {
    return this.hrService.advanceApplicantStage(
      req.user.tenantId,
      id,
      dto.stage,
    );
  ...
  async convertApplicant(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.any()) dto: any,
  ) {
    return this.hrService.convertApplicantToEmployee(
      req.user.tenantId,
      req.user.orgId || "default",
      id,
      dto,
  ...
  async resolveTicket(
    ...
    return this.hrService.resolveHrTicket(
      req.user.tenantId,
      id,
      dto.resolution,
    );
  ...
  async getUpcomingBirthdays(
    ...
    return this.hrService.getUpcomingBirthdays(
      req.user.tenantId,
  ...
  async getUpcomingAnniversaries(
    ...
    return this.hrService.getUpcomingAnniversaries(
      req.user.tenantId,
      days ? parseInt(days) : 30,
    );
  }
