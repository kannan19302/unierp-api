...
export class FieldServiceEnterpriseController {
  ...
  async getTechnicianPerformance(
    ...
    return this.service.getTechnicianPerformance(
      req.user.tenantId,
      techId,
      period,
    );
  ...
  async getCustomerSatisfaction(
    ...
    return this.service.getCustomerSatisfaction(
      req.user.tenantId,
      periodStart,
      periodEnd,
    );
  ...
  @Permissions("field-service.enterprise.read")
  async getMobileWorkforce(
    @Req() req: AuthenticatedRequest,
    @Query("dateRange") dateRange?: string,
  ) {
    return this.service.getMobileWorkforceAnalytics(
      req.user.tenantId,
      dateRange,
    );
  }
