...
export class HazmatController {
  ...
  listClassifications(
    ...
    return this.svc.listClassifications(
      req.user.tenantId,
      productId,
      regulation,
    );
  ...
  createClassification(
    ...
    return this.svc.createClassification(
      req.user.tenantId,
      req.user.userId,
      dto,
    );
  ...
  checkWarehouseCompatibility(
    ...
    return this.svc.checkWarehouseCompatibility(
      req.user.tenantId,
      warehouseId,
      hazardClass,
    );
  ...
  getExpiringSds(
    ...
    return this.svc.getExpiringSds(
      req.user.tenantId,
