...
} from "../services/inventory-atp-ctp.service";
...
export class InventoryAtpCtpController {
  ...
  computeAtp(@Req() req: AuthReq, @ZodBody(computeAtpSchema) dto: any) {
    return this.service.computeAtp(
      req.user.tenantId,
      dto.productId,
      dto.warehouseId,
    );
  ...
  getAtpStatus(
    ...
    return this.service.getAtpStatus(
      req.user.tenantId,
      productId,
      warehouseId,
      {
  ...
  getMultiWarehouseAtp(
    @Req() req: AuthReq,
    @ZodBody(multiWarehouseAtpSchema) dto: any,
  ) {
    return this.service.getMultiWarehouseAtp(
      req.user.tenantId,
      dto.warehouseIds,
    );
  }
  ...
  createReservation(
    @Req() req: AuthReq,
    @ZodBody(createAtpReservationSchema) dto: any,
  ) {
