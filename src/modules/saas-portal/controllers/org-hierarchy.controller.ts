...
export class SaasPortalOrgHierarchyController {
  constructor(
    private readonly orgHierarchyService: SaasPortalOrgHierarchyService,
  ) {}
  ...
  async createDepartment(
    ...
    @ZodBody(createDepartmentSchema)
    dto: z.infer<typeof createDepartmentSchema>,
  ) {
  ...
  async updateDepartment(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateDepartmentSchema)
    dto: z.infer<typeof updateDepartmentSchema>,
  ) {
    return this.orgHierarchyService.updateDepartment(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async updateCostCenter(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(updateCostCenterSchema)
    dto: z.infer<typeof updateCostCenterSchema>,
  ) {
    return this.orgHierarchyService.updateCostCenter(
      req.user.tenantId,
      id,
      dto,
    );
