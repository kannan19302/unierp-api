...
import {
  CreateSaasAppSchema,
  CreateSaasAppVersionSchema,
  CreateSaasSubscriptionPlanSchema,
  CreateSaasSubscriptionSchema,
  CreateSaasUsageMeterSchema,
  RecordSaasUsageSchema,
  CreateSaasInvoiceSchema,
  CreateSaasPaymentSchema,
  CreateSaasFeatureFlagSchema,
  CreateSaasTenantSettingSchema,
  CreateSaasDomainSchema,
  CreateSaasWebhookEndpointSchema,
  CreateSaasApiKeySchema,
  CreateSaasSupportTicketSchema,
  CreateSaasSupportTicketMessageSchema,
  CreateSaasAnnouncementSchema,
  CreateSaasMaintenanceWindowSchema,
...
export class SaasExpansionController {
  ...
  async createApp(
    ...
    @ZodBody(CreateSaasAppSchema) dto: any,
  ) {
  ...
  async updateApp(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreateSaasAppSchema.partial()) dto: any,
  ) {
  ...
  async createAppVersion(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasAppVersionSchema) dto: any,
  ) {
  ...
  async installApp(
    ...
    @ZodBody(z.object({ installingTenantId: z.string() })) dto: any,
  ) {
    return this.saasExpansionService.installApp(
      req.user.tenantId,
      appId,
      dto.installingTenantId,
      req.user.userId,
    );
  }
  ...
  async createSubscriptionPlan(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasSubscriptionPlanSchema) dto: any,
  ) {
    return this.saasExpansionService.createSubscriptionPlan(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async updateSubscriptionPlan(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreateSaasSubscriptionPlanSchema.partial()) dto: any,
  ) {
    return this.saasExpansionService.updateSubscriptionPlan(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deleteSubscriptionPlan(
    ...
    return this.saasExpansionService.deleteSubscriptionPlan(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createSubscription(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasSubscriptionSchema) dto: any,
  ) {
  ...
  async updateSubscriptionStatus(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ status: z.string(), reason: z.string().optional() }))
    dto: any,
  ) {
    return this.saasExpansionService.updateSubscriptionStatus(
      req.user.tenantId,
      id,
      dto.status,
      dto.reason,
  ...
  async createUsageMeter(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasUsageMeterSchema) dto: any,
  ) {
  ...
  async recordUsage(
    @Req() req: AuthenticatedRequest,
    @ZodBody(RecordSaasUsageSchema) dto: any,
  ) {
  ...
  async getUsageRecords(
    ...
    return this.saasExpansionService.getUsageRecords(
      req.user.tenantId,
      subscriptionId,
      meterId,
    );
  ...
  async createInvoice(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasInvoiceSchema) dto: any,
  ) {
  ...
  async recordPayment(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasPaymentSchema) dto: any,
  ) {
  ...
  async createCoupon(
    ...
    @ZodBody(
      z.object({
        ...
        type: z.enum(["PERCENTAGE", "FIXED", "FREE_MONTH"]),
        value: z.number(),
  ...
  async createFeatureFlag(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasFeatureFlagSchema) dto: any,
  ) {
  ...
  async toggleFeatureFlag(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ isEnabled: z.boolean() })) dto: any,
  ) {
    return this.saasExpansionService.toggleFeatureFlag(
      req.user.tenantId,
      id,
      dto.isEnabled,
    );
  ...
  async getTenantSettings(
    ...
    return this.saasExpansionService.getTenantSettings(
      req.user.tenantId,
      category,
    );
  }
  ...
  async upsertTenantSetting(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasTenantSettingSchema) dto: any,
  ) {
    return this.saasExpansionService.upsertTenantSetting(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async deleteTenantSetting(
    ...
    return this.saasExpansionService.deleteTenantSetting(
      req.user.tenantId,
      category,
      key,
    );
  ...
  async addDomain(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasDomainSchema) dto: any,
  ) {
  ...
  async createWebhookEndpoint(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasWebhookEndpointSchema) dto: any,
  ) {
    return this.saasExpansionService.createWebhookEndpoint(
      req.user.tenantId,
      dto,
    );
  }
  ...
  async updateWebhookEndpoint(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(CreateSaasWebhookEndpointSchema.partial()) dto: any,
  ) {
    return this.saasExpansionService.updateWebhookEndpoint(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async deleteWebhookEndpoint(
    ...
    return this.saasExpansionService.deleteWebhookEndpoint(
      req.user.tenantId,
      id,
    );
  }
  ...
  async getWebhookDeliveries(
    ...
    return this.saasExpansionService.getWebhookDeliveries(
      req.user.tenantId,
      id,
      query,
    );
  ...
  async createApiKey(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasApiKeySchema) dto: any,
  ) {
    return this.saasExpansionService.createApiKey(
      req.user.tenantId,
      dto,
      req.user.userId,
    );
  ...
  async getSupportTickets(
    ...
    return this.saasExpansionService.getSupportTickets(
      req.user.tenantId,
      query,
    );
  }
  ...
  async getSupportTicketById(
    ...
    return this.saasExpansionService.getSupportTicketById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createSupportTicket(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasSupportTicketSchema) dto: any,
  ) {
    return this.saasExpansionService.createSupportTicket(
      req.user.tenantId,
      dto,
      req.user.userId,
    );
  ...
  async updateSupportTicketStatus(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ status: z.string() })) dto: any,
  ) {
    return this.saasExpansionService.updateSupportTicketStatus(
      req.user.tenantId,
      id,
      dto.status,
      req.user.userId,
  ...
  async addTicketMessage(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasSupportTicketMessageSchema) dto: any,
  ) {
    return this.saasExpansionService.addTicketMessage(
      req.user.tenantId,
      dto,
      req.user.userId,
    );
  ...
  async createAnnouncement(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasAnnouncementSchema) dto: any,
  ) {
    return this.saasExpansionService.createAnnouncement(
      req.user.tenantId,
      dto,
      req.user.userId,
    );
  ...
  async createMaintenanceWindow(
    @Req() req: AuthenticatedRequest,
    @ZodBody(CreateSaasMaintenanceWindowSchema) dto: any,
  ) {
    return this.saasExpansionService.createMaintenanceWindow(
      req.user.tenantId,
      dto,
      req.user.userId,
    );
  ...
  async updateMaintenanceWindowStatus(
    ...
    return this.saasExpansionService.updateMaintenanceWindowStatus(
      req.user.tenantId,
      id,
      dto.status,
    );
  ...
  async logAudit(
    ...
    return this.saasExpansionService.logAudit(
      req.user.tenantId,
      req.user.userId,
      dto.action,
      dto.resource,
