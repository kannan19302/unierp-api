...
export class SaasPortalGdprComplianceController {
  constructor(
    private readonly gdprComplianceService: SaasPortalGdprComplianceService,
  ) {}
  ...
  async upsertRetentionPolicy(
    ...
    @ZodBody(upsertRetentionPolicySchema)
    body: z.infer<typeof upsertRetentionPolicySchema>,
  ) {
    return this.gdprComplianceService.upsertRetentionPolicy(
      req.user.tenantId,
      body,
    );
  }
  ...
  async createErasureRequest(
    @Req() req: AuthenticatedRequest,
    @ZodBody(createErasureRequestSchema)
    body: z.infer<typeof createErasureRequestSchema>,
  ) {
    return this.gdprComplianceService.createErasureRequest(
      req.user.tenantId,
      req.user.userId,
      body,
    );
  ...
  async exportSubjectData(
    ...
    return this.gdprComplianceService.exportSubjectData(
      req.user.tenantId,
      email,
    );
  }
  ...
  async signDataProcessingAgreement(
    ...
    return this.gdprComplianceService.signDataProcessingAgreement(
      body.acceptedBy,
    );
  }
