...
export class NettingDeepController {
  ...
  async createGroup(
    ...
    return this.nettingService.createNettingGroup(
      req.user.tenantId,
  ...
  async addMember(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(addMemberSchema) dto: any,
  ) {
    return this.nettingService.addNettingGroupMember(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async removeMember(
    ...
    return this.nettingService.removeNettingGroupMember(
      req.user.tenantId,
      id,
      memberId,
    );
  ...
  async deactivateMember(
    ...
    return this.nettingService.deactivateNettingGroupMember(
      req.user.tenantId,
      id,
      memberId,
    );
  ...
  async createRun(
    ...
    return this.nettingService.createNettingRun(
      req.user.tenantId,
      groupId,
      dto,
    );
  ...
  async updateRun(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createRunSchema.partial()) dto: any,
  ) {
  ...
  async submitRun(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
    return this.nettingService.submitNettingRunForApproval(
      req.user.tenantId,
      id,
    );
  }
  ...
  async approveRun(@Req() req: AuthenticatedRequest, @Param("id") id: string) {
    return this.nettingService.approveNettingRun(
      req.user.tenantId,
      id,
      req.user.userId,
    );
  ...
  async getSettlements(
    @Req() req: AuthenticatedRequest,
    @Query("nettingRunId") nettingRunId?: string,
    @Query("status") status?: string,
  ) {
    return this.nettingService.getSettlementInstructions(
      req.user.tenantId,
      nettingRunId,
      status,
    );
  ...
  async getSettlementById(
    ...
    return this.nettingService.getSettlementInstructionById(
      req.user.tenantId,
      id,
    );
  }
  ...
  async createSettlement(
    ...
    @ZodBody(createSettlementSchema) dto: any,
  ) {
    return this.nettingService.createSettlementInstruction(
      req.user.tenantId,
      runId,
      dto,
    );
  ...
  async updateSettlement(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(createSettlementSchema.partial()) dto: any,
  ) {
    return this.nettingService.updateSettlementInstruction(
      req.user.tenantId,
      id,
      dto,
    );
  ...
  async executeSettlement(
    ...
    return this.nettingService.executeSettlementInstruction(
      req.user.tenantId,
      id,
    );
  }
  ...
  async confirmSettlement(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ confirmationRef: z.string().optional() })) dto: any,
  ) {
    return this.nettingService.confirmSettlementInstruction(
      req.user.tenantId,
      id,
      dto.confirmationRef,
    );
  ...
  async failSettlement(
    @Req() req: AuthenticatedRequest,
    @Param("id") id: string,
    @ZodBody(z.object({ errorMessage: z.string().optional() })) dto: any,
  ) {
    return this.nettingService.failSettlementInstruction(
      req.user.tenantId,
      id,
      dto.errorMessage,
    );
  ...
  async deleteSettlement(
    ...
    return this.nettingService.deleteSettlementInstruction(
      req.user.tenantId,
      id,
    );
  }
