...
import {
  ...
  updateRmaStatusSchema,
  UpdateRmaStatusInput,
  rejectRmaSchema,
  RejectRmaInput,
  createShipmentSchema,
  CreateShipmentInput,
  recordCreditMemoSchema,
  RecordCreditMemoInput,
} from "../services/rtv.service";
...
export class RtvController {
  ...
  async listReasonCodes(
    ...
    return this.svc.listReasonCodes(
      req.user.tenantId,
  ...
  async createReasonCode(
    @Req() req: AuthReq,
    @ZodBody(createReasonCodeSchema) body: CreateReasonCodeInput,
  ) {
  ...
  async updateReasonCode(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateReasonCodeSchema) body: UpdateReasonCodeInput,
  ) {
  ...
  async createRmaRequest(
    @Req() req: AuthReq,
    @ZodBody(createRmaRequestSchema) body: CreateRmaRequestInput,
  ) {
    return this.svc.createRmaRequest(
      req.user.tenantId,
      req.user.orgId,
      req.user.userId,
      body,
  ...
  async authorizeRmaRequest(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(updateRmaStatusSchema) body: UpdateRmaStatusInput,
  ) {
  ...
  @Permissions("inventory.rtv.update")
  async rejectRmaRequest(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(rejectRmaSchema) body: RejectRmaInput,
  ) {
  ...
  @ApiOperation({
    summary: "Create a return shipment (RMA must be AUTHORIZED)",
  })
  @Post("shipments")
  @Permissions("inventory.rtv.create")
  ...
  @ApiOperation({
    summary: "Record vendor credit memo against a delivered shipment",
  })
  ...
  async recordCreditMemo(
    @Req() req: AuthReq,
    @Param("id") id: string,
    @ZodBody(recordCreditMemoSchema) body: RecordCreditMemoInput,
  ) {
